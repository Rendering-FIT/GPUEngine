...
//    WHEN("running f1"){
//      REQUIRE(fa->isDirty()==true);
//      REQUIRE(fb->isDirty()==true);
//      REQUIRE(fc->isDirty()==true);
...
//    REQUIRE(fki->isDirty()==true);
//    REQUIRE(fi1->isDirty()==true);
//    REQUIRE(fiend->isDirty()==true);
//    REQUIRE(f1->isDirty()==true);
