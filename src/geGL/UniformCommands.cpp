...
template<>void UniformV<1,GLfloat >::operator()(){glUniform1fv (this->_location,this->_count,(const GLfloat* )this->_data);}
template<>void UniformV<2,GLfloat >::operator()(){glUniform2fv (this->_location,this->_count,(const GLfloat* )this->_data);}
template<>void UniformV<3,GLfloat >::operator()(){glUniform3fv (this->_location,this->_count,(const GLfloat* )this->_data);}
template<>void UniformV<4,GLfloat >::operator()(){glUniform4fv (this->_location,this->_count,(const GLfloat* )this->_data);}
template<>void UniformV<1,GLint   >::operator()(){glUniform1iv (this->_location,this->_count,(const GLint*   )this->_data);}
template<>void UniformV<2,GLint   >::operator()(){glUniform2iv (this->_location,this->_count,(const GLint*   )this->_data);}
template<>void UniformV<3,GLint   >::operator()(){glUniform3iv (this->_location,this->_count,(const GLint*   )this->_data);}
template<>void UniformV<4,GLint   >::operator()(){glUniform4iv (this->_location,this->_count,(const GLint*   )this->_data);}
template<>void UniformV<1,GLuint  >::operator()(){glUniform1uiv(this->_location,this->_count,(const GLuint*  )this->_data);}
template<>void UniformV<2,GLuint  >::operator()(){glUniform2uiv(this->_location,this->_count,(const GLuint*  )this->_data);}
template<>void UniformV<3,GLuint  >::operator()(){glUniform3uiv(this->_location,this->_count,(const GLuint*  )this->_data);}
template<>void UniformV<4,GLuint  >::operator()(){glUniform4uiv(this->_location,this->_count,(const GLuint*  )this->_data);}
template<>void UniformV<1,GLdouble>::operator()(){glUniform1dv (this->_location,this->_count,(const GLdouble*)this->_data);}
template<>void UniformV<2,GLdouble>::operator()(){glUniform2dv (this->_location,this->_count,(const GLdouble*)this->_data);}
template<>void UniformV<3,GLdouble>::operator()(){glUniform3dv (this->_location,this->_count,(const GLdouble*)this->_data);}
template<>void UniformV<4,GLdouble>::operator()(){glUniform4dv (this->_location,this->_count,(const GLdouble*)this->_data);}
