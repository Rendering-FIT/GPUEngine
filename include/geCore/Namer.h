...
namespace ge{
  namespace core{
    ...
    inline std::string const&Namer::getFceInputName(Id id,ElementIndex input)const{
      assert(this!=nullptr);
    ...
    inline std::string const&Namer::getFceOutputName(Id id)const{
      assert(this!=nullptr);
      assert(this->_functionNaming.count(id)!=0);
      return std::get<OUTPUT>(this->_functionNaming.find(id)->second);
    }

    inline void Namer::setFceInputName(Id id,ElementIndex input,std::string const&name){
      assert(this!=nullptr);
      assert(this->_functionNaming.count(id)!=0);
    ...
    inline void Namer::setFceOutputName(Id id,std::string const&name){
      assert(this!=nullptr);
      assert(this->_functionNaming.count(id)!=0);
      std::get<OUTPUT>(this->_functionNaming[id]) = name;
    }

    inline std::string const&Namer::getStructElementName(Id id,ElementIndex element)const{
      assert(this!=nullptr);
    ...
    inline void Namer::setStructElementName(Id id,ElementIndex element,std::string const&name){
      assert(this!=nullptr);
      assert(this->_structureNaming.count(id)!=0);
      assert(element<std::get<ELEMENT_NAME>(this->_structureNaming.find(id)->second).size());
    ...
    inline Namer::ElementIndex Namer::getFceInput(Id id,std::string const&name)const{
      assert(this!=nullptr);
      assert(this->_functionNaming.count(id)!=0);
    ...
    inline Namer::ElementIndex Namer::getStructElement(Id id,std::string const&name)const{
      assert(this!=nullptr);
      assert(this->_structureNaming.count(id)!=0);
    ...
    inline bool Namer::hasFceInput(Id id,std::string const&name)const{
      assert(this!=nullptr);
      assert(this->_functionNaming.count(id)!=0);
      return std::get<NAME_2_INPUT>(this->_functionNaming.find(id)->second).count(name)>0;
    }

    inline bool Namer::hasStructElement(Id id,std::string const&name)const{
      assert(this!=nullptr);
      assert(this->_structureNaming.count(id)!=0);
