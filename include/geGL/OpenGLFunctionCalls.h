...
inline const GLubyte* glGetString(GLenum name) { this->_getTable()->glGetString(name); }
inline const GLubyte* glGetStringi(GLenum name, GLuint index) { this->_getTable()->glGetStringi(name, index); }
inline GLbitfield glQueryMatrixxOES(GLfixed* mantissa, GLint* exponent) { this->_getTable()->glQueryMatrixxOES(mantissa, exponent); }
inline GLboolean glAreProgramsResidentNV(GLsizei n, const GLuint* programs, GLboolean* residences) { this->_getTable()->glAreProgramsResidentNV(n, programs, residences); }
inline GLboolean glAreTexturesResidentEXT(GLsizei n, const GLuint* textures, GLboolean* residences) { this->_getTable()->glAreTexturesResidentEXT(n, textures, residences); }
inline GLboolean glAreTexturesResident(GLsizei n, const GLuint* textures, GLboolean* residences) { this->_getTable()->glAreTexturesResident(n, textures, residences); }
inline GLboolean glIsAsyncMarkerSGIX(GLuint marker) { this->_getTable()->glIsAsyncMarkerSGIX(marker); }
inline GLboolean glIsBufferARB(GLuint buffer) { this->_getTable()->glIsBufferARB(buffer); }
inline GLboolean glIsBuffer(GLuint buffer) { this->_getTable()->glIsBuffer(buffer); }
inline GLboolean glIsBufferResidentNV(GLenum target) { this->_getTable()->glIsBufferResidentNV(target); }
inline GLboolean glIsCommandListNV(GLuint list) { this->_getTable()->glIsCommandListNV(list); }
inline GLboolean glIsEnabled(GLenum cap) { this->_getTable()->glIsEnabled(cap); }
inline GLboolean glIsEnabledi(GLenum target, GLuint index) { this->_getTable()->glIsEnabledi(target, index); }
inline GLboolean glIsEnabledIndexedEXT(GLenum target, GLuint index) { this->_getTable()->glIsEnabledIndexedEXT(target, index); }
inline GLboolean glIsFenceAPPLE(GLuint fence) { this->_getTable()->glIsFenceAPPLE(fence); }
inline GLboolean glIsFenceNV(GLuint fence) { this->_getTable()->glIsFenceNV(fence); }
inline GLboolean glIsFramebufferEXT(GLuint framebuffer) { this->_getTable()->glIsFramebufferEXT(framebuffer); }
inline GLboolean glIsFramebuffer(GLuint framebuffer) { this->_getTable()->glIsFramebuffer(framebuffer); }
inline GLboolean glIsImageHandleResidentARB(GLuint64 handle) { this->_getTable()->glIsImageHandleResidentARB(handle); }
inline GLboolean glIsImageHandleResidentNV(GLuint64 handle) { this->_getTable()->glIsImageHandleResidentNV(handle); }
inline GLboolean glIsList(GLuint list) { this->_getTable()->glIsList(list); }
inline GLboolean glIsNameAMD(GLenum identifier, GLuint name) { this->_getTable()->glIsNameAMD(identifier, name); }
inline GLboolean glIsNamedBufferResidentNV(GLuint buffer) { this->_getTable()->glIsNamedBufferResidentNV(buffer); }
inline GLboolean glIsNamedStringARB(GLint namelen, const GLchar* name) { this->_getTable()->glIsNamedStringARB(namelen, name); }
inline GLboolean glIsObjectBufferATI(GLuint buffer) { this->_getTable()->glIsObjectBufferATI(buffer); }
inline GLboolean glIsOcclusionQueryNV(GLuint id) { this->_getTable()->glIsOcclusionQueryNV(id); }
inline GLboolean glIsPathNV(GLuint path) { this->_getTable()->glIsPathNV(path); }
inline GLboolean glIsPointInFillPathNV(GLuint path, GLuint mask, GLfloat x, GLfloat y) { this->_getTable()->glIsPointInFillPathNV(path, mask, x, y); }
inline GLboolean glIsPointInStrokePathNV(GLuint path, GLfloat x, GLfloat y) { this->_getTable()->glIsPointInStrokePathNV(path, x, y); }
inline GLboolean glIsProgramARB(GLuint program) { this->_getTable()->glIsProgramARB(program); }
inline GLboolean glIsProgram(GLuint program) { this->_getTable()->glIsProgram(program); }
inline GLboolean glIsProgramNV(GLuint id) { this->_getTable()->glIsProgramNV(id); }
inline GLboolean glIsProgramPipeline(GLuint pipeline) { this->_getTable()->glIsProgramPipeline(pipeline); }
inline GLboolean glIsQueryARB(GLuint id) { this->_getTable()->glIsQueryARB(id); }
inline GLboolean glIsQuery(GLuint id) { this->_getTable()->glIsQuery(id); }
inline GLboolean glIsRenderbufferEXT(GLuint renderbuffer) { this->_getTable()->glIsRenderbufferEXT(renderbuffer); }
inline GLboolean glIsRenderbuffer(GLuint renderbuffer) { this->_getTable()->glIsRenderbuffer(renderbuffer); }
inline GLboolean glIsSampler(GLuint sampler) { this->_getTable()->glIsSampler(sampler); }
inline GLboolean glIsShader(GLuint shader) { this->_getTable()->glIsShader(shader); }
inline GLboolean glIsStateNV(GLuint state) { this->_getTable()->glIsStateNV(state); }
inline GLboolean glIsSync(GLsync sync) { this->_getTable()->glIsSync(sync); }
inline GLboolean glIsTextureEXT(GLuint texture) { this->_getTable()->glIsTextureEXT(texture); }
inline GLboolean glIsTexture(GLuint texture) { this->_getTable()->glIsTexture(texture); }
inline GLboolean glIsTextureHandleResidentARB(GLuint64 handle) { this->_getTable()->glIsTextureHandleResidentARB(handle); }
inline GLboolean glIsTextureHandleResidentNV(GLuint64 handle) { this->_getTable()->glIsTextureHandleResidentNV(handle); }
inline GLboolean glIsTransformFeedback(GLuint id) { this->_getTable()->glIsTransformFeedback(id); }
inline GLboolean glIsTransformFeedbackNV(GLuint id) { this->_getTable()->glIsTransformFeedbackNV(id); }
inline GLboolean glIsVariantEnabledEXT(GLuint id, GLenum cap) { this->_getTable()->glIsVariantEnabledEXT(id, cap); }
inline GLboolean glIsVertexArrayAPPLE(GLuint array) { this->_getTable()->glIsVertexArrayAPPLE(array); }
inline GLboolean glIsVertexArray(GLuint array) { this->_getTable()->glIsVertexArray(array); }
inline GLboolean glIsVertexAttribEnabledAPPLE(GLuint index, GLenum pname) { this->_getTable()->glIsVertexAttribEnabledAPPLE(index, pname); }
inline GLboolean glPointAlongPathNV(GLuint path, GLsizei startSegment, GLsizei numSegments, GLfloat distance, GLfloat* x, GLfloat* y, GLfloat* tangentX, GLfloat* tangentY) { this->_getTable()->glPointAlongPathNV(path, startSegment, numSegments, distance, x, y, tangentX, tangentY); }
inline GLboolean glTestFenceAPPLE(GLuint fence) { this->_getTable()->glTestFenceAPPLE(fence); }
inline GLboolean glTestFenceNV(GLuint fence) { this->_getTable()->glTestFenceNV(fence); }
inline GLboolean glTestObjectAPPLE(GLenum object, GLuint name) { this->_getTable()->glTestObjectAPPLE(object, name); }
inline GLboolean glUnmapBufferARB(GLenum target) { this->_getTable()->glUnmapBufferARB(target); }
inline GLboolean glUnmapBuffer(GLenum target) { this->_getTable()->glUnmapBuffer(target); }
inline GLboolean glUnmapNamedBufferEXT(GLuint buffer) { this->_getTable()->glUnmapNamedBufferEXT(buffer); }
inline GLboolean glUnmapNamedBuffer(GLuint buffer) { this->_getTable()->glUnmapNamedBuffer(buffer); }
inline GLboolean glVDPAUIsSurfaceNV(GLvdpauSurfaceNV surface) { this->_getTable()->glVDPAUIsSurfaceNV(surface); }
inline GLenum glCheckFramebufferStatusEXT(GLenum target) { this->_getTable()->glCheckFramebufferStatusEXT(target); }
inline GLenum glCheckFramebufferStatus(GLenum target) { this->_getTable()->glCheckFramebufferStatus(target); }
inline GLenum glCheckNamedFramebufferStatusEXT(GLuint framebuffer, GLenum target) { this->_getTable()->glCheckNamedFramebufferStatusEXT(framebuffer, target); }
inline GLenum glCheckNamedFramebufferStatus(GLuint framebuffer, GLenum target) { this->_getTable()->glCheckNamedFramebufferStatus(framebuffer, target); }
inline GLenum glClientWaitSync(GLsync sync, GLbitfield flags, GLuint64 timeout) { this->_getTable()->glClientWaitSync(sync, flags, timeout); }
inline GLenum glGetError() { this->_getTable()->glGetError(); }
inline GLenum glGetGraphicsResetStatus() { this->_getTable()->glGetGraphicsResetStatus(); }
inline GLenum glGetGraphicsResetStatusARB() { this->_getTable()->glGetGraphicsResetStatusARB(); }
inline GLenum glObjectPurgeableAPPLE(GLenum objectType, GLuint name, GLenum option) { this->_getTable()->glObjectPurgeableAPPLE(objectType, name, option); }
inline GLenum glObjectUnpurgeableAPPLE(GLenum objectType, GLuint name, GLenum option) { this->_getTable()->glObjectUnpurgeableAPPLE(objectType, name, option); }
inline GLenum glPathGlyphIndexArrayNV(GLuint firstPathName, GLenum fontTarget, const void* fontName, GLbitfield fontStyle, GLuint firstGlyphIndex, GLsizei numGlyphs, GLuint pathParameterTemplate, GLfloat emScale) { this->_getTable()->glPathGlyphIndexArrayNV(firstPathName, fontTarget, fontName, fontStyle, firstGlyphIndex, numGlyphs, pathParameterTemplate, emScale); }
inline GLenum glPathGlyphIndexRangeNV(GLenum fontTarget, const void* fontName, GLbitfield fontStyle, GLuint pathParameterTemplate, GLfloat emScale, GLuint baseAndCount[2]) { this->_getTable()->glPathGlyphIndexRangeNV(fontTarget, fontName, fontStyle, pathParameterTemplate, emScale, baseAndCount[2]); }
inline GLenum glPathMemoryGlyphIndexArrayNV(GLuint firstPathName, GLenum fontTarget, GLsizeiptr fontSize, const void* fontData, GLsizei faceIndex, GLuint firstGlyphIndex, GLsizei numGlyphs, GLuint pathParameterTemplate, GLfloat emScale) { this->_getTable()->glPathMemoryGlyphIndexArrayNV(firstPathName, fontTarget, fontSize, fontData, faceIndex, firstGlyphIndex, numGlyphs, pathParameterTemplate, emScale); }
inline GLenum glVideoCaptureNV(GLuint video_capture_slot, GLuint* sequence_num, GLuint64EXT* capture_time) { this->_getTable()->glVideoCaptureNV(video_capture_slot, sequence_num, capture_time); }
inline GLfloat glGetPathLengthNV(GLuint path, GLsizei startSegment, GLsizei numSegments) { this->_getTable()->glGetPathLengthNV(path, startSegment, numSegments); }
inline GLhandleARB glCreateProgramObjectARB() { this->_getTable()->glCreateProgramObjectARB(); }
inline GLhandleARB glCreateShaderObjectARB(GLenum shaderType) { this->_getTable()->glCreateShaderObjectARB(shaderType); }
inline GLhandleARB glGetHandleARB(GLenum pname) { this->_getTable()->glGetHandleARB(pname); }
inline GLint glFinishAsyncSGIX(GLuint* markerp) { this->_getTable()->glFinishAsyncSGIX(markerp); }
inline GLint glGetAttribLocationARB(GLhandleARB programObj, const GLcharARB* name) { this->_getTable()->glGetAttribLocationARB(programObj, name); }
inline GLint glGetAttribLocation(GLuint program, const GLchar* name) { this->_getTable()->glGetAttribLocation(program, name); }
inline GLint glGetFragDataIndex(GLuint program, const GLchar* name) { this->_getTable()->glGetFragDataIndex(program, name); }
inline GLint glGetFragDataLocationEXT(GLuint program, const GLchar* name) { this->_getTable()->glGetFragDataLocationEXT(program, name); }
inline GLint glGetFragDataLocation(GLuint program, const GLchar* name) { this->_getTable()->glGetFragDataLocation(program, name); }
inline GLint glGetInstrumentsSGIX() { this->_getTable()->glGetInstrumentsSGIX(); }
inline GLint glGetProgramResourceLocation(GLuint program, GLenum programInterface, const GLchar* name) { this->_getTable()->glGetProgramResourceLocation(program, programInterface, name); }
inline GLint glGetProgramResourceLocationIndex(GLuint program, GLenum programInterface, const GLchar* name) { this->_getTable()->glGetProgramResourceLocationIndex(program, programInterface, name); }
inline GLint glGetSubroutineUniformLocation(GLuint program, GLenum shadertype, const GLchar* name) { this->_getTable()->glGetSubroutineUniformLocation(program, shadertype, name); }
inline GLint glGetUniformBufferSizeEXT(GLuint program, GLint location) { this->_getTable()->glGetUniformBufferSizeEXT(program, location); }
inline GLint glGetUniformLocationARB(GLhandleARB programObj, const GLcharARB* name) { this->_getTable()->glGetUniformLocationARB(programObj, name); }
inline GLint glGetUniformLocation(GLuint program, const GLchar* name) { this->_getTable()->glGetUniformLocation(program, name); }
inline GLint glGetVaryingLocationNV(GLuint program, const GLchar* name) { this->_getTable()->glGetVaryingLocationNV(program, name); }
inline GLint glPollAsyncSGIX(GLuint* markerp) { this->_getTable()->glPollAsyncSGIX(markerp); }
inline GLint glPollInstrumentsSGIX(GLint* marker_p) { this->_getTable()->glPollInstrumentsSGIX(marker_p); }
inline GLint glRenderMode(GLenum mode) { this->_getTable()->glRenderMode(mode); }
inline GLintptr glGetUniformOffsetEXT(GLuint program, GLint location) { this->_getTable()->glGetUniformOffsetEXT(program, location); }
inline GLsync glCreateSyncFromCLeventARB(struct _cl_context* context, struct _cl_event* event, GLbitfield flags) { this->_getTable()->glCreateSyncFromCLeventARB(context, event, flags); }
inline GLsync glFenceSync(GLenum condition, GLbitfield flags) { this->_getTable()->glFenceSync(condition, flags); }
inline GLsync glImportSyncEXT(GLenum external_sync_type, GLintptr external_sync, GLbitfield flags) { this->_getTable()->glImportSyncEXT(external_sync_type, external_sync, flags); }
inline GLuint64 glGetImageHandleARB(GLuint texture, GLint level, GLboolean layered, GLint layer, GLenum format) { this->_getTable()->glGetImageHandleARB(texture, level, layered, layer, format); }
inline GLuint64 glGetImageHandleNV(GLuint texture, GLint level, GLboolean layered, GLint layer, GLenum format) { this->_getTable()->glGetImageHandleNV(texture, level, layered, layer, format); }
inline GLuint64 glGetTextureHandleARB(GLuint texture) { this->_getTable()->glGetTextureHandleARB(texture); }
inline GLuint64 glGetTextureHandleNV(GLuint texture) { this->_getTable()->glGetTextureHandleNV(texture); }
inline GLuint64 glGetTextureSamplerHandleARB(GLuint texture, GLuint sampler) { this->_getTable()->glGetTextureSamplerHandleARB(texture, sampler); }
inline GLuint64 glGetTextureSamplerHandleNV(GLuint texture, GLuint sampler) { this->_getTable()->glGetTextureSamplerHandleNV(texture, sampler); }
inline GLuint glBindLightParameterEXT(GLenum light, GLenum value) { this->_getTable()->glBindLightParameterEXT(light, value); }
inline GLuint glBindMaterialParameterEXT(GLenum face, GLenum value) { this->_getTable()->glBindMaterialParameterEXT(face, value); }
inline GLuint glBindParameterEXT(GLenum value) { this->_getTable()->glBindParameterEXT(value); }
inline GLuint glBindTexGenParameterEXT(GLenum unit, GLenum coord, GLenum value) { this->_getTable()->glBindTexGenParameterEXT(unit, coord, value); }
inline GLuint glBindTextureUnitParameterEXT(GLenum unit, GLenum value) { this->_getTable()->glBindTextureUnitParameterEXT(unit, value); }
inline GLuint glCreateProgram() { this->_getTable()->glCreateProgram(); }
inline GLuint glCreateShader(GLenum type) { this->_getTable()->glCreateShader(type); }
inline GLuint glCreateShaderProgramEXT(GLenum type, const GLchar* string) { this->_getTable()->glCreateShaderProgramEXT(type, string); }
inline GLuint glCreateShaderProgramv(GLenum type, GLsizei count, const GLchar*const* strings) { this->_getTable()->glCreateShaderProgramv(type, count, strings); }
inline GLuint glGenAsyncMarkersSGIX(GLsizei range) { this->_getTable()->glGenAsyncMarkersSGIX(range); }
inline GLuint glGenFragmentShadersATI(GLuint range) { this->_getTable()->glGenFragmentShadersATI(range); }
inline GLuint glGenLists(GLsizei range) { this->_getTable()->glGenLists(range); }
inline GLuint glGenPathsNV(GLsizei range) { this->_getTable()->glGenPathsNV(range); }
inline GLuint glGenSymbolsEXT(GLenum datatype, GLenum storagetype, GLenum range, GLuint components) { this->_getTable()->glGenSymbolsEXT(datatype, storagetype, range, components); }
inline GLuint glGenVertexShadersEXT(GLuint range) { this->_getTable()->glGenVertexShadersEXT(range); }
inline GLuint glGetCommandHeaderNV(GLenum tokenID, GLuint size) { this->_getTable()->glGetCommandHeaderNV(tokenID, size); }
inline GLuint glGetDebugMessageLogAMD(GLuint count, GLsizei bufsize, GLenum* categories, GLuint* severities, GLuint* ids, GLsizei* lengths, GLchar* message) { this->_getTable()->glGetDebugMessageLogAMD(count, bufsize, categories, severities, ids, lengths, message); }
inline GLuint glGetDebugMessageLogARB(GLuint count, GLsizei bufSize, GLenum* sources, GLenum* types, GLuint* ids, GLenum* severities, GLsizei* lengths, GLchar* messageLog) { this->_getTable()->glGetDebugMessageLogARB(count, bufSize, sources, types, ids, severities, lengths, messageLog); }
inline GLuint glGetDebugMessageLog(GLuint count, GLsizei bufSize, GLenum* sources, GLenum* types, GLuint* ids, GLenum* severities, GLsizei* lengths, GLchar* messageLog) { this->_getTable()->glGetDebugMessageLog(count, bufSize, sources, types, ids, severities, lengths, messageLog); }
inline GLuint glGetProgramResourceIndex(GLuint program, GLenum programInterface, const GLchar* name) { this->_getTable()->glGetProgramResourceIndex(program, programInterface, name); }
inline GLuint glGetSubroutineIndex(GLuint program, GLenum shadertype, const GLchar* name) { this->_getTable()->glGetSubroutineIndex(program, shadertype, name); }
inline GLuint glGetUniformBlockIndex(GLuint program, const GLchar* uniformBlockName) { this->_getTable()->glGetUniformBlockIndex(program, uniformBlockName); }
inline GLuint glNewObjectBufferATI(GLsizei size, const void* pointer, GLenum usage) { this->_getTable()->glNewObjectBufferATI(size, pointer, usage); }
inline GLushort glGetStageIndexNV(GLenum shadertype) { this->_getTable()->glGetStageIndexNV(shadertype); }
inline GLvdpauSurfaceNV glVDPAURegisterOutputSurfaceNV(const void* vdpSurface, GLenum target, GLsizei numTextureNames, const GLuint* textureNames) { this->_getTable()->glVDPAURegisterOutputSurfaceNV(vdpSurface, target, numTextureNames, textureNames); }
inline GLvdpauSurfaceNV glVDPAURegisterVideoSurfaceNV(const void* vdpSurface, GLenum target, GLsizei numTextureNames, const GLuint* textureNames) { this->_getTable()->glVDPAURegisterVideoSurfaceNV(vdpSurface, target, numTextureNames, textureNames); }
...
inline void* glMapBufferARB(GLenum target, GLenum access) { this->_getTable()->glMapBufferARB(target, access); }
inline void* glMapBuffer(GLenum target, GLenum access) { this->_getTable()->glMapBuffer(target, access); }
inline void* glMapBufferRange(GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access) { this->_getTable()->glMapBufferRange(target, offset, length, access); }
...
inline void* glMapNamedBufferEXT(GLuint buffer, GLenum access) { this->_getTable()->glMapNamedBufferEXT(buffer, access); }
inline void* glMapNamedBuffer(GLuint buffer, GLenum access) { this->_getTable()->glMapNamedBuffer(buffer, access); }
inline void* glMapNamedBufferRangeEXT(GLuint buffer, GLintptr offset, GLsizeiptr length, GLbitfield access) { this->_getTable()->glMapNamedBufferRangeEXT(buffer, offset, length, access); }
inline void* glMapNamedBufferRange(GLuint buffer, GLintptr offset, GLsizeiptr length, GLbitfield access) { this->_getTable()->glMapNamedBufferRange(buffer, offset, length, access); }
inline void* glMapObjectBufferATI(GLuint buffer) { this->_getTable()->glMapObjectBufferATI(buffer); }
...
inline void* glMapTexture2DINTEL(GLuint texture, GLint level, GLbitfield access, GLint* stride, GLenum* layout) { this->_getTable()->glMapTexture2DINTEL(texture, level, access, stride, layout); }
