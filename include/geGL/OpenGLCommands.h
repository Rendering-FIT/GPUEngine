...
namespace ge{
  namespace gl{
    ...
    template<typename OUTPUT_TO,typename...ARGS_TO,typename OUTPUT_FROM,typename... ARGS_FROM,std::size_t...I,typename std::enable_if<!std::is_same<OUTPUT_TO,void>::value,unsigned>::type = 0>
      void callProviderMethod(OUTPUT_FROM o,std::tuple<ARGS_FROM...>const&args,OUTPUT_TO(opengl::Context::*f)(ARGS_TO...)const,ge::core::index_sequence<I...>){
        assert(opengl::getDefaultContext()!=nullptr);
        auto prov = &*opengl::getDefaultContext();
        assert(prov!=nullptr);
        assert(o!=nullptr);
    ...
    template<typename OUTPUT_TO,typename...ARGS_TO,typename OUTPUT_FROM,typename... ARGS_FROM,typename std::enable_if<!std::is_same<OUTPUT_TO,void>::value,unsigned>::type = 0>
      std::shared_ptr<ge::core::Command>createCommand(OUTPUT_TO(opengl::Context::*fce)(ARGS_TO...)const,OUTPUT_FROM output,ARGS_FROM...args){
        class FunctionCommand: public ge::core::Command{
          public:
            OUTPUT_FROM _output;
            std::tuple<ARGS_FROM...>_args;
            OUTPUT_TO(opengl::Context::*_impl)(ARGS_TO...)const;
            FunctionCommand(OUTPUT_TO(opengl::Context::*f)(ARGS_TO...)const,OUTPUT_FROM o,ARGS_FROM...ar){
              assert(this!=nullptr);
              this->_output = o;
    ...
    template<typename...TO,typename...FROM,std::size_t...I>
      void callProviderMethod(std::tuple<FROM...>const&args,void(opengl::Context::*f)(TO...),ge::core::index_sequence<I...>){
        assert(opengl::getDefaultContext()!=nullptr);
        auto prov = &*opengl::getDefaultContext();
        assert(prov!=nullptr);
    ...
    template<typename...TO,typename...FROM>
      std::shared_ptr<ge::core::Command>createCommand(void(opengl::Context::*fce)(TO...),FROM...args){
        class FunctionCommand: public ge::core::Command{
          public:
            std::tuple<FROM...>_args;
            void(opengl::Context::*_impl)(TO...);
            FunctionCommand(void(opengl::Context::*f)(TO...),FROM...ar){
              assert(this!=nullptr);
