#ifndef GEPARSER_EXPORT_
#define GEPARSER_EXPORT_
...
#      define GEPARSER_EXPORT
#   elif defined(GEPARSER_LIBRARY)
#      define GEPARSER_EXPORT __declspec(dllexport)
#   else
#      define GEPARSER_EXPORT __declspec(dllimport)
#   endif
#else
#   ifdef GEPARSER_LIBRARY
#      define GEPARSER_EXPORT __attribute__ ((visibility("default")))
#   else
#      define GEPARSER_EXPORT
#   endif
#endif
