inline void glMultiDrawArraysIndirectBindlessCountNV(GLenum mode,const void* indirect,GLsizei drawCount,GLsizei maxDrawCount,GLsizei stride,GLint vertexBufferCount)const{(this->*(this->m_ptr_glMultiDrawArraysIndirectBindlessCountNV))(mode,indirect,drawCount,maxDrawCount,stride,vertexBufferCount);}
...
inline void glGetListParameterivSGIX(GLuint list,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetListParameterivSGIX))(list,pname,params);}
inline void glProgramUniform1i64ARB(GLuint program,GLint location,GLint64 x)const{(this->*(this->m_ptr_glProgramUniform1i64ARB))(program,location,x);}
...
inline void glHintPGI(GLenum target,GLint mode)const{(this->*(this->m_ptr_glHintPGI))(target,mode);}
...
inline void glTexRenderbufferNV(GLenum target,GLuint renderbuffer)const{(this->*(this->m_ptr_glTexRenderbufferNV))(target,renderbuffer);}
inline void glVertexAttrib3hvNV(GLuint index,const GLhalfNV* v)const{(this->*(this->m_ptr_glVertexAttrib3hvNV))(index,v);}
inline void glProgramUniform4ui64ARB(GLuint program,GLint location,GLuint64 x,GLuint64 y,GLuint64 z,GLuint64 w)const{(this->*(this->m_ptr_glProgramUniform4ui64ARB))(program,location,x,y,z,w);}
inline void glInstrumentsBufferSGIX(GLsizei size,GLint* buffer)const{(this->*(this->m_ptr_glInstrumentsBufferSGIX))(size,buffer);}
inline void glIndexi(GLint c)const{(this->*(this->m_ptr_glIndexi))(c);}
inline void glMultiTexCoord2sARB(GLenum target,GLshort s,GLshort t)const{(this->*(this->m_ptr_glMultiTexCoord2sARB))(target,s,t);}
inline void glProgramEnvParameter4fARB(GLenum target,GLuint index,GLfloat x,GLfloat y,GLfloat z,GLfloat w)const{(this->*(this->m_ptr_glProgramEnvParameter4fARB))(target,index,x,y,z,w);}
...
inline void glSecondaryColor3hvNV(const GLhalfNV* v)const{(this->*(this->m_ptr_glSecondaryColor3hvNV))(v);}
inline void glIndexf(GLfloat c)const{(this->*(this->m_ptr_glIndexf))(c);}
inline void glFrustumxOES(GLfixed l,GLfixed r,GLfixed b,GLfixed t,GLfixed n,GLfixed f)const{(this->*(this->m_ptr_glFrustumxOES))(l,r,b,t,n,f);}
...
inline void glDrawCommandsStatesNV(GLuint buffer,const GLintptr* indirects,const GLsizei* sizes,const GLuint* states,const GLuint* fbos,GLuint count)const{(this->*(this->m_ptr_glDrawCommandsStatesNV))(buffer,indirects,sizes,states,fbos,count);}
...
inline void glProgramUniform3ui64ARB(GLuint program,GLint location,GLuint64 x,GLuint64 y,GLuint64 z)const{(this->*(this->m_ptr_glProgramUniform3ui64ARB))(program,location,x,y,z);}
...
inline void glColor4ubVertex2fSUN(GLubyte r,GLubyte g,GLubyte b,GLubyte a,GLfloat x,GLfloat y)const{(this->*(this->m_ptr_glColor4ubVertex2fSUN))(r,g,b,a,x,y);}
...
inline void glPathGlyphsNV(GLuint firstPathName,GLenum fontTarget,const void* fontName,GLbitfield fontStyle,GLsizei numGlyphs,GLenum type,const void* charcodes,GLenum handleMissingGlyphs,GLuint pathParameterTemplate,GLfloat emScale)const{(this->*(this->m_ptr_glPathGlyphsNV))(firstPathName,fontTarget,fontName,fontStyle,numGlyphs,type,charcodes,handleMissingGlyphs,pathParameterTemplate,emScale);}
inline void glSecondaryColor3fv(const GLfloat* v)const{(this->*(this->m_ptr_glSecondaryColor3fv))(v);}
inline void glGetCombinerInputParameterivNV(GLenum stage,GLenum portion,GLenum variable,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetCombinerInputParameterivNV))(stage,portion,variable,pname,params);}
inline void glEndPerfMonitorAMD(GLuint monitor)const{(this->*(this->m_ptr_glEndPerfMonitorAMD))(monitor);}
inline void glPointParameterfvARB(GLenum pname,const GLfloat* params)const{(this->*(this->m_ptr_glPointParameterfvARB))(pname,params);}
inline void glVertex2xOES(GLfixed x)const{(this->*(this->m_ptr_glVertex2xOES))(x);}
...
inline void glMultTransposeMatrixdARB(const GLdouble* m)const{(this->*(this->m_ptr_glMultTransposeMatrixdARB))(m);}
...
inline void glCoverStrokePathInstancedNV(GLsizei numPaths,GLenum pathNameType,const void* paths,GLuint pathBase,GLenum coverMode,GLenum transformType,const GLfloat* transformValues)const{(this->*(this->m_ptr_glCoverStrokePathInstancedNV))(numPaths,pathNameType,paths,pathBase,coverMode,transformType,transformValues);}
inline void glDeformSGIX(GLbitfield mask)const{(this->*(this->m_ptr_glDeformSGIX))(mask);}
inline void glUniform2ui64NV(GLint location,GLuint64EXT x,GLuint64EXT y)const{(this->*(this->m_ptr_glUniform2ui64NV))(location,x,y);}
inline void glCopyPathNV(GLuint resultPath,GLuint srcPath)const{(this->*(this->m_ptr_glCopyPathNV))(resultPath,srcPath);}
...
inline GLvdpauSurfaceNV glVDPAURegisterOutputSurfaceNV(const void* vdpSurface,GLenum target,GLsizei numTextureNames,const GLuint* textureNames)const{return (this->*(this->m_ptr_glVDPAURegisterOutputSurfaceNV))(vdpSurface,target,numTextureNames,textureNames);}
...
inline void glVertexAttrib4ubNV(GLuint index,GLubyte x,GLubyte y,GLubyte z,GLubyte w)const{(this->*(this->m_ptr_glVertexAttrib4ubNV))(index,x,y,z,w);}
inline void glColorMaterial(GLenum face,GLenum mode)const{(this->*(this->m_ptr_glColorMaterial))(face,mode);}
inline void glVertexAttrib2svARB(GLuint index,const GLshort* v)const{(this->*(this->m_ptr_glVertexAttrib2svARB))(index,v);}
inline void glMinSampleShadingARB(GLfloat value)const{(this->*(this->m_ptr_glMinSampleShadingARB))(value);}
inline void glColor3b(GLbyte red,GLbyte green,GLbyte blue)const{(this->*(this->m_ptr_glColor3b))(red,green,blue);}
inline void glReplacementCodeuiTexCoord2fNormal3fVertex3fSUN(GLuint rc,GLfloat s,GLfloat t,GLfloat nx,GLfloat ny,GLfloat nz,GLfloat x,GLfloat y,GLfloat z)const{(this->*(this->m_ptr_glReplacementCodeuiTexCoord2fNormal3fVertex3fSUN))(rc,s,t,nx,ny,nz,x,y,z);}
inline void glColor3f(GLfloat red,GLfloat green,GLfloat blue)const{(this->*(this->m_ptr_glColor3f))(red,green,blue);}
inline void glVDPAUGetSurfaceivNV(GLvdpauSurfaceNV surface,GLenum pname,GLsizei bufSize,GLsizei* length,GLint* values)const{(this->*(this->m_ptr_glVDPAUGetSurfaceivNV))(surface,pname,bufSize,length,values);}
...
inline void glGetInternalformatSampleivNV(GLenum target,GLenum internalformat,GLsizei samples,GLenum pname,GLsizei bufSize,GLint* params)const{(this->*(this->m_ptr_glGetInternalformatSampleivNV))(target,internalformat,samples,pname,bufSize,params);}
...
inline void glVertexAttribs4hvNV(GLuint index,GLsizei n,const GLhalfNV* v)const{(this->*(this->m_ptr_glVertexAttribs4hvNV))(index,n,v);}
inline void glVertexAttrib4NubvARB(GLuint index,const GLubyte* v)const{(this->*(this->m_ptr_glVertexAttrib4NubvARB))(index,v);}
inline void glMultiTexCoord3hvNV(GLenum target,const GLhalfNV* v)const{(this->*(this->m_ptr_glMultiTexCoord3hvNV))(target,v);}
...
inline void glColorPointerListIBM(GLint size,GLenum type,GLint stride,const void** pointer,GLint ptrstride)const{(this->*(this->m_ptr_glColorPointerListIBM))(size,type,stride,pointer,ptrstride);}
...
inline void glGetFragmentMaterialfvSGIX(GLenum face,GLenum pname,GLfloat* params)const{(this->*(this->m_ptr_glGetFragmentMaterialfvSGIX))(face,pname,params);}
inline void glVertex2iv(const GLint* v)const{(this->*(this->m_ptr_glVertex2iv))(v);}
inline void glGetTexEnvxvOES(GLenum target,GLenum pname,GLfixed* params)const{(this->*(this->m_ptr_glGetTexEnvxvOES))(target,pname,params);}
...
inline void glDeformationMap3dSGIX(GLenum target,GLdouble u1,GLdouble u2,GLint ustride,GLint uorder,GLdouble v1,GLdouble v2,GLint vstride,GLint vorder,GLdouble w1,GLdouble w2,GLint wstride,GLint worder,const GLdouble* points)const{(this->*(this->m_ptr_glDeformationMap3dSGIX))(target,u1,u2,ustride,uorder,v1,v2,vstride,vorder,w1,w2,wstride,worder,points);}
...
inline void glTessellationModeAMD(GLenum mode)const{(this->*(this->m_ptr_glTessellationModeAMD))(mode);}
inline void glDrawCommandsAddressNV(GLenum primitiveMode,const GLuint64* indirects,const GLsizei* sizes,GLuint count)const{(this->*(this->m_ptr_glDrawCommandsAddressNV))(primitiveMode,indirects,sizes,count);}
inline void glFogi(GLenum pname,GLint param)const{(this->*(this->m_ptr_glFogi))(pname,param);}
inline void glGetTexParameterxvOES(GLenum target,GLenum pname,GLfixed* params)const{(this->*(this->m_ptr_glGetTexParameterxvOES))(target,pname,params);}
...
inline void glGetPerfMonitorCounterDataAMD(GLuint monitor,GLenum pname,GLsizei dataSize,GLuint* data,GLint* bytesWritten)const{(this->*(this->m_ptr_glGetPerfMonitorCounterDataAMD))(monitor,pname,dataSize,data,bytesWritten);}
...
inline void glListParameterfSGIX(GLuint list,GLenum pname,GLfloat param)const{(this->*(this->m_ptr_glListParameterfSGIX))(list,pname,param);}
...
inline void glFragmentLightModelfSGIX(GLenum pname,GLfloat param)const{(this->*(this->m_ptr_glFragmentLightModelfSGIX))(pname,param);}
...
inline void glBlendEquationSeparateATI(GLenum modeRGB,GLenum modeA)const{(this->*(this->m_ptr_glBlendEquationSeparateATI))(modeRGB,modeA);}
...
inline void glReplacementCodeuiTexCoord2fColor4fNormal3fVertex3fSUN(GLuint rc,GLfloat s,GLfloat t,GLfloat r,GLfloat g,GLfloat b,GLfloat a,GLfloat nx,GLfloat ny,GLfloat nz,GLfloat x,GLfloat y,GLfloat z)const{(this->*(this->m_ptr_glReplacementCodeuiTexCoord2fColor4fNormal3fVertex3fSUN))(rc,s,t,r,g,b,a,nx,ny,nz,x,y,z);}
inline void glReplacementCodeubvSUN(const GLubyte* code)const{(this->*(this->m_ptr_glReplacementCodeubvSUN))(code);}
...
inline void glGetPixelTexGenParameterfvSGIS(GLenum pname,GLfloat* params)const{(this->*(this->m_ptr_glGetPixelTexGenParameterfvSGIS))(pname,params);}
inline void glReplacementCodeuiNormal3fVertex3fSUN(GLuint rc,GLfloat nx,GLfloat ny,GLfloat nz,GLfloat x,GLfloat y,GLfloat z)const{(this->*(this->m_ptr_glReplacementCodeuiNormal3fVertex3fSUN))(rc,nx,ny,nz,x,y,z);}
inline GLuint glGetDebugMessageLogAMD(GLuint count,GLsizei bufsize,GLenum* categories,GLuint* severities,GLuint* ids,GLsizei* lengths,GLchar* message)const{return (this->*(this->m_ptr_glGetDebugMessageLogAMD))(count,bufsize,categories,severities,ids,lengths,message);}
inline void glVertexStream4sATI(GLenum stream,GLshort x,GLshort y,GLshort z,GLshort w)const{(this->*(this->m_ptr_glVertexStream4sATI))(stream,x,y,z,w);}
inline void glVertexAttribs4dvNV(GLuint index,GLsizei count,const GLdouble* v)const{(this->*(this->m_ptr_glVertexAttribs4dvNV))(index,count,v);}
inline void glGetnMapdvARB(GLenum target,GLenum query,GLsizei bufSize,GLdouble* v)const{(this->*(this->m_ptr_glGetnMapdvARB))(target,query,bufSize,v);}
...
inline void glUniform3ui64ARB(GLint location,GLuint64 x,GLuint64 y,GLuint64 z)const{(this->*(this->m_ptr_glUniform3ui64ARB))(location,x,y,z);}
inline void glVertexAttrib2fvNV(GLuint index,const GLfloat* v)const{(this->*(this->m_ptr_glVertexAttrib2fvNV))(index,v);}
...
inline GLboolean glIsProgramNV(GLuint id)const{return (this->*(this->m_ptr_glIsProgramNV))(id);}
...
inline void glVertexAttrib4hvNV(GLuint index,const GLhalfNV* v)const{(this->*(this->m_ptr_glVertexAttrib4hvNV))(index,v);}
...
inline void glVertexAttribL1ui64vNV(GLuint index,const GLuint64EXT* v)const{(this->*(this->m_ptr_glVertexAttribL1ui64vNV))(index,v);}
inline void glClearColorxOES(GLfixed red,GLfixed green,GLfixed blue,GLfixed alpha)const{(this->*(this->m_ptr_glClearColorxOES))(red,green,blue,alpha);}
...
inline void glSampleMaskIndexedNV(GLuint index,GLbitfield mask)const{(this->*(this->m_ptr_glSampleMaskIndexedNV))(index,mask);}
inline void glCompileShaderIncludeARB(GLuint shader,GLsizei count,const GLchar*const* path,const GLint* length)const{(this->*(this->m_ptr_glCompileShaderIncludeARB))(shader,count,path,length);}
inline void glGetArrayObjectfvATI(GLenum array,GLenum pname,GLfloat* params)const{(this->*(this->m_ptr_glGetArrayObjectfvATI))(array,pname,params);}
inline void glVertexStream4svATI(GLenum stream,const GLshort* coords)const{(this->*(this->m_ptr_glVertexStream4svATI))(stream,coords);}
inline void glMultiTexCoord4iARB(GLenum target,GLint s,GLint t,GLint r,GLint q)const{(this->*(this->m_ptr_glMultiTexCoord4iARB))(target,s,t,r,q);}
...
inline void glLoadIdentityDeformationMapSGIX(GLbitfield mask)const{(this->*(this->m_ptr_glLoadIdentityDeformationMapSGIX))(mask);}
...
inline void glVertexAttribs4fvNV(GLuint index,GLsizei count,const GLfloat* v)const{(this->*(this->m_ptr_glVertexAttribs4fvNV))(index,count,v);}
inline void glPauseTransformFeedbackNV()const{(this->*(this->m_ptr_glPauseTransformFeedbackNV))();}
...
inline void glVDPAUSurfaceAccessNV(GLvdpauSurfaceNV surface,GLenum access)const{(this->*(this->m_ptr_glVDPAUSurfaceAccessNV))(surface,access);}
inline void glValidateProgramPipeline(GLuint pipeline)const{(this->*(this->m_ptr_glValidateProgramPipeline))(pipeline);}
inline void glTexPageCommitmentARB(GLenum target,GLint level,GLint xoffset,GLint yoffset,GLint zoffset,GLsizei width,GLsizei height,GLsizei depth,GLboolean commit)const{(this->*(this->m_ptr_glTexPageCommitmentARB))(target,level,xoffset,yoffset,zoffset,width,height,depth,commit);}
inline void glWindowPos3dvARB(const GLdouble* v)const{(this->*(this->m_ptr_glWindowPos3dvARB))(v);}
inline void glStencilStrokePathInstancedNV(GLsizei numPaths,GLenum pathNameType,const void* paths,GLuint pathBase,GLint reference,GLuint mask,GLenum transformType,const GLfloat* transformValues)const{(this->*(this->m_ptr_glStencilStrokePathInstancedNV))(numPaths,pathNameType,paths,pathBase,reference,mask,transformType,transformValues);}
inline void glFogfv(GLenum pname,const GLfloat* params)const{(this->*(this->m_ptr_glFogfv))(pname,params);}
inline void glGenQueriesARB(GLsizei n,GLuint* ids)const{(this->*(this->m_ptr_glGenQueriesARB))(n,ids);}
inline void glProgramUniform2i64NV(GLuint program,GLint location,GLint64EXT x,GLint64EXT y)const{(this->*(this->m_ptr_glProgramUniform2i64NV))(program,location,x,y);}
inline void glVertexP4ui(GLenum type,GLuint value)const{(this->*(this->m_ptr_glVertexP4ui))(type,value);}
inline void glVertexStream1ivATI(GLenum stream,const GLint* coords)const{(this->*(this->m_ptr_glVertexStream1ivATI))(stream,coords);}
inline void glProgramEnvParameterI4iNV(GLenum target,GLuint index,GLint x,GLint y,GLint z,GLint w)const{(this->*(this->m_ptr_glProgramEnvParameterI4iNV))(target,index,x,y,z,w);}
inline void glGenVertexArraysAPPLE(GLsizei n,GLuint* arrays)const{(this->*(this->m_ptr_glGenVertexArraysAPPLE))(n,arrays);}
...
inline void glStencilThenCoverStrokePathNV(GLuint path,GLint reference,GLuint mask,GLenum coverMode)const{(this->*(this->m_ptr_glStencilThenCoverStrokePathNV))(path,reference,mask,coverMode);}
inline void glDeleteVertexArraysAPPLE(GLsizei n,const GLuint* arrays)const{(this->*(this->m_ptr_glDeleteVertexArraysAPPLE))(n,arrays);}
inline void glGetNamedBufferParameterui64vNV(GLuint buffer,GLenum pname,GLuint64EXT* params)const{(this->*(this->m_ptr_glGetNamedBufferParameterui64vNV))(buffer,pname,params);}
inline GLbitfield glQueryMatrixxOES(GLfixed* mantissa,GLint* exponent)const{return (this->*(this->m_ptr_glQueryMatrixxOES))(mantissa,exponent);}
inline void glSecondaryColor3usv(const GLushort* v)const{(this->*(this->m_ptr_glSecondaryColor3usv))(v);}
inline void glTranslatexOES(GLfixed x,GLfixed y,GLfixed z)const{(this->*(this->m_ptr_glTranslatexOES))(x,y,z);}
inline void glDrawTransformFeedback(GLenum mode,GLuint id)const{(this->*(this->m_ptr_glDrawTransformFeedback))(mode,id);}
inline void glTexCoord2fColor4fNormal3fVertex3fvSUN(const GLfloat* tc,const GLfloat* c,const GLfloat* n,const GLfloat* v)const{(this->*(this->m_ptr_glTexCoord2fColor4fNormal3fVertex3fvSUN))(tc,c,n,v);}
inline GLvdpauSurfaceNV glVDPAURegisterVideoSurfaceNV(const void* vdpSurface,GLenum target,GLsizei numTextureNames,const GLuint* textureNames)const{return (this->*(this->m_ptr_glVDPAURegisterVideoSurfaceNV))(vdpSurface,target,numTextureNames,textureNames);}
...
inline void glUniformui64vNV(GLint location,GLsizei count,const GLuint64EXT* value)const{(this->*(this->m_ptr_glUniformui64vNV))(location,count,value);}
...
inline void glFogCoordhvNV(const GLhalfNV* fog)const{(this->*(this->m_ptr_glFogCoordhvNV))(fog);}
...
inline void glMultiTexCoord1fARB(GLenum target,GLfloat s)const{(this->*(this->m_ptr_glMultiTexCoord1fARB))(target,s);}
...
inline void glDeleteNamesAMD(GLenum identifier,GLuint num,const GLuint* names)const{(this->*(this->m_ptr_glDeleteNamesAMD))(identifier,num,names);}
...
inline void glColor4xOES(GLfixed red,GLfixed green,GLfixed blue,GLfixed alpha)const{(this->*(this->m_ptr_glColor4xOES))(red,green,blue,alpha);}
inline void glTexImage4DSGIS(GLenum target,GLint level,GLenum internalformat,GLsizei width,GLsizei height,GLsizei depth,GLsizei size4d,GLint border,GLenum format,GLenum type,const void* pixels)const{(this->*(this->m_ptr_glTexImage4DSGIS))(target,level,internalformat,width,height,depth,size4d,border,format,type,pixels);}
...
inline void glDeleteBuffersARB(GLsizei n,const GLuint* buffers)const{(this->*(this->m_ptr_glDeleteBuffersARB))(n,buffers);}
inline GLboolean glUnmapBufferARB(GLenum target)const{return (this->*(this->m_ptr_glUnmapBufferARB))(target);}
...
inline void glMaterialxOES(GLenum face,GLenum pname,GLfixed param)const{(this->*(this->m_ptr_glMaterialxOES))(face,pname,param);}
...
inline GLboolean glTestObjectAPPLE(GLenum object,GLuint name)const{return (this->*(this->m_ptr_glTestObjectAPPLE))(object,name);}
...
inline void glVertexAttribL1ui64ARB(GLuint index,GLuint64EXT x)const{(this->*(this->m_ptr_glVertexAttribL1ui64ARB))(index,x);}
inline void glEndFragmentShaderATI()const{(this->*(this->m_ptr_glEndFragmentShaderATI))();}
inline void glPathParameterivNV(GLuint path,GLenum pname,const GLint* value)const{(this->*(this->m_ptr_glPathParameterivNV))(path,pname,value);}
...
inline void glGetTexBumpParameterivATI(GLenum pname,GLint* param)const{(this->*(this->m_ptr_glGetTexBumpParameterivATI))(pname,param);}
...
inline void glEndOcclusionQueryNV()const{(this->*(this->m_ptr_glEndOcclusionQueryNV))();}
...
inline void glFramebufferTextureLayerARB(GLenum target,GLenum attachment,GLuint texture,GLint level,GLint layer)const{(this->*(this->m_ptr_glFramebufferTextureLayerARB))(target,attachment,texture,level,layer);}
inline void glVertexAttribL2dvEXT(GLuint index,const GLdouble* v)const{(this->*(this->m_ptr_glVertexAttribL2dvEXT))(index,v);}
inline void glGetCombinerStageParameterfvNV(GLenum stage,GLenum pname,GLfloat* params)const{(this->*(this->m_ptr_glGetCombinerStageParameterfvNV))(stage,pname,params);}
inline void glMultiTexCoord1xvOES(GLenum texture,const GLfixed* coords)const{(this->*(this->m_ptr_glMultiTexCoord1xvOES))(texture,coords);}
...
inline void glElementPointerAPPLE(GLenum type,const void* pointer)const{(this->*(this->m_ptr_glElementPointerAPPLE))(type,pointer);}
inline void glVertexStream1fATI(GLenum stream,GLfloat x)const{(this->*(this->m_ptr_glVertexStream1fATI))(stream,x);}
inline void glCoverageModulationNV(GLenum components)const{(this->*(this->m_ptr_glCoverageModulationNV))(components);}
...
inline void glGetProgramParameterfvNV(GLenum target,GLuint index,GLenum pname,GLfloat* params)const{(this->*(this->m_ptr_glGetProgramParameterfvNV))(target,index,pname,params);}
inline void glMaxShaderCompilerThreadsARB(GLuint count)const{(this->*(this->m_ptr_glMaxShaderCompilerThreadsARB))(count);}
...
inline GLboolean glIsImageHandleResidentNV(GLuint64 handle)const{return (this->*(this->m_ptr_glIsImageHandleResidentNV))(handle);}
...
inline GLboolean glIsVertexArrayAPPLE(GLuint array)const{return (this->*(this->m_ptr_glIsVertexArrayAPPLE))(array);}
...
inline void glMultiTexCoord4fvARB(GLenum target,const GLfloat* v)const{(this->*(this->m_ptr_glMultiTexCoord4fvARB))(target,v);}
inline GLenum glVideoCaptureNV(GLuint video_capture_slot,GLuint* sequence_num,GLuint64EXT* capture_time)const{return (this->*(this->m_ptr_glVideoCaptureNV))(video_capture_slot,sequence_num,capture_time);}
...
inline void glUniform3fvARB(GLint location,GLsizei count,const GLfloat* value)const{(this->*(this->m_ptr_glUniform3fvARB))(location,count,value);}
...
inline void glEvalCoord2xvOES(const GLfixed* coords)const{(this->*(this->m_ptr_glEvalCoord2xvOES))(coords);}
inline void glBindVideoCaptureStreamBufferNV(GLuint video_capture_slot,GLuint stream,GLenum frame_region,GLintptrARB offset)const{(this->*(this->m_ptr_glBindVideoCaptureStreamBufferNV))(video_capture_slot,stream,frame_region,offset);}
inline void glTexImage2DMultisampleCoverageNV(GLenum target,GLsizei coverageSamples,GLsizei colorSamples,GLint internalFormat,GLsizei width,GLsizei height,GLboolean fixedSampleLocations)const{(this->*(this->m_ptr_glTexImage2DMultisampleCoverageNV))(target,coverageSamples,colorSamples,internalFormat,width,height,fixedSampleLocations);}
inline GLint glGetAttribLocationARB(GLhandleARB programObj,const GLcharARB* name)const{return (this->*(this->m_ptr_glGetAttribLocationARB))(programObj,name);}
inline void glDeleteShader(GLuint shader)const{(this->*(this->m_ptr_glDeleteShader))(shader);}
inline void glVertexAttrib1fARB(GLuint index,GLfloat x)const{(this->*(this->m_ptr_glVertexAttrib1fARB))(index,x);}
inline void glTexCoord2fColor4ubVertex3fSUN(GLfloat s,GLfloat t,GLubyte r,GLubyte g,GLubyte b,GLubyte a,GLfloat x,GLfloat y,GLfloat z)const{(this->*(this->m_ptr_glTexCoord2fColor4ubVertex3fSUN))(s,t,r,g,b,a,x,y,z);}
inline void glTexCoord4fVertex4fSUN(GLfloat s,GLfloat t,GLfloat p,GLfloat q,GLfloat x,GLfloat y,GLfloat z,GLfloat w)const{(this->*(this->m_ptr_glTexCoord4fVertex4fSUN))(s,t,p,q,x,y,z,w);}
inline void glGetMapdv(GLenum target,GLenum query,GLdouble* v)const{(this->*(this->m_ptr_glGetMapdv))(target,query,v);}
inline void glMapParameterfvNV(GLenum target,GLenum pname,const GLfloat* params)const{(this->*(this->m_ptr_glMapParameterfvNV))(target,pname,params);}
...
inline void glTransformFeedbackAttribsNV(GLsizei count,const GLint* attribs,GLenum bufferMode)const{(this->*(this->m_ptr_glTransformFeedbackAttribsNV))(count,attribs,bufferMode);}
inline void glFragmentLightfvSGIX(GLenum light,GLenum pname,const GLfloat* params)const{(this->*(this->m_ptr_glFragmentLightfvSGIX))(light,pname,params);}
inline void glWindowPos3sARB(GLshort x,GLshort y,GLshort z)const{(this->*(this->m_ptr_glWindowPos3sARB))(x,y,z);}
...
inline GLhandleARB glCreateShaderObjectARB(GLenum shaderType)const{return (this->*(this->m_ptr_glCreateShaderObjectARB))(shaderType);}
...
inline void glGetProgramivARB(GLenum target,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetProgramivARB))(target,pname,params);}
...
inline void glVertexAttrib4dvNV(GLuint index,const GLdouble* v)const{(this->*(this->m_ptr_glVertexAttrib4dvNV))(index,v);}
inline void glVertexAttrib1dvNV(GLuint index,const GLdouble* v)const{(this->*(this->m_ptr_glVertexAttrib1dvNV))(index,v);}
...
inline GLboolean glIsNameAMD(GLenum identifier,GLuint name)const{return (this->*(this->m_ptr_glIsNameAMD))(identifier,name);}
...
inline void glBufferParameteriAPPLE(GLenum target,GLenum pname,GLint param)const{(this->*(this->m_ptr_glBufferParameteriAPPLE))(target,pname,param);}
...
inline void glDebugMessageCallbackARB(GLDEBUGPROCARB callback,const void* userParam)const{(this->*(this->m_ptr_glDebugMessageCallbackARB))(callback,userParam);}
inline const GLubyte* glGetString(GLenum name)const{return (this->*(this->m_ptr_glGetString))(name);}
inline void glGetPathParameterfvNV(GLuint path,GLenum pname,GLfloat* value)const{(this->*(this->m_ptr_glGetPathParameterfvNV))(path,pname,value);}
inline void glLightxvOES(GLenum light,GLenum pname,const GLfixed* params)const{(this->*(this->m_ptr_glLightxvOES))(light,pname,params);}
...
inline void glPrioritizeTexturesxOES(GLsizei n,const GLuint* textures,const GLfixed* priorities)const{(this->*(this->m_ptr_glPrioritizeTexturesxOES))(n,textures,priorities);}
...
inline void glTexCoord3hNV(GLhalfNV s,GLhalfNV t,GLhalfNV r)const{(this->*(this->m_ptr_glTexCoord3hNV))(s,t,r);}
inline void glMultiModeDrawElementsIBM(const GLenum* mode,const GLsizei* count,GLenum type,const void*const* indices,GLsizei primcount,GLint modestride)const{(this->*(this->m_ptr_glMultiModeDrawElementsIBM))(mode,count,type,indices,primcount,modestride);}
...
inline void glClampColorARB(GLenum target,GLenum clamp)const{(this->*(this->m_ptr_glClampColorARB))(target,clamp);}
inline void glColorPointervINTEL(GLint size,GLenum type,const void** pointer)const{(this->*(this->m_ptr_glColorPointervINTEL))(size,type,pointer);}
...
inline void glWindowPos3sMESA(GLshort x,GLshort y,GLshort z)const{(this->*(this->m_ptr_glWindowPos3sMESA))(x,y,z);}
...
inline void glTexCoord2fVertex3fvSUN(const GLfloat* tc,const GLfloat* v)const{(this->*(this->m_ptr_glTexCoord2fVertex3fvSUN))(tc,v);}
inline void glReplacementCodeusSUN(GLushort code)const{(this->*(this->m_ptr_glReplacementCodeusSUN))(code);}
...
inline void glScalexOES(GLfixed x,GLfixed y,GLfixed z)const{(this->*(this->m_ptr_glScalexOES))(x,y,z);}
...
inline void glBeginVideoCaptureNV(GLuint video_capture_slot)const{(this->*(this->m_ptr_glBeginVideoCaptureNV))(video_capture_slot);}
...
inline void glDeleteFencesAPPLE(GLsizei n,const GLuint* fences)const{(this->*(this->m_ptr_glDeleteFencesAPPLE))(n,fences);}
...
inline void glUniformHandleui64ARB(GLint location,GLuint64 value)const{(this->*(this->m_ptr_glUniformHandleui64ARB))(location,value);}
...
inline void glTexCoord2fColor4ubVertex3fvSUN(const GLfloat* tc,const GLubyte* c,const GLfloat* v)const{(this->*(this->m_ptr_glTexCoord2fColor4ubVertex3fvSUN))(tc,c,v);}
...
inline void glTexStorageSparseAMD(GLenum target,GLenum internalFormat,GLsizei width,GLsizei height,GLsizei depth,GLsizei layers,GLbitfield flags)const{(this->*(this->m_ptr_glTexStorageSparseAMD))(target,internalFormat,width,height,depth,layers,flags);}
...
inline void glMultiTexCoord4ivARB(GLenum target,const GLint* v)const{(this->*(this->m_ptr_glMultiTexCoord4ivARB))(target,v);}
inline void glSpriteParameterfSGIX(GLenum pname,GLfloat param)const{(this->*(this->m_ptr_glSpriteParameterfSGIX))(pname,param);}
inline void glSecondaryColor3sv(const GLshort* v)const{(this->*(this->m_ptr_glSecondaryColor3sv))(v);}
inline void glBindVideoCaptureStreamTextureNV(GLuint video_capture_slot,GLuint stream,GLenum frame_region,GLenum target,GLuint texture)const{(this->*(this->m_ptr_glBindVideoCaptureStreamTextureNV))(video_capture_slot,stream,frame_region,target,texture);}
...
inline void glFlushPixelDataRangeNV(GLenum target)const{(this->*(this->m_ptr_glFlushPixelDataRangeNV))(target);}
inline void glWindowPos3fv(const GLfloat* v)const{(this->*(this->m_ptr_glWindowPos3fv))(v);}
inline void glVertexAttribLFormatNV(GLuint index,GLint size,GLenum type,GLsizei stride)const{(this->*(this->m_ptr_glVertexAttribLFormatNV))(index,size,type,stride);}
inline void glLightModelfv(GLenum pname,const GLfloat* params)const{(this->*(this->m_ptr_glLightModelfv))(pname,params);}
inline void glGetColorTableSGI(GLenum target,GLenum format,GLenum type,void* table)const{(this->*(this->m_ptr_glGetColorTableSGI))(target,format,type,table);}
inline void glGetCompressedTexImageARB(GLenum target,GLint level,void* img)const{(this->*(this->m_ptr_glGetCompressedTexImageARB))(target,level,img);}
...
inline void glVertexWeighthNV(GLhalfNV weight)const{(this->*(this->m_ptr_glVertexWeighthNV))(weight);}
...
inline void glColorFragmentOp1ATI(GLenum op,GLuint dst,GLuint dstMask,GLuint dstMod,GLuint arg1,GLuint arg1Rep,GLuint arg1Mod)const{(this->*(this->m_ptr_glColorFragmentOp1ATI))(op,dst,dstMask,dstMod,arg1,arg1Rep,arg1Mod);}
inline void glVertexAttribI4ubvEXT(GLuint index,const GLubyte* v)const{(this->*(this->m_ptr_glVertexAttribI4ubvEXT))(index,v);}
inline void glVertexAttrib1dNV(GLuint index,GLdouble x)const{(this->*(this->m_ptr_glVertexAttrib1dNV))(index,x);}
inline void glUnmapObjectBufferATI(GLuint buffer)const{(this->*(this->m_ptr_glUnmapObjectBufferATI))(buffer);}
...
inline void glUniformHandleui64vNV(GLint location,GLsizei count,const GLuint64* value)const{(this->*(this->m_ptr_glUniformHandleui64vNV))(location,count,value);}
...
inline void glVertexAttrib4sNV(GLuint index,GLshort x,GLshort y,GLshort z,GLshort w)const{(this->*(this->m_ptr_glVertexAttrib4sNV))(index,x,y,z,w);}
...
inline void glGetNamedStringARB(GLint namelen,const GLchar* name,GLsizei bufSize,GLint* stringlen,GLchar* string)const{(this->*(this->m_ptr_glGetNamedStringARB))(namelen,name,bufSize,stringlen,string);}
...
inline void glTexGenxOES(GLenum coord,GLenum pname,GLfixed param)const{(this->*(this->m_ptr_glTexGenxOES))(coord,pname,param);}
inline void glMultiTexCoord1fvARB(GLenum target,const GLfloat* v)const{(this->*(this->m_ptr_glMultiTexCoord1fvARB))(target,v);}
inline void glLightEnviSGIX(GLenum pname,GLint param)const{(this->*(this->m_ptr_glLightEnviSGIX))(pname,param);}
...
inline void glVertexStream2ivATI(GLenum stream,const GLint* coords)const{(this->*(this->m_ptr_glVertexStream2ivATI))(stream,coords);}
...
inline void glGetOcclusionQueryuivNV(GLuint id,GLenum pname,GLuint* params)const{(this->*(this->m_ptr_glGetOcclusionQueryuivNV))(id,pname,params);}
...
inline void glVertexAttribL1i64NV(GLuint index,GLint64EXT x)const{(this->*(this->m_ptr_glVertexAttribL1i64NV))(index,x);}
inline void glVDPAUInitNV(const void* vdpDevice,const void* getProcAddress)const{(this->*(this->m_ptr_glVDPAUInitNV))(vdpDevice,getProcAddress);}
inline void glVertexAttrib1hvNV(GLuint index,const GLhalfNV* v)const{(this->*(this->m_ptr_glVertexAttrib1hvNV))(index,v);}
...
inline void glGetIntegerui64i_vNV(GLenum value,GLuint index,GLuint64EXT* result)const{(this->*(this->m_ptr_glGetIntegerui64i_vNV))(value,index,result);}
inline void glUniformHandleui64NV(GLint location,GLuint64 value)const{(this->*(this->m_ptr_glUniformHandleui64NV))(location,value);}
inline void glWindowPos3ivMESA(const GLint* v)const{(this->*(this->m_ptr_glWindowPos3ivMESA))(v);}
...
inline void glDrawElementsInstancedARB(GLenum mode,GLsizei count,GLenum type,const void* indices,GLsizei primcount)const{(this->*(this->m_ptr_glDrawElementsInstancedARB))(mode,count,type,indices,primcount);}
...
inline void glSamplePatternSGIS(GLenum pattern)const{(this->*(this->m_ptr_glSamplePatternSGIS))(pattern);}
inline void glEGLImageTargetRenderbufferStorageOES(GLenum target,GLeglImageOES image)const{(this->*(this->m_ptr_glEGLImageTargetRenderbufferStorageOES))(target,image);}
inline void glPushAttrib(GLbitfield mask)const{(this->*(this->m_ptr_glPushAttrib))(mask);}
inline void glVertex3hNV(GLhalfNV x,GLhalfNV y,GLhalfNV z)const{(this->*(this->m_ptr_glVertex3hNV))(x,y,z);}
inline void glRasterPos3xvOES(const GLfixed* coords)const{(this->*(this->m_ptr_glRasterPos3xvOES))(coords);}
inline void glPathParameterfNV(GLuint path,GLenum pname,GLfloat value)const{(this->*(this->m_ptr_glPathParameterfNV))(path,pname,value);}
inline void glGetUniformi64vNV(GLuint program,GLint location,GLint64EXT* params)const{(this->*(this->m_ptr_glGetUniformi64vNV))(program,location,params);}
inline void glLightiv(GLenum light,GLenum pname,const GLint* params)const{(this->*(this->m_ptr_glLightiv))(light,pname,params);}
inline void glMaterialxvOES(GLenum face,GLenum pname,const GLfixed* param)const{(this->*(this->m_ptr_glMaterialxvOES))(face,pname,param);}
...
inline void glGetnUniformdvARB(GLuint program,GLint location,GLsizei bufSize,GLdouble* params)const{(this->*(this->m_ptr_glGetnUniformdvARB))(program,location,bufSize,params);}
...
inline void glBeginPerfQueryINTEL(GLuint queryHandle)const{(this->*(this->m_ptr_glBeginPerfQueryINTEL))(queryHandle);}
...
inline void glImageTransformParameterivHP(GLenum target,GLenum pname,const GLint* params)const{(this->*(this->m_ptr_glImageTransformParameterivHP))(target,pname,params);}
...
inline void glWindowPos4fvMESA(const GLfloat* v)const{(this->*(this->m_ptr_glWindowPos4fvMESA))(v);}
...
inline void glProgramBufferParametersfvNV(GLenum target,GLuint bindingIndex,GLuint wordIndex,GLsizei count,const GLfloat* params)const{(this->*(this->m_ptr_glProgramBufferParametersfvNV))(target,bindingIndex,wordIndex,count,params);}
inline void glAlphaFuncxOES(GLenum func,GLfixed ref)const{(this->*(this->m_ptr_glAlphaFuncxOES))(func,ref);}
inline void glMultiDrawArraysIndirectAMD(GLenum mode,const void* indirect,GLsizei primcount,GLsizei stride)const{(this->*(this->m_ptr_glMultiDrawArraysIndirectAMD))(mode,indirect,primcount,stride);}
inline void glNormalStream3ivATI(GLenum stream,const GLint* coords)const{(this->*(this->m_ptr_glNormalStream3ivATI))(stream,coords);}
inline void glTextureImage3DMultisampleNV(GLuint texture,GLenum target,GLsizei samples,GLint internalFormat,GLsizei width,GLsizei height,GLsizei depth,GLboolean fixedSampleLocations)const{(this->*(this->m_ptr_glTextureImage3DMultisampleNV))(texture,target,samples,internalFormat,width,height,depth,fixedSampleLocations);}
...
inline void glReplacementCodeusvSUN(const GLushort* code)const{(this->*(this->m_ptr_glReplacementCodeusvSUN))(code);}
inline GLint glPollInstrumentsSGIX(GLint* marker_p)const{return (this->*(this->m_ptr_glPollInstrumentsSGIX))(marker_p);}
...
inline void glMapControlPointsNV(GLenum target,GLuint index,GLenum type,GLsizei ustride,GLsizei vstride,GLint uorder,GLint vorder,GLboolean packed,const void* points)const{(this->*(this->m_ptr_glMapControlPointsNV))(target,index,type,ustride,vstride,uorder,vorder,packed,points);}
...
inline void glMultiTexCoord1hNV(GLenum target,GLhalfNV s)const{(this->*(this->m_ptr_glMultiTexCoord1hNV))(target,s);}
inline void glPointParameterfv(GLenum pname,const GLfloat* params)const{(this->*(this->m_ptr_glPointParameterfv))(pname,params);}
inline void glUniformMatrix2fvARB(GLint location,GLsizei count,GLboolean transpose,const GLfloat* value)const{(this->*(this->m_ptr_glUniformMatrix2fvARB))(location,count,transpose,value);}
...
inline void glVertexPointerListIBM(GLint size,GLenum type,GLint stride,const void** pointer,GLint ptrstride)const{(this->*(this->m_ptr_glVertexPointerListIBM))(size,type,stride,pointer,ptrstride);}
...
inline void glFinalCombinerInputNV(GLenum variable,GLenum input,GLenum mapping,GLenum componentUsage)const{(this->*(this->m_ptr_glFinalCombinerInputNV))(variable,input,mapping,componentUsage);}
...
inline void glMapVertexAttrib1fAPPLE(GLuint index,GLuint size,GLfloat u1,GLfloat u2,GLint stride,GLint order,const GLfloat* points)const{(this->*(this->m_ptr_glMapVertexAttrib1fAPPLE))(index,size,u1,u2,stride,order,points);}
...
inline void glGlobalAlphaFactorubSUN(GLubyte factor)const{(this->*(this->m_ptr_glGlobalAlphaFactorubSUN))(factor);}
inline void glVertexAttribL1ui64NV(GLuint index,GLuint64EXT x)const{(this->*(this->m_ptr_glVertexAttribL1ui64NV))(index,x);}
inline void glPointParameterfSGIS(GLenum pname,GLfloat param)const{(this->*(this->m_ptr_glPointParameterfSGIS))(pname,param);}
inline void glGetImageTransformParameterivHP(GLenum target,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetImageTransformParameterivHP))(target,pname,params);}
...
inline void glPixelTexGenParameterfvSGIS(GLenum pname,const GLfloat* params)const{(this->*(this->m_ptr_glPixelTexGenParameterfvSGIS))(pname,params);}
...
inline void glQueryObjectParameteruiAMD(GLenum target,GLuint id,GLenum pname,GLuint param)const{(this->*(this->m_ptr_glQueryObjectParameteruiAMD))(target,id,pname,param);}
inline void glVertexAttribs1fvNV(GLuint index,GLsizei count,const GLfloat* v)const{(this->*(this->m_ptr_glVertexAttribs1fvNV))(index,count,v);}
inline void glVertexAttrib4NusvARB(GLuint index,const GLushort* v)const{(this->*(this->m_ptr_glVertexAttrib4NusvARB))(index,v);}
...
inline void glProgramEnvParametersI4ivNV(GLenum target,GLuint index,GLsizei count,const GLint* params)const{(this->*(this->m_ptr_glProgramEnvParametersI4ivNV))(target,index,count,params);}
inline GLenum glPathGlyphIndexArrayNV(GLuint firstPathName,GLenum fontTarget,const void* fontName,GLbitfield fontStyle,GLuint firstGlyphIndex,GLsizei numGlyphs,GLuint pathParameterTemplate,GLfloat emScale)const{return (this->*(this->m_ptr_glPathGlyphIndexArrayNV))(firstPathName,fontTarget,fontName,fontStyle,firstGlyphIndex,numGlyphs,pathParameterTemplate,emScale);}
...
inline void glMultiTexCoord1iARB(GLenum target,GLint s)const{(this->*(this->m_ptr_glMultiTexCoord1iARB))(target,s);}
...
inline void glPassThroughxOES(GLfixed token)const{(this->*(this->m_ptr_glPassThroughxOES))(token);}
inline GLboolean glIsSampler(GLuint sampler)const{return (this->*(this->m_ptr_glIsSampler))(sampler);}
inline void glConservativeRasterParameterfNV(GLenum pname,GLfloat value)const{(this->*(this->m_ptr_glConservativeRasterParameterfNV))(pname,value);}
...
inline void glDrawElementArrayAPPLE(GLenum mode,GLint first,GLsizei count)const{(this->*(this->m_ptr_glDrawElementArrayAPPLE))(mode,first,count);}
...
inline void glSyncTextureINTEL(GLuint texture)const{(this->*(this->m_ptr_glSyncTextureINTEL))(texture);}
inline void glCreateSamplers(GLsizei n,GLuint* samplers)const{(this->*(this->m_ptr_glCreateSamplers))(n,samplers);}
inline void glCombinerParameterfNV(GLenum pname,GLfloat param)const{(this->*(this->m_ptr_glCombinerParameterfNV))(pname,param);}
inline void glGetArrayObjectivATI(GLenum array,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetArrayObjectivATI))(array,pname,params);}
...
inline void glBufferDataARB(GLenum target,GLsizeiptrARB size,const void* data,GLenum usage)const{(this->*(this->m_ptr_glBufferDataARB))(target,size,data,usage);}
...
inline void glNormalStream3dvATI(GLenum stream,const GLdouble* coords)const{(this->*(this->m_ptr_glNormalStream3dvATI))(stream,coords);}
...
inline void glUniform3i64vNV(GLint location,GLsizei count,const GLint64EXT* value)const{(this->*(this->m_ptr_glUniform3i64vNV))(location,count,value);}
inline void glNormal3fVertex3fSUN(GLfloat nx,GLfloat ny,GLfloat nz,GLfloat x,GLfloat y,GLfloat z)const{(this->*(this->m_ptr_glNormal3fVertex3fSUN))(nx,ny,nz,x,y,z);}
...
inline void glMakeImageHandleResidentNV(GLuint64 handle,GLenum access)const{(this->*(this->m_ptr_glMakeImageHandleResidentNV))(handle,access);}
...
inline void glGetnUniformfvARB(GLuint program,GLint location,GLsizei bufSize,GLfloat* params)const{(this->*(this->m_ptr_glGetnUniformfvARB))(program,location,bufSize,params);}
inline void glReplacementCodeuiNormal3fVertex3fvSUN(const GLuint* rc,const GLfloat* n,const GLfloat* v)const{(this->*(this->m_ptr_glReplacementCodeuiNormal3fVertex3fvSUN))(rc,n,v);}
inline void glDeletePerfQueryINTEL(GLuint queryHandle)const{(this->*(this->m_ptr_glDeletePerfQueryINTEL))(queryHandle);}
inline void glActiveVaryingNV(GLuint program,const GLchar* name)const{(this->*(this->m_ptr_glActiveVaryingNV))(program,name);}
inline void glGetActiveUniformARB(GLhandleARB programObj,GLuint index,GLsizei maxLength,GLsizei* length,GLint* size,GLenum* type,GLcharARB* name)const{(this->*(this->m_ptr_glGetActiveUniformARB))(programObj,index,maxLength,length,size,type,name);}
...
inline GLsync glCreateSyncFromCLeventARB(struct _cl_context* context,struct _cl_event* event,GLbitfield flags)const{return (this->*(this->m_ptr_glCreateSyncFromCLeventARB))(context,event,flags);}
inline void glGetPixelMapusv(GLenum map,GLushort* values)const{(this->*(this->m_ptr_glGetPixelMapusv))(map,values);}
inline void glGetnColorTableARB(GLenum target,GLenum format,GLenum type,GLsizei bufSize,void* table)const{(this->*(this->m_ptr_glGetnColorTableARB))(target,format,type,bufSize,table);}
...
inline void glBlendFunciARB(GLuint buf,GLenum src,GLenum dst)const{(this->*(this->m_ptr_glBlendFunciARB))(buf,src,dst);}
inline void glProgramUniform3i64vARB(GLuint program,GLint location,GLsizei count,const GLint64* value)const{(this->*(this->m_ptr_glProgramUniform3i64vARB))(program,location,count,value);}
...
inline void glLightxOES(GLenum light,GLenum pname,GLfixed param)const{(this->*(this->m_ptr_glLightxOES))(light,pname,param);}
...
inline void glVertexStream3sATI(GLenum stream,GLshort x,GLshort y,GLshort z)const{(this->*(this->m_ptr_glVertexStream3sATI))(stream,x,y,z);}
inline void glVertexAttrib3fvARB(GLuint index,const GLfloat* v)const{(this->*(this->m_ptr_glVertexAttrib3fvARB))(index,v);}
...
inline void glProgramUniformHandleui64ARB(GLuint program,GLint location,GLuint64 value)const{(this->*(this->m_ptr_glProgramUniformHandleui64ARB))(program,location,value);}
inline void glUniform3iARB(GLint location,GLint v0,GLint v1,GLint v2)const{(this->*(this->m_ptr_glUniform3iARB))(location,v0,v1,v2);}
inline GLhandleARB glCreateProgramObjectARB()const{return (this->*(this->m_ptr_glCreateProgramObjectARB))();}
inline void glMultiTexCoord1dvARB(GLenum target,const GLdouble* v)const{(this->*(this->m_ptr_glMultiTexCoord1dvARB))(target,v);}
inline void glGetObjectParameterfvARB(GLhandleARB obj,GLenum pname,GLfloat* params)const{(this->*(this->m_ptr_glGetObjectParameterfvARB))(obj,pname,params);}
...
inline void glProgramUniform1i64NV(GLuint program,GLint location,GLint64EXT x)const{(this->*(this->m_ptr_glProgramUniform1i64NV))(program,location,x);}
inline void glGetObjectBufferivATI(GLuint buffer,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetObjectBufferivATI))(buffer,pname,params);}
inline void glUniform4i64ARB(GLint location,GLint64 x,GLint64 y,GLint64 z,GLint64 w)const{(this->*(this->m_ptr_glUniform4i64ARB))(location,x,y,z,w);}
inline void glReplacementCodeuiColor4ubVertex3fvSUN(const GLuint* rc,const GLubyte* c,const GLfloat* v)const{(this->*(this->m_ptr_glReplacementCodeuiColor4ubVertex3fvSUN))(rc,c,v);}
inline void glBlendFuncSeparateINGR(GLenum sfactorRGB,GLenum dfactorRGB,GLenum sfactorAlpha,GLenum dfactorAlpha)const{(this->*(this->m_ptr_glBlendFuncSeparateINGR))(sfactorRGB,dfactorRGB,sfactorAlpha,dfactorAlpha);}
inline void glGetVideoCaptureStreamfvNV(GLuint video_capture_slot,GLuint stream,GLenum pname,GLfloat* params)const{(this->*(this->m_ptr_glGetVideoCaptureStreamfvNV))(video_capture_slot,stream,pname,params);}
inline void glVertexAttrib2fARB(GLuint index,GLfloat x,GLfloat y)const{(this->*(this->m_ptr_glVertexAttrib2fARB))(index,x,y);}
...
inline void glVertexStream1iATI(GLenum stream,GLint x)const{(this->*(this->m_ptr_glVertexStream1iATI))(stream,x);}
...
inline void glProgramUniform1ui64ARB(GLuint program,GLint location,GLuint64 x)const{(this->*(this->m_ptr_glProgramUniform1ui64ARB))(program,location,x);}
...
inline void glGetPixelTexGenParameterivSGIS(GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetPixelTexGenParameterivSGIS))(pname,params);}
...
inline void glSampleMaskSGIS(GLclampf value,GLboolean invert)const{(this->*(this->m_ptr_glSampleMaskSGIS))(value,invert);}
inline void glVertexAttrib4NivARB(GLuint index,const GLint* v)const{(this->*(this->m_ptr_glVertexAttrib4NivARB))(index,v);}
inline void glGlobalAlphaFactorfSUN(GLfloat factor)const{(this->*(this->m_ptr_glGlobalAlphaFactorfSUN))(factor);}
inline void glBlendEquationSeparateIndexedAMD(GLuint buf,GLenum modeRGB,GLenum modeAlpha)const{(this->*(this->m_ptr_glBlendEquationSeparateIndexedAMD))(buf,modeRGB,modeAlpha);}
inline void glGetPerfCounterInfoINTEL(GLuint queryId,GLuint counterId,GLuint counterNameLength,GLchar* counterName,GLuint counterDescLength,GLchar* counterDesc,GLuint* counterOffset,GLuint* counterDataSize,GLuint* counterTypeEnum,GLuint* counterDataTypeEnum,GLuint64* rawCounterMaxValue)const{(this->*(this->m_ptr_glGetPerfCounterInfoINTEL))(queryId,counterId,counterNameLength,counterName,counterDescLength,counterDesc,counterOffset,counterDataSize,counterTypeEnum,counterDataTypeEnum,rawCounterMaxValue);}
inline void glDeleteProgramsNV(GLsizei n,const GLuint* programs)const{(this->*(this->m_ptr_glDeleteProgramsNV))(n,programs);}
inline void glPixelZoomxOES(GLfixed xfactor,GLfixed yfactor)const{(this->*(this->m_ptr_glPixelZoomxOES))(xfactor,yfactor);}
inline void glGetCombinerOutputParameterivNV(GLenum stage,GLenum portion,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetCombinerOutputParameterivNV))(stage,portion,pname,params);}
inline void glRasterPos2xvOES(const GLfixed* coords)const{(this->*(this->m_ptr_glRasterPos2xvOES))(coords);}
...
inline void glUniform1ui64NV(GLint location,GLuint64EXT x)const{(this->*(this->m_ptr_glUniform1ui64NV))(location,x);}
...
inline void glNormal3xOES(GLfixed nx,GLfixed ny,GLfixed nz)const{(this->*(this->m_ptr_glNormal3xOES))(nx,ny,nz);}
inline void glGetMapfv(GLenum target,GLenum query,GLfloat* v)const{(this->*(this->m_ptr_glGetMapfv))(target,query,v);}
inline void glVertexStream2dvATI(GLenum stream,const GLdouble* coords)const{(this->*(this->m_ptr_glVertexStream2dvATI))(stream,coords);}
inline void glPathStencilDepthOffsetNV(GLfloat factor,GLfloat units)const{(this->*(this->m_ptr_glPathStencilDepthOffsetNV))(factor,units);}
inline GLboolean glIsStateNV(GLuint state)const{return (this->*(this->m_ptr_glIsStateNV))(state);}
inline void glGetIntegerui64vNV(GLenum value,GLuint64EXT* result)const{(this->*(this->m_ptr_glGetIntegerui64vNV))(value,result);}
...
inline void glWindowPos2fMESA(GLfloat x,GLfloat y)const{(this->*(this->m_ptr_glWindowPos2fMESA))(x,y);}
...
inline GLuint glGenPathsNV(GLsizei range)const{return (this->*(this->m_ptr_glGenPathsNV))(range);}
...
inline void glVertexAttrib4ubvARB(GLuint index,const GLubyte* v)const{(this->*(this->m_ptr_glVertexAttrib4ubvARB))(index,v);}
inline void glDrawTextureNV(GLuint texture,GLuint sampler,GLfloat x0,GLfloat y0,GLfloat x1,GLfloat y1,GLfloat z,GLfloat s0,GLfloat t0,GLfloat s1,GLfloat t1)const{(this->*(this->m_ptr_glDrawTextureNV))(texture,sampler,x0,y0,x1,y1,z,s0,t0,s1,t1);}
inline void glVertexAttribs1svNV(GLuint index,GLsizei count,const GLshort* v)const{(this->*(this->m_ptr_glVertexAttribs1svNV))(index,count,v);}
...
inline void glPointParameterfARB(GLenum pname,GLfloat param)const{(this->*(this->m_ptr_glPointParameterfARB))(pname,param);}
...
inline void glWindowPos2dMESA(GLdouble x,GLdouble y)const{(this->*(this->m_ptr_glWindowPos2dMESA))(x,y);}
...
inline void glCompressedTexSubImage1DARB(GLenum target,GLint level,GLint xoffset,GLsizei width,GLenum format,GLsizei imageSize,const void* data)const{(this->*(this->m_ptr_glCompressedTexSubImage1DARB))(target,level,xoffset,width,format,imageSize,data);}
...
inline void glProgramEnvParameterI4uiNV(GLenum target,GLuint index,GLuint x,GLuint y,GLuint z,GLuint w)const{(this->*(this->m_ptr_glProgramEnvParameterI4uiNV))(target,index,x,y,z,w);}
...
inline void glProgramUniform4i64vARB(GLuint program,GLint location,GLsizei count,const GLint64* value)const{(this->*(this->m_ptr_glProgramUniform4i64vARB))(program,location,count,value);}
inline void glVertexAttrib4Nuiv(GLuint index,const GLuint* v)const{(this->*(this->m_ptr_glVertexAttrib4Nuiv))(index,v);}
inline void glGetUniformfvARB(GLhandleARB programObj,GLint location,GLfloat* params)const{(this->*(this->m_ptr_glGetUniformfvARB))(programObj,location,params);}
...
inline void glVertexAttrib2hvNV(GLuint index,const GLhalfNV* v)const{(this->*(this->m_ptr_glVertexAttrib2hvNV))(index,v);}
...
inline void glSetFragmentShaderConstantATI(GLuint dst,const GLfloat* value)const{(this->*(this->m_ptr_glSetFragmentShaderConstantATI))(dst,value);}
...
inline void glReplacementCodeuiSUN(GLuint code)const{(this->*(this->m_ptr_glReplacementCodeuiSUN))(code);}
inline void glStateCaptureNV(GLuint state,GLenum mode)const{(this->*(this->m_ptr_glStateCaptureNV))(state,mode);}
...
inline void glWeightusvARB(GLint size,const GLushort* weights)const{(this->*(this->m_ptr_glWeightusvARB))(size,weights);}
...
inline void glGetTexLevelParameterxvOES(GLenum target,GLint level,GLenum pname,GLfixed* params)const{(this->*(this->m_ptr_glGetTexLevelParameterxvOES))(target,level,pname,params);}
...
inline void glAlphaFragmentOp2ATI(GLenum op,GLuint dst,GLuint dstMod,GLuint arg1,GLuint arg1Rep,GLuint arg1Mod,GLuint arg2,GLuint arg2Rep,GLuint arg2Mod)const{(this->*(this->m_ptr_glAlphaFragmentOp2ATI))(op,dst,dstMod,arg1,arg1Rep,arg1Mod,arg2,arg2Rep,arg2Mod);}
...
inline void glGetnTexImageARB(GLenum target,GLint level,GLenum format,GLenum type,GLsizei bufSize,void* img)const{(this->*(this->m_ptr_glGetnTexImageARB))(target,level,format,type,bufSize,img);}
inline void glClear(GLbitfield mask)const{(this->*(this->m_ptr_glClear))(mask);}
inline void glVertexArrayParameteriAPPLE(GLenum pname,GLint param)const{(this->*(this->m_ptr_glVertexArrayParameteriAPPLE))(pname,param);}
inline void glMultiTexCoord2dvARB(GLenum target,const GLdouble* v)const{(this->*(this->m_ptr_glMultiTexCoord2dvARB))(target,v);}
inline void glGetVideoCaptureStreamdvNV(GLuint video_capture_slot,GLuint stream,GLenum pname,GLdouble* params)const{(this->*(this->m_ptr_glGetVideoCaptureStreamdvNV))(video_capture_slot,stream,pname,params);}
inline void glFragmentLightModelivSGIX(GLenum pname,const GLint* params)const{(this->*(this->m_ptr_glFragmentLightModelivSGIX))(pname,params);}
...
inline void glTexCoord4hNV(GLhalfNV s,GLhalfNV t,GLhalfNV r,GLhalfNV q)const{(this->*(this->m_ptr_glTexCoord4hNV))(s,t,r,q);}
...
inline void glDeletePerfMonitorsAMD(GLsizei n,GLuint* monitors)const{(this->*(this->m_ptr_glDeletePerfMonitorsAMD))(n,monitors);}
inline GLboolean glIsRenderbufferEXT(GLuint renderbuffer)const{return (this->*(this->m_ptr_glIsRenderbufferEXT))(renderbuffer);}
inline void glDrawCommandsNV(GLenum primitiveMode,GLuint buffer,const GLintptr* indirects,const GLsizei* sizes,GLuint count)const{(this->*(this->m_ptr_glDrawCommandsNV))(primitiveMode,buffer,indirects,sizes,count);}
inline void glUniform3ivARB(GLint location,GLsizei count,const GLint* value)const{(this->*(this->m_ptr_glUniform3ivARB))(location,count,value);}
...
inline void glRequestResidentProgramsNV(GLsizei n,const GLuint* programs)const{(this->*(this->m_ptr_glRequestResidentProgramsNV))(n,programs);}
inline void glAlphaFragmentOp1ATI(GLenum op,GLuint dst,GLuint dstMod,GLuint arg1,GLuint arg1Rep,GLuint arg1Mod)const{(this->*(this->m_ptr_glAlphaFragmentOp1ATI))(op,dst,dstMod,arg1,arg1Rep,arg1Mod);}
...
inline void glMatrixMult3x3fNV(GLenum matrixMode,const GLfloat* m)const{(this->*(this->m_ptr_glMatrixMult3x3fNV))(matrixMode,m);}
...
inline void glPathSubCommandsNV(GLuint path,GLsizei commandStart,GLsizei commandsToDelete,GLsizei numCommands,const GLubyte* commands,GLsizei numCoords,GLenum coordType,const void* coords)const{(this->*(this->m_ptr_glPathSubCommandsNV))(path,commandStart,commandsToDelete,numCommands,commands,numCoords,coordType,coords);}
inline void glGetFinalCombinerInputParameterivNV(GLenum variable,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetFinalCombinerInputParameterivNV))(variable,pname,params);}
...
inline void glFrustumfOES(GLfloat l,GLfloat r,GLfloat b,GLfloat t,GLfloat n,GLfloat f)const{(this->*(this->m_ptr_glFrustumfOES))(l,r,b,t,n,f);}
...
inline void glMultiTexCoord2svARB(GLenum target,const GLshort* v)const{(this->*(this->m_ptr_glMultiTexCoord2svARB))(target,v);}
inline void glDisableVertexAttribArray(GLuint index)const{(this->*(this->m_ptr_glDisableVertexAttribArray))(index);}
inline void glWindowPos3ivARB(const GLint* v)const{(this->*(this->m_ptr_glWindowPos3ivARB))(v);}
inline void glTexCoordFormatNV(GLint size,GLenum type,GLsizei stride)const{(this->*(this->m_ptr_glTexCoordFormatNV))(size,type,stride);}
...
inline void glReplacementCodeuiColor4fNormal3fVertex3fSUN(GLuint rc,GLfloat r,GLfloat g,GLfloat b,GLfloat a,GLfloat nx,GLfloat ny,GLfloat nz,GLfloat x,GLfloat y,GLfloat z)const{(this->*(this->m_ptr_glReplacementCodeuiColor4fNormal3fVertex3fSUN))(rc,r,g,b,a,nx,ny,nz,x,y,z);}
...
inline void glMatrixIndexPointerARB(GLint size,GLenum type,GLsizei stride,const void* pointer)const{(this->*(this->m_ptr_glMatrixIndexPointerARB))(size,type,stride,pointer);}
...
inline void glVertexAttrib2fNV(GLuint index,GLfloat x,GLfloat y)const{(this->*(this->m_ptr_glVertexAttrib2fNV))(index,x,y);}
...
inline void glEndConditionalRenderNVX()const{(this->*(this->m_ptr_glEndConditionalRenderNVX))();}
inline void glBinormal3fEXT(GLfloat bx,GLfloat by,GLfloat bz)const{(this->*(this->m_ptr_glBinormal3fEXT))(bx,by,bz);}
inline void glNormalStream3iATI(GLenum stream,GLint nx,GLint ny,GLint nz)const{(this->*(this->m_ptr_glNormalStream3iATI))(stream,nx,ny,nz);}
inline void glProgramBufferParametersIivNV(GLenum target,GLuint bindingIndex,GLuint wordIndex,GLsizei count,const GLint* params)const{(this->*(this->m_ptr_glProgramBufferParametersIivNV))(target,bindingIndex,wordIndex,count,params);}
inline void glMapGrid1xOES(GLint n,GLfixed u1,GLfixed u2)const{(this->*(this->m_ptr_glMapGrid1xOES))(n,u1,u2);}
inline void glGetVertexAttribPointervARB(GLuint index,GLenum pname,void** pointer)const{(this->*(this->m_ptr_glGetVertexAttribPointervARB))(index,pname,pointer);}
...
inline void glUniformui64NV(GLint location,GLuint64EXT value)const{(this->*(this->m_ptr_glUniformui64NV))(location,value);}
inline void glColor4fv(const GLfloat* v)const{(this->*(this->m_ptr_glColor4fv))(v);}
inline void glTexParameterxvOES(GLenum target,GLenum pname,const GLfixed* params)const{(this->*(this->m_ptr_glTexParameterxvOES))(target,pname,params);}
...
inline void glGetProgramLocalParameterfvARB(GLenum target,GLuint index,GLfloat* params)const{(this->*(this->m_ptr_glGetProgramLocalParameterfvARB))(target,index,params);}
inline GLuint glGenFragmentShadersATI(GLuint range)const{return (this->*(this->m_ptr_glGenFragmentShadersATI))(range);}
inline void glTexBumpParameterivATI(GLenum pname,const GLint* param)const{(this->*(this->m_ptr_glTexBumpParameterivATI))(pname,param);}
...
inline void glNormal3xvOES(const GLfixed* coords)const{(this->*(this->m_ptr_glNormal3xvOES))(coords);}
inline void glPassTexCoordATI(GLuint dst,GLuint coord,GLenum swizzle)const{(this->*(this->m_ptr_glPassTexCoordATI))(dst,coord,swizzle);}
inline void glFramebufferTextureFaceARB(GLenum target,GLenum attachment,GLuint texture,GLint level,GLenum face)const{(this->*(this->m_ptr_glFramebufferTextureFaceARB))(target,attachment,texture,level,face);}
...
inline void glVertexAttrib4bvARB(GLuint index,const GLbyte* v)const{(this->*(this->m_ptr_glVertexAttrib4bvARB))(index,v);}
inline void glVertexAttribIFormatNV(GLuint index,GLint size,GLenum type,GLsizei stride)const{(this->*(this->m_ptr_glVertexAttribIFormatNV))(index,size,type,stride);}
...
inline void glGetVertexAttribfvARB(GLuint index,GLenum pname,GLfloat* params)const{(this->*(this->m_ptr_glGetVertexAttribfvARB))(index,pname,params);}
inline void glVertexAttrib2dNV(GLuint index,GLdouble x,GLdouble y)const{(this->*(this->m_ptr_glVertexAttrib2dNV))(index,x,y);}
...
inline void glClientActiveVertexStreamATI(GLenum stream)const{(this->*(this->m_ptr_glClientActiveVertexStreamATI))(stream);}
inline void glRasterPos3xOES(GLfixed x,GLfixed y,GLfixed z)const{(this->*(this->m_ptr_glRasterPos3xOES))(x,y,z);}
...
inline void glUniform4fvARB(GLint location,GLsizei count,const GLfloat* value)const{(this->*(this->m_ptr_glUniform4fvARB))(location,count,value);}
inline void glRenderbufferStorageMultisampleCoverageNV(GLenum target,GLsizei coverageSamples,GLsizei colorSamples,GLenum internalformat,GLsizei width,GLsizei height)const{(this->*(this->m_ptr_glRenderbufferStorageMultisampleCoverageNV))(target,coverageSamples,colorSamples,internalformat,width,height);}
...
inline void glBindAttribLocationARB(GLhandleARB programObj,GLuint index,const GLcharARB* name)const{(this->*(this->m_ptr_glBindAttribLocationARB))(programObj,index,name);}
inline void glBufferAddressRangeNV(GLenum pname,GLuint index,GLuint64EXT address,GLsizeiptr length)const{(this->*(this->m_ptr_glBufferAddressRangeNV))(pname,index,address,length);}
inline void glGenProgramsARB(GLsizei n,GLuint* programs)const{(this->*(this->m_ptr_glGenProgramsARB))(n,programs);}
...
inline void glMultiTexCoord4bvOES(GLenum texture,const GLbyte* coords)const{(this->*(this->m_ptr_glMultiTexCoord4bvOES))(texture,coords);}
...
inline void glColor3fVertex3fSUN(GLfloat r,GLfloat g,GLfloat b,GLfloat x,GLfloat y,GLfloat z)const{(this->*(this->m_ptr_glColor3fVertex3fSUN))(r,g,b,x,y,z);}
inline void glNormal3fVertex3fvSUN(const GLfloat* n,const GLfloat* v)const{(this->*(this->m_ptr_glNormal3fVertex3fvSUN))(n,v);}
...
inline void glProgramLocalParameterI4iNV(GLenum target,GLuint index,GLint x,GLint y,GLint z,GLint w)const{(this->*(this->m_ptr_glProgramLocalParameterI4iNV))(target,index,x,y,z,w);}
...
inline GLenum glPathMemoryGlyphIndexArrayNV(GLuint firstPathName,GLenum fontTarget,GLsizeiptr fontSize,const void* fontData,GLsizei faceIndex,GLuint firstGlyphIndex,GLsizei numGlyphs,GLuint pathParameterTemplate,GLfloat emScale)const{return (this->*(this->m_ptr_glPathMemoryGlyphIndexArrayNV))(firstPathName,fontTarget,fontSize,fontData,faceIndex,firstGlyphIndex,numGlyphs,pathParameterTemplate,emScale);}
...
inline void glVertexAttrib2dvNV(GLuint index,const GLdouble* v)const{(this->*(this->m_ptr_glVertexAttrib2dvNV))(index,v);}
inline void glGenPerfMonitorsAMD(GLsizei n,GLuint* monitors)const{(this->*(this->m_ptr_glGenPerfMonitorsAMD))(n,monitors);}
...
inline void glVertexFormatNV(GLint size,GLenum type,GLsizei stride)const{(this->*(this->m_ptr_glVertexFormatNV))(size,type,stride);}
inline void glBlendFuncIndexedAMD(GLuint buf,GLenum src,GLenum dst)const{(this->*(this->m_ptr_glBlendFuncIndexedAMD))(buf,src,dst);}
...
inline void glVertexAttribL2ui64vNV(GLuint index,const GLuint64EXT* v)const{(this->*(this->m_ptr_glVertexAttribL2ui64vNV))(index,v);}
inline void glVertexAttribL4i64NV(GLuint index,GLint64EXT x,GLint64EXT y,GLint64EXT z,GLint64EXT w)const{(this->*(this->m_ptr_glVertexAttribL4i64NV))(index,x,y,z,w);}
...
inline void glMakeTextureHandleResidentARB(GLuint64 handle)const{(this->*(this->m_ptr_glMakeTextureHandleResidentARB))(handle);}
...
inline void glClipPlanexOES(GLenum plane,const GLfixed* equation)const{(this->*(this->m_ptr_glClipPlanexOES))(plane,equation);}
...
inline void glVertexWeighthvNV(const GLhalfNV* weight)const{(this->*(this->m_ptr_glVertexWeighthvNV))(weight);}
...
inline void glTransformPathNV(GLuint resultPath,GLuint srcPath,GLenum transformType,const GLfloat* transformValues)const{(this->*(this->m_ptr_glTransformPathNV))(resultPath,srcPath,transformType,transformValues);}
inline void glProgramNamedParameter4dNV(GLuint id,GLsizei len,const GLubyte* name,GLdouble x,GLdouble y,GLdouble z,GLdouble w)const{(this->*(this->m_ptr_glProgramNamedParameter4dNV))(id,len,name,x,y,z,w);}
...
inline void glNormal3hvNV(const GLhalfNV* v)const{(this->*(this->m_ptr_glNormal3hvNV))(v);}
inline void glGetCombinerOutputParameterfvNV(GLenum stage,GLenum portion,GLenum pname,GLfloat* params)const{(this->*(this->m_ptr_glGetCombinerOutputParameterfvNV))(stage,portion,pname,params);}
inline void glVertexAttrib4sARB(GLuint index,GLshort x,GLshort y,GLshort z,GLshort w)const{(this->*(this->m_ptr_glVertexAttrib4sARB))(index,x,y,z,w);}
...
inline void glTexCoord2xOES(GLfixed s,GLfixed t)const{(this->*(this->m_ptr_glTexCoord2xOES))(s,t);}
inline GLushort glGetStageIndexNV(GLenum shadertype)const{return (this->*(this->m_ptr_glGetStageIndexNV))(shadertype);}
inline void glProgramUniform4i64vNV(GLuint program,GLint location,GLsizei count,const GLint64EXT* value)const{(this->*(this->m_ptr_glProgramUniform4i64vNV))(program,location,count,value);}
...
inline void glTextureBarrierNV()const{(this->*(this->m_ptr_glTextureBarrierNV))();}
inline void glColor4ubVertex3fvSUN(const GLubyte* c,const GLfloat* v)const{(this->*(this->m_ptr_glColor4ubVertex3fvSUN))(c,v);}
inline GLuint glGetCommandHeaderNV(GLenum tokenID,GLuint size)const{return (this->*(this->m_ptr_glGetCommandHeaderNV))(tokenID,size);}
inline void glGetPerfMonitorCounterInfoAMD(GLuint group,GLuint counter,GLenum pname,void* data)const{(this->*(this->m_ptr_glGetPerfMonitorCounterInfoAMD))(group,counter,pname,data);}
inline void glVertexAttrib1svARB(GLuint index,const GLshort* v)const{(this->*(this->m_ptr_glVertexAttrib1svARB))(index,v);}
inline void glCombinerParameteriNV(GLenum pname,GLint param)const{(this->*(this->m_ptr_glCombinerParameteriNV))(pname,param);}
inline void glMatrixMultTransposefEXT(GLenum mode,const GLfloat* m)const{(this->*(this->m_ptr_glMatrixMultTransposefEXT))(mode,m);}
inline void glDetailTexFuncSGIS(GLenum target,GLsizei n,const GLfloat* points)const{(this->*(this->m_ptr_glDetailTexFuncSGIS))(target,n,points);}
...
inline void glIndexPointerListIBM(GLenum type,GLint stride,const void** pointer,GLint ptrstride)const{(this->*(this->m_ptr_glIndexPointerListIBM))(type,stride,pointer,ptrstride);}
...
inline void glClientActiveTextureARB(GLenum texture)const{(this->*(this->m_ptr_glClientActiveTextureARB))(texture);}
...
inline void glEdgeFlagFormatNV(GLsizei stride)const{(this->*(this->m_ptr_glEdgeFlagFormatNV))(stride);}
...
inline GLenum glObjectUnpurgeableAPPLE(GLenum objectType,GLuint name,GLenum option)const{return (this->*(this->m_ptr_glObjectUnpurgeableAPPLE))(objectType,name,option);}
inline void glVertexAttribs2dvNV(GLuint index,GLsizei count,const GLdouble* v)const{(this->*(this->m_ptr_glVertexAttribs2dvNV))(index,count,v);}
inline void glReplacementCodeuiTexCoord2fVertex3fSUN(GLuint rc,GLfloat s,GLfloat t,GLfloat x,GLfloat y,GLfloat z)const{(this->*(this->m_ptr_glReplacementCodeuiTexCoord2fVertex3fSUN))(rc,s,t,x,y,z);}
inline void glGetMapParameterfvNV(GLenum target,GLenum pname,GLfloat* params)const{(this->*(this->m_ptr_glGetMapParameterfvNV))(target,pname,params);}
...
inline void glProgramUniform3ui64vNV(GLuint program,GLint location,GLsizei count,const GLuint64EXT* value)const{(this->*(this->m_ptr_glProgramUniform3ui64vNV))(program,location,count,value);}
inline void glRectfv(const GLfloat* v1,const GLfloat* v2)const{(this->*(this->m_ptr_glRectfv))(v1,v2);}
inline void glTexFilterFuncSGIS(GLenum target,GLenum filter,GLsizei n,const GLfloat* weights)const{(this->*(this->m_ptr_glTexFilterFuncSGIS))(target,filter,n,weights);}
inline void glSpriteParameterfvSGIX(GLenum pname,const GLfloat* params)const{(this->*(this->m_ptr_glSpriteParameterfvSGIX))(pname,params);}
...
inline void glColor3hNV(GLhalfNV red,GLhalfNV green,GLhalfNV blue)const{(this->*(this->m_ptr_glColor3hNV))(red,green,blue);}
inline void glViewport(GLint x,GLint y,GLsizei width,GLsizei height)const{(this->*(this->m_ptr_glViewport))(x,y,width,height);}
inline void glProgramNamedParameter4fNV(GLuint id,GLsizei len,const GLubyte* name,GLfloat x,GLfloat y,GLfloat z,GLfloat w)const{(this->*(this->m_ptr_glProgramNamedParameter4fNV))(id,len,name,x,y,z,w);}
...
inline void glWindowPos3dARB(GLdouble x,GLdouble y,GLdouble z)const{(this->*(this->m_ptr_glWindowPos3dARB))(x,y,z);}
inline void glEvalCoord1dv(const GLdouble* u)const{(this->*(this->m_ptr_glEvalCoord1dv))(u);}
inline void glVertexAttribs2fvNV(GLuint index,GLsizei count,const GLfloat* v)const{(this->*(this->m_ptr_glVertexAttribs2fvNV))(index,count,v);}
inline void glRecti(GLint x1,GLint y1,GLint x2,GLint y2)const{(this->*(this->m_ptr_glRecti))(x1,y1,x2,y2);}
inline void glReplacementCodeuiTexCoord2fColor4fNormal3fVertex3fvSUN(const GLuint* rc,const GLfloat* tc,const GLfloat* c,const GLfloat* n,const GLfloat* v)const{(this->*(this->m_ptr_glReplacementCodeuiTexCoord2fColor4fNormal3fVertex3fvSUN))(rc,tc,c,n,v);}
inline void glTexCoord1bOES(GLbyte s)const{(this->*(this->m_ptr_glTexCoord1bOES))(s);}
inline void glProgramUniform2i64vARB(GLuint program,GLint location,GLsizei count,const GLint64* value)const{(this->*(this->m_ptr_glProgramUniform2i64vARB))(program,location,count,value);}
inline void glWindowPos2dARB(GLdouble x,GLdouble y)const{(this->*(this->m_ptr_glWindowPos2dARB))(x,y);}
inline void glGetProgramParameterdvNV(GLenum target,GLuint index,GLenum pname,GLdouble* params)const{(this->*(this->m_ptr_glGetProgramParameterdvNV))(target,index,pname,params);}
...
inline void glGetActiveAttribARB(GLhandleARB programObj,GLuint index,GLsizei maxLength,GLsizei* length,GLint* size,GLenum* type,GLcharARB* name)const{(this->*(this->m_ptr_glGetActiveAttribARB))(programObj,index,maxLength,length,size,type,name);}
...
inline GLuint64 glGetTextureSamplerHandleNV(GLuint texture,GLuint sampler)const{return (this->*(this->m_ptr_glGetTextureSamplerHandleNV))(texture,sampler);}
inline void glDetachShader(GLuint program,GLuint shader)const{(this->*(this->m_ptr_glDetachShader))(program,shader);}
inline void glFinishTextureSUNX()const{(this->*(this->m_ptr_glFinishTextureSUNX))();}
...
inline void glVertexAttrib4fARB(GLuint index,GLfloat x,GLfloat y,GLfloat z,GLfloat w)const{(this->*(this->m_ptr_glVertexAttrib4fARB))(index,x,y,z,w);}
inline void glGetPathColorGenivNV(GLenum color,GLenum pname,GLint* value)const{(this->*(this->m_ptr_glGetPathColorGenivNV))(color,pname,value);}
...
inline void glIndexFormatNV(GLenum type,GLsizei stride)const{(this->*(this->m_ptr_glIndexFormatNV))(type,stride);}
inline void glMultiTexCoord3i(GLenum target,GLint s,GLint t,GLint r)const{(this->*(this->m_ptr_glMultiTexCoord3i))(target,s,t,r);}
inline void glReplacementCodeuiVertex3fvSUN(const GLuint* rc,const GLfloat* v)const{(this->*(this->m_ptr_glReplacementCodeuiVertex3fvSUN))(rc,v);}
...
inline void glTexBumpParameterfvATI(GLenum pname,const GLfloat* param)const{(this->*(this->m_ptr_glTexBumpParameterfvATI))(pname,param);}
inline void glMatrixIndexuivARB(GLint size,const GLuint* indices)const{(this->*(this->m_ptr_glMatrixIndexuivARB))(size,indices);}
inline void glVertexAttrib1hNV(GLuint index,GLhalfNV x)const{(this->*(this->m_ptr_glVertexAttrib1hNV))(index,x);}
inline void glWindowPos3svMESA(const GLshort* v)const{(this->*(this->m_ptr_glWindowPos3svMESA))(v);}
inline void glStencilOpSeparateATI(GLenum face,GLenum sfail,GLenum dpfail,GLenum dppass)const{(this->*(this->m_ptr_glStencilOpSeparateATI))(face,sfail,dpfail,dppass);}
...
inline void glBlendEquationSeparateiARB(GLuint buf,GLenum modeRGB,GLenum modeAlpha)const{(this->*(this->m_ptr_glBlendEquationSeparateiARB))(buf,modeRGB,modeAlpha);}
inline void glVertexAttrib1fNV(GLuint index,GLfloat x)const{(this->*(this->m_ptr_glVertexAttrib1fNV))(index,x);}
inline void glMapVertexAttrib2fAPPLE(GLuint index,GLuint size,GLfloat u1,GLfloat u2,GLint ustride,GLint uorder,GLfloat v1,GLfloat v2,GLint vstride,GLint vorder,const GLfloat* points)const{(this->*(this->m_ptr_glMapVertexAttrib2fAPPLE))(index,size,u1,u2,ustride,uorder,v1,v2,vstride,vorder,points);}
...
inline void glMakeTextureHandleNonResidentARB(GLuint64 handle)const{(this->*(this->m_ptr_glMakeTextureHandleNonResidentARB))(handle);}
inline void glMultiDrawElementArrayAPPLE(GLenum mode,const GLint* first,const GLsizei* count,GLsizei primcount)const{(this->*(this->m_ptr_glMultiDrawElementArrayAPPLE))(mode,first,count,primcount);}
inline void glVertexStream4dATI(GLenum stream,GLdouble x,GLdouble y,GLdouble z,GLdouble w)const{(this->*(this->m_ptr_glVertexStream4dATI))(stream,x,y,z,w);}
...
inline void glVertexAttribs2hvNV(GLuint index,GLsizei n,const GLhalfNV* v)const{(this->*(this->m_ptr_glVertexAttribs2hvNV))(index,n,v);}
...
inline void glClipPlanefOES(GLenum plane,const GLfloat* equation)const{(this->*(this->m_ptr_glClipPlanefOES))(plane,equation);}
...
inline void glValidateProgramARB(GLhandleARB programObj)const{(this->*(this->m_ptr_glValidateProgramARB))(programObj);}
...
inline void glVertexAttrib1fvNV(GLuint index,const GLfloat* v)const{(this->*(this->m_ptr_glVertexAttrib1fvNV))(index,v);}
inline GLboolean glIsQueryARB(GLuint id)const{return (this->*(this->m_ptr_glIsQueryARB))(id);}
...
inline void glProgramLocalParameterI4uiNV(GLenum target,GLuint index,GLuint x,GLuint y,GLuint z,GLuint w)const{(this->*(this->m_ptr_glProgramLocalParameterI4uiNV))(target,index,x,y,z,w);}
inline void glConvolutionParameterxvOES(GLenum target,GLenum pname,const GLfixed* params)const{(this->*(this->m_ptr_glConvolutionParameterxvOES))(target,pname,params);}
...
inline void glMultiTexCoord3ivARB(GLenum target,const GLint* v)const{(this->*(this->m_ptr_glMultiTexCoord3ivARB))(target,v);}
...
inline GLboolean glIsTextureHandleResidentARB(GLuint64 handle)const{return (this->*(this->m_ptr_glIsTextureHandleResidentARB))(handle);}
inline void glRasterPos2dv(const GLdouble* v)const{(this->*(this->m_ptr_glRasterPos2dv))(v);}
inline void glWindowPos4ivMESA(const GLint* v)const{(this->*(this->m_ptr_glWindowPos4ivMESA))(v);}
...
inline void glMultiTexCoord3sARB(GLenum target,GLshort s,GLshort t,GLshort r)const{(this->*(this->m_ptr_glMultiTexCoord3sARB))(target,s,t,r);}
...
inline void glTextureRangeAPPLE(GLenum target,GLsizei length,const void* pointer)const{(this->*(this->m_ptr_glTextureRangeAPPLE))(target,length,pointer);}
inline void glBlendEquationIndexedAMD(GLuint buf,GLenum mode)const{(this->*(this->m_ptr_glBlendEquationIndexedAMD))(buf,mode);}
...
inline void glTexCoord1xvOES(const GLfixed* coords)const{(this->*(this->m_ptr_glTexCoord1xvOES))(coords);}
inline void glVertexAttrib1sARB(GLuint index,GLshort x)const{(this->*(this->m_ptr_glVertexAttrib1sARB))(index,x);}
...
inline void glProgramParameter4dvNV(GLenum target,GLuint index,const GLdouble* v)const{(this->*(this->m_ptr_glProgramParameter4dvNV))(target,index,v);}
...
inline void glGetColorTableParameterfvSGI(GLenum target,GLenum pname,GLfloat* params)const{(this->*(this->m_ptr_glGetColorTableParameterfvSGI))(target,pname,params);}
...
inline void glVertexAttrib2dARB(GLuint index,GLdouble x,GLdouble y)const{(this->*(this->m_ptr_glVertexAttrib2dARB))(index,x,y);}
inline void glMultiTexCoord4dARB(GLenum target,GLdouble s,GLdouble t,GLdouble r,GLdouble q)const{(this->*(this->m_ptr_glMultiTexCoord4dARB))(target,s,t,r,q);}
inline void glReadnPixelsARB(GLint x,GLint y,GLsizei width,GLsizei height,GLenum format,GLenum type,GLsizei bufSize,void* data)const{(this->*(this->m_ptr_glReadnPixelsARB))(x,y,width,height,format,type,bufSize,data);}
...
inline void glWindowPos4dvMESA(const GLdouble* v)const{(this->*(this->m_ptr_glWindowPos4dvMESA))(v);}
...
inline void glSecondaryColorPointerListIBM(GLint size,GLenum type,GLint stride,const void** pointer,GLint ptrstride)const{(this->*(this->m_ptr_glSecondaryColorPointerListIBM))(size,type,stride,pointer,ptrstride);}
...
inline void glPathTexGenNV(GLenum texCoordSet,GLenum genMode,GLint components,const GLfloat* coeffs)const{(this->*(this->m_ptr_glPathTexGenNV))(texCoordSet,genMode,components,coeffs);}
inline void glVertexBlendEnviATI(GLenum pname,GLint param)const{(this->*(this->m_ptr_glVertexBlendEnviATI))(pname,param);}
inline void glUniform3i64ARB(GLint location,GLint64 x,GLint64 y,GLint64 z)const{(this->*(this->m_ptr_glUniform3i64ARB))(location,x,y,z);}
...
inline void glColor3hvNV(const GLhalfNV* v)const{(this->*(this->m_ptr_glColor3hvNV))(v);}
inline void glGetMapAttribParameterfvNV(GLenum target,GLuint index,GLenum pname,GLfloat* params)const{(this->*(this->m_ptr_glGetMapAttribParameterfvNV))(target,index,pname,params);}
...
inline void glGetUniformui64vNV(GLuint program,GLint location,GLuint64EXT* params)const{(this->*(this->m_ptr_glGetUniformui64vNV))(program,location,params);}
...
inline void glVertexAttrib3dNV(GLuint index,GLdouble x,GLdouble y,GLdouble z)const{(this->*(this->m_ptr_glVertexAttrib3dNV))(index,x,y,z);}
...
inline void glPixelTexGenParameteriSGIS(GLenum pname,GLint param)const{(this->*(this->m_ptr_glPixelTexGenParameteriSGIS))(pname,param);}
...
inline void glMultiTexCoord3xvOES(GLenum texture,const GLfixed* coords)const{(this->*(this->m_ptr_glMultiTexCoord3xvOES))(texture,coords);}
inline void glExecuteProgramNV(GLenum target,GLuint id,const GLfloat* params)const{(this->*(this->m_ptr_glExecuteProgramNV))(target,id,params);}
inline void glVariantArrayObjectATI(GLuint id,GLenum type,GLsizei stride,GLuint buffer,GLuint offset)const{(this->*(this->m_ptr_glVariantArrayObjectATI))(id,type,stride,buffer,offset);}
inline void glColor3xvOES(const GLfixed* components)const{(this->*(this->m_ptr_glColor3xvOES))(components);}
inline void glGetnConvolutionFilterARB(GLenum target,GLenum format,GLenum type,GLsizei bufSize,void* image)const{(this->*(this->m_ptr_glGetnConvolutionFilterARB))(target,format,type,bufSize,image);}
inline void glNormalFormatNV(GLenum type,GLsizei stride)const{(this->*(this->m_ptr_glNormalFormatNV))(type,stride);}
...
inline void glGetVertexAttribfvNV(GLuint index,GLenum pname,GLfloat* params)const{(this->*(this->m_ptr_glGetVertexAttribfvNV))(index,pname,params);}
inline void glDrawRangeElementArrayAPPLE(GLenum mode,GLuint start,GLuint end,GLint first,GLsizei count)const{(this->*(this->m_ptr_glDrawRangeElementArrayAPPLE))(mode,start,end,first,count);}
inline void glUniform3i64NV(GLint location,GLint64EXT x,GLint64EXT y,GLint64EXT z)const{(this->*(this->m_ptr_glUniform3i64NV))(location,x,y,z);}
inline void glMatrixPopEXT(GLenum mode)const{(this->*(this->m_ptr_glMatrixPopEXT))(mode);}
inline void glVertexStream1sATI(GLenum stream,GLshort x)const{(this->*(this->m_ptr_glVertexStream1sATI))(stream,x);}
inline void glGetnPixelMapuivARB(GLenum map,GLsizei bufSize,GLuint* values)const{(this->*(this->m_ptr_glGetnPixelMapuivARB))(map,bufSize,values);}
...
inline void glGetPerfMonitorGroupsAMD(GLint* numGroups,GLsizei groupsSize,GLuint* groups)const{(this->*(this->m_ptr_glGetPerfMonitorGroupsAMD))(numGroups,groupsSize,groups);}
inline void glMultTransposeMatrixfARB(const GLfloat* m)const{(this->*(this->m_ptr_glMultTransposeMatrixfARB))(m);}
inline void glVertexAttribI2ivEXT(GLuint index,const GLint* v)const{(this->*(this->m_ptr_glVertexAttribI2ivEXT))(index,v);}
inline void glReplacementCodeuiColor4fNormal3fVertex3fvSUN(const GLuint* rc,const GLfloat* c,const GLfloat* n,const GLfloat* v)const{(this->*(this->m_ptr_glReplacementCodeuiColor4fNormal3fVertex3fvSUN))(rc,c,n,v);}
inline void glDeleteStatesNV(GLsizei n,const GLuint* states)const{(this->*(this->m_ptr_glDeleteStatesNV))(n,states);}
...
inline void glVideoCaptureStreamParameterivNV(GLuint video_capture_slot,GLuint stream,GLenum pname,const GLint* params)const{(this->*(this->m_ptr_glVideoCaptureStreamParameterivNV))(video_capture_slot,stream,pname,params);}
inline void glVertexStream4iATI(GLenum stream,GLint x,GLint y,GLint z,GLint w)const{(this->*(this->m_ptr_glVertexStream4iATI))(stream,x,y,z,w);}
inline void glVDPAUFiniNV()const{(this->*(this->m_ptr_glVDPAUFiniNV))();}
...
inline void glMultiTexCoord1sARB(GLenum target,GLshort s)const{(this->*(this->m_ptr_glMultiTexCoord1sARB))(target,s);}
...
inline void glMakeTextureHandleResidentNV(GLuint64 handle)const{(this->*(this->m_ptr_glMakeTextureHandleResidentNV))(handle);}
inline void glMultMatrixxOES(const GLfixed* m)const{(this->*(this->m_ptr_glMultMatrixxOES))(m);}
inline void glTextureNormalEXT(GLenum mode)const{(this->*(this->m_ptr_glTextureNormalEXT))(mode);}
inline void glGetQueryivARB(GLenum target,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetQueryivARB))(target,pname,params);}
...
inline GLint glGetInstrumentsSGIX()const{return (this->*(this->m_ptr_glGetInstrumentsSGIX))();}
...
inline void glMultiTexCoord2hNV(GLenum target,GLhalfNV s,GLhalfNV t)const{(this->*(this->m_ptr_glMultiTexCoord2hNV))(target,s,t);}
...
inline void glVertexAttrib2hNV(GLuint index,GLhalfNV x,GLhalfNV y)const{(this->*(this->m_ptr_glVertexAttrib2hNV))(index,x,y);}
inline void glCurrentPaletteMatrixARB(GLint index)const{(this->*(this->m_ptr_glCurrentPaletteMatrixARB))(index);}
inline void glFogxvOES(GLenum pname,const GLfixed* param)const{(this->*(this->m_ptr_glFogxvOES))(pname,param);}
...
inline void glCombinerInputNV(GLenum stage,GLenum portion,GLenum variable,GLenum input,GLenum mapping,GLenum componentUsage)const{(this->*(this->m_ptr_glCombinerInputNV))(stage,portion,variable,input,mapping,componentUsage);}
inline void glDepthFunc(GLenum func)const{(this->*(this->m_ptr_glDepthFunc))(func);}
inline void glWindowPos4fMESA(GLfloat x,GLfloat y,GLfloat z,GLfloat w)const{(this->*(this->m_ptr_glWindowPos4fMESA))(x,y,z,w);}
...
inline void glProgramUniform4i64ARB(GLuint program,GLint location,GLint64 x,GLint64 y,GLint64 z,GLint64 w)const{(this->*(this->m_ptr_glProgramUniform4i64ARB))(program,location,x,y,z,w);}
inline void glBlendFunci(GLuint buf,GLenum src,GLenum dst)const{(this->*(this->m_ptr_glBlendFunci))(buf,src,dst);}
inline void glResolveDepthValuesNV()const{(this->*(this->m_ptr_glResolveDepthValuesNV))();}
inline void glTextureColorMaskSGIS(GLboolean red,GLboolean green,GLboolean blue,GLboolean alpha)const{(this->*(this->m_ptr_glTextureColorMaskSGIS))(red,green,blue,alpha);}
...
inline void glMakeNamedBufferNonResidentNV(GLuint buffer)const{(this->*(this->m_ptr_glMakeNamedBufferNonResidentNV))(buffer);}
...
inline void glUniform2ui64ARB(GLint location,GLuint64 x,GLuint64 y)const{(this->*(this->m_ptr_glUniform2ui64ARB))(location,x,y);}
...
inline void glVertexStream1svATI(GLenum stream,const GLshort* coords)const{(this->*(this->m_ptr_glVertexStream1svATI))(stream,coords);}
inline void glVertexStream3fATI(GLenum stream,GLfloat x,GLfloat y,GLfloat z)const{(this->*(this->m_ptr_glVertexStream3fATI))(stream,x,y,z);}
...
inline void glUniform2ui64vNV(GLint location,GLsizei count,const GLuint64EXT* value)const{(this->*(this->m_ptr_glUniform2ui64vNV))(location,count,value);}
inline void glTexCoordPointervINTEL(GLint size,GLenum type,const void** pointer)const{(this->*(this->m_ptr_glTexCoordPointervINTEL))(size,type,pointer);}
...
inline void glVertexAttrib4hNV(GLuint index,GLhalfNV x,GLhalfNV y,GLhalfNV z,GLhalfNV w)const{(this->*(this->m_ptr_glVertexAttrib4hNV))(index,x,y,z,w);}
inline void glNormal3f(GLfloat nx,GLfloat ny,GLfloat nz)const{(this->*(this->m_ptr_glNormal3f))(nx,ny,nz);}
inline void glVertexStream2iATI(GLenum stream,GLint x,GLint y)const{(this->*(this->m_ptr_glVertexStream2iATI))(stream,x,y);}
...
inline void glAsyncMarkerSGIX(GLuint marker)const{(this->*(this->m_ptr_glAsyncMarkerSGIX))(marker);}
inline void glTextureStorageSparseAMD(GLuint texture,GLenum target,GLenum internalFormat,GLsizei width,GLsizei height,GLsizei depth,GLsizei layers,GLbitfield flags)const{(this->*(this->m_ptr_glTextureStorageSparseAMD))(texture,target,internalFormat,width,height,depth,layers,flags);}
...
inline void glEndPerfQueryINTEL(GLuint queryHandle)const{(this->*(this->m_ptr_glEndPerfQueryINTEL))(queryHandle);}
inline void glFragmentLightModeliSGIX(GLenum pname,GLint param)const{(this->*(this->m_ptr_glFragmentLightModeliSGIX))(pname,param);}
...
inline void glGetOcclusionQueryivNV(GLuint id,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetOcclusionQueryivNV))(id,pname,params);}
...
inline void glMultiTexCoord2iARB(GLenum target,GLint s,GLint t)const{(this->*(this->m_ptr_glMultiTexCoord2iARB))(target,s,t);}
...
inline void glWindowPos3dvMESA(const GLdouble* v)const{(this->*(this->m_ptr_glWindowPos3dvMESA))(v);}
...
inline GLboolean glAreProgramsResidentNV(GLsizei n,const GLuint* programs,GLboolean* residences)const{return (this->*(this->m_ptr_glAreProgramsResidentNV))(n,programs,residences);}
...
inline void glVertexStream1dvATI(GLenum stream,const GLdouble* coords)const{(this->*(this->m_ptr_glVertexStream1dvATI))(stream,coords);}
...
inline void glPointSizexOES(GLfixed size)const{(this->*(this->m_ptr_glPointSizexOES))(size);}
...
inline void glBlendParameteriNV(GLenum pname,GLint value)const{(this->*(this->m_ptr_glBlendParameteriNV))(pname,value);}
...
inline void glProgramUniformHandleui64NV(GLuint program,GLint location,GLuint64 value)const{(this->*(this->m_ptr_glProgramUniformHandleui64NV))(program,location,value);}
...
inline void glGetPathMetricsNV(GLbitfield metricQueryMask,GLsizei numPaths,GLenum pathNameType,const void* paths,GLuint pathBase,GLsizei stride,GLfloat* metrics)const{(this->*(this->m_ptr_glGetPathMetricsNV))(metricQueryMask,numPaths,pathNameType,paths,pathBase,stride,metrics);}
...
inline void glMatrixLoad3x3fNV(GLenum matrixMode,const GLfloat* m)const{(this->*(this->m_ptr_glMatrixLoad3x3fNV))(matrixMode,m);}
inline void glMultiTexCoord2fARB(GLenum target,GLfloat s,GLfloat t)const{(this->*(this->m_ptr_glMultiTexCoord2fARB))(target,s,t);}
inline void glWeightdvARB(GLint size,const GLdouble* weights)const{(this->*(this->m_ptr_glWeightdvARB))(size,weights);}
inline GLboolean glIsTransformFeedbackNV(GLuint id)const{return (this->*(this->m_ptr_glIsTransformFeedbackNV))(id);}
inline void glVertexAttribDivisorARB(GLuint index,GLuint divisor)const{(this->*(this->m_ptr_glVertexAttribDivisorARB))(index,divisor);}
inline void glSecondaryColorP3uiv(GLenum type,const GLuint* color)const{(this->*(this->m_ptr_glSecondaryColorP3uiv))(type,color);}
inline void glGetnCompressedTexImageARB(GLenum target,GLint lod,GLsizei bufSize,void* img)const{(this->*(this->m_ptr_glGetnCompressedTexImageARB))(target,lod,bufSize,img);}
...
inline GLfloat glGetPathLengthNV(GLuint path,GLsizei startSegment,GLsizei numSegments)const{return (this->*(this->m_ptr_glGetPathLengthNV))(path,startSegment,numSegments);}
...
inline void glUniform4i64NV(GLint location,GLint64EXT x,GLint64EXT y,GLint64EXT z,GLint64EXT w)const{(this->*(this->m_ptr_glUniform4i64NV))(location,x,y,z,w);}
...
inline void glVertexAttrib4NuivARB(GLuint index,const GLuint* v)const{(this->*(this->m_ptr_glVertexAttrib4NuivARB))(index,v);}
inline void glMapGrid2xOES(GLint n,GLfixed u1,GLfixed u2,GLfixed v1,GLfixed v2)const{(this->*(this->m_ptr_glMapGrid2xOES))(n,u1,u2,v1,v2);}
...
inline void glWindowPos2fvARB(const GLfloat* v)const{(this->*(this->m_ptr_glWindowPos2fvARB))(v);}
inline void glEnableIndexedEXT(GLenum target,GLuint index)const{(this->*(this->m_ptr_glEnableIndexedEXT))(target,index);}
inline void glTexCoord1bvOES(const GLbyte* coords)const{(this->*(this->m_ptr_glTexCoord1bvOES))(coords);}
...
inline void glReplacementCodePointerSUN(GLenum type,GLsizei stride,const void** pointer)const{(this->*(this->m_ptr_glReplacementCodePointerSUN))(type,stride,pointer);}
inline void glLoadTransposeMatrixdARB(const GLdouble* m)const{(this->*(this->m_ptr_glLoadTransposeMatrixdARB))(m);}
...
inline void glCompileShaderARB(GLhandleARB shaderObj)const{(this->*(this->m_ptr_glCompileShaderARB))(shaderObj);}
...
inline void glVertexStream2fvATI(GLenum stream,const GLfloat* coords)const{(this->*(this->m_ptr_glVertexStream2fvATI))(stream,coords);}
inline void glProgramStringARB(GLenum target,GLenum format,GLsizei len,const void* string)const{(this->*(this->m_ptr_glProgramStringARB))(target,format,len,string);}
...
inline void glMakeNamedBufferResidentNV(GLuint buffer,GLenum access)const{(this->*(this->m_ptr_glMakeNamedBufferResidentNV))(buffer,access);}
...
inline void glVertexAttrib3dARB(GLuint index,GLdouble x,GLdouble y,GLdouble z)const{(this->*(this->m_ptr_glVertexAttrib3dARB))(index,x,y,z);}
inline GLboolean glVDPAUIsSurfaceNV(GLvdpauSurfaceNV surface)const{return (this->*(this->m_ptr_glVDPAUIsSurfaceNV))(surface);}
...
inline GLboolean glIsAsyncMarkerSGIX(GLuint marker)const{return (this->*(this->m_ptr_glIsAsyncMarkerSGIX))(marker);}
...
inline void glUniform2i64NV(GLint location,GLint64EXT x,GLint64EXT y)const{(this->*(this->m_ptr_glUniform2i64NV))(location,x,y);}
inline GLboolean glIsCommandListNV(GLuint list)const{return (this->*(this->m_ptr_glIsCommandListNV))(list);}
...
inline GLint glGetUniformLocationARB(GLhandleARB programObj,const GLcharARB* name)const{return (this->*(this->m_ptr_glGetUniformLocationARB))(programObj,name);}
inline void glPathParameterfvNV(GLuint path,GLenum pname,const GLfloat* value)const{(this->*(this->m_ptr_glPathParameterfvNV))(path,pname,value);}
inline void glVertexAttrib3sNV(GLuint index,GLshort x,GLshort y,GLshort z)const{(this->*(this->m_ptr_glVertexAttrib3sNV))(index,x,y,z);}
...
inline void glVertexArrayRangeAPPLE(GLsizei length,void* pointer)const{(this->*(this->m_ptr_glVertexArrayRangeAPPLE))(length,pointer);}
...
inline void glWeightfvARB(GLint size,const GLfloat* weights)const{(this->*(this->m_ptr_glWeightfvARB))(size,weights);}
...
inline void glProgramLocalParameter4fvARB(GLenum target,GLuint index,const GLfloat* params)const{(this->*(this->m_ptr_glProgramLocalParameter4fvARB))(target,index,params);}
inline void glGetTransformFeedbackVaryingNV(GLuint program,GLuint index,GLint* location)const{(this->*(this->m_ptr_glGetTransformFeedbackVaryingNV))(program,index,location);}
inline void glWindowPos2iv(const GLint* v)const{(this->*(this->m_ptr_glWindowPos2iv))(v);}
inline void glVertexStream1dATI(GLenum stream,GLdouble x)const{(this->*(this->m_ptr_glVertexStream1dATI))(stream,x);}
inline void glColorFragmentOp2ATI(GLenum op,GLuint dst,GLuint dstMask,GLuint dstMod,GLuint arg1,GLuint arg1Rep,GLuint arg1Mod,GLuint arg2,GLuint arg2Rep,GLuint arg2Mod)const{(this->*(this->m_ptr_glColorFragmentOp2ATI))(op,dst,dstMask,dstMod,arg1,arg1Rep,arg1Mod,arg2,arg2Rep,arg2Mod);}
inline void glFogiv(GLenum pname,const GLint* params)const{(this->*(this->m_ptr_glFogiv))(pname,params);}
inline GLuint64 glGetTextureHandleNV(GLuint texture)const{return (this->*(this->m_ptr_glGetTextureHandleNV))(texture);}
...
inline void glGetFragmentMaterialivSGIX(GLenum face,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetFragmentMaterialivSGIX))(face,pname,params);}
inline void glVideoCaptureStreamParameterfvNV(GLuint video_capture_slot,GLuint stream,GLenum pname,const GLfloat* params)const{(this->*(this->m_ptr_glVideoCaptureStreamParameterfvNV))(video_capture_slot,stream,pname,params);}
inline void glDeleteProgramsARB(GLsizei n,const GLuint* programs)const{(this->*(this->m_ptr_glDeleteProgramsARB))(n,programs);}
inline void glWindowPos3fvARB(const GLfloat* v)const{(this->*(this->m_ptr_glWindowPos3fvARB))(v);}
inline void glFeedbackBufferxOES(GLsizei n,GLenum type,const GLfixed* buffer)const{(this->*(this->m_ptr_glFeedbackBufferxOES))(n,type,buffer);}
inline void glGetTexBumpParameterfvATI(GLenum pname,GLfloat* param)const{(this->*(this->m_ptr_glGetTexBumpParameterfvATI))(pname,param);}
...
inline void glDrawBuffersARB(GLsizei n,const GLenum* bufs)const{(this->*(this->m_ptr_glDrawBuffersARB))(n,bufs);}
inline void glBindProgramARB(GLenum target,GLuint program)const{(this->*(this->m_ptr_glBindProgramARB))(target,program);}
inline void glEvalCoord1fv(const GLfloat* u)const{(this->*(this->m_ptr_glEvalCoord1fv))(u);}
inline void glProgramUniform3ui64vARB(GLuint program,GLint location,GLsizei count,const GLuint64* value)const{(this->*(this->m_ptr_glProgramUniform3ui64vARB))(program,location,count,value);}
...
inline void glMultiTexCoord2hvNV(GLenum target,const GLhalfNV* v)const{(this->*(this->m_ptr_glMultiTexCoord2hvNV))(target,v);}
...
inline void glSampleCoverageARB(GLfloat value,GLboolean invert)const{(this->*(this->m_ptr_glSampleCoverageARB))(value,invert);}
inline void glProgramUniform2ui64vARB(GLuint program,GLint location,GLsizei count,const GLuint64* value)const{(this->*(this->m_ptr_glProgramUniform2ui64vARB))(program,location,count,value);}
inline void glPixelDataRangeNV(GLenum target,GLsizei length,const void* pointer)const{(this->*(this->m_ptr_glPixelDataRangeNV))(target,length,pointer);}
inline void glVertexStream3svATI(GLenum stream,const GLshort* coords)const{(this->*(this->m_ptr_glVertexStream3svATI))(stream,coords);}
inline void glReplacementCodeuiTexCoord2fNormal3fVertex3fvSUN(const GLuint* rc,const GLfloat* tc,const GLfloat* n,const GLfloat* v)const{(this->*(this->m_ptr_glReplacementCodeuiTexCoord2fNormal3fVertex3fvSUN))(rc,tc,n,v);}
inline void glTexCoord3hvNV(const GLhalfNV* v)const{(this->*(this->m_ptr_glTexCoord3hvNV))(v);}
...
inline void glPointParameteriNV(GLenum pname,GLint param)const{(this->*(this->m_ptr_glPointParameteriNV))(pname,param);}
...
inline void glUniform2i64ARB(GLint location,GLint64 x,GLint64 y)const{(this->*(this->m_ptr_glUniform2i64ARB))(location,x,y);}
...
inline void glGetVertexAttribArrayObjectivATI(GLuint index,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetVertexAttribArrayObjectivATI))(index,pname,params);}
...
inline void glColorTableParameterfvSGI(GLenum target,GLenum pname,const GLfloat* params)const{(this->*(this->m_ptr_glColorTableParameterfvSGI))(target,pname,params);}
...
inline void glSpriteParameterivSGIX(GLenum pname,const GLint* params)const{(this->*(this->m_ptr_glSpriteParameterivSGIX))(pname,params);}
inline void glPathGlyphRangeNV(GLuint firstPathName,GLenum fontTarget,const void* fontName,GLbitfield fontStyle,GLuint firstGlyph,GLsizei numGlyphs,GLenum handleMissingGlyphs,GLuint pathParameterTemplate,GLfloat emScale)const{(this->*(this->m_ptr_glPathGlyphRangeNV))(firstPathName,fontTarget,fontName,fontStyle,firstGlyph,numGlyphs,handleMissingGlyphs,pathParameterTemplate,emScale);}
inline void glPrimitiveBoundingBoxARB(GLfloat minX,GLfloat minY,GLfloat minZ,GLfloat minW,GLfloat maxX,GLfloat maxY,GLfloat maxZ,GLfloat maxW)const{(this->*(this->m_ptr_glPrimitiveBoundingBoxARB))(minX,minY,minZ,minW,maxX,maxY,maxZ,maxW);}
inline void glVertexAttribL3ui64vNV(GLuint index,const GLuint64EXT* v)const{(this->*(this->m_ptr_glVertexAttribL3ui64vNV))(index,v);}
...
inline void glDeletePathsNV(GLuint path,GLsizei range)const{(this->*(this->m_ptr_glDeletePathsNV))(path,range);}
inline void glPrimitiveRestartIndexNV(GLuint index)const{(this->*(this->m_ptr_glPrimitiveRestartIndexNV))(index);}
inline void glTexCoord2fColor3fVertex3fvSUN(const GLfloat* tc,const GLfloat* c,const GLfloat* v)const{(this->*(this->m_ptr_glTexCoord2fColor3fVertex3fvSUN))(tc,c,v);}
inline void glTexCoordPointerListIBM(GLint size,GLenum type,GLint stride,const void** pointer,GLint ptrstride)const{(this->*(this->m_ptr_glTexCoordPointerListIBM))(size,type,stride,pointer,ptrstride);}
inline void glRectxOES(GLfixed x1,GLfixed y1,GLfixed x2,GLfixed y2)const{(this->*(this->m_ptr_glRectxOES))(x1,y1,x2,y2);}
...
inline void glGenProgramsNV(GLsizei n,GLuint* programs)const{(this->*(this->m_ptr_glGenProgramsNV))(n,programs);}
inline void glFragmentLightfSGIX(GLenum light,GLenum pname,GLfloat param)const{(this->*(this->m_ptr_glFragmentLightfSGIX))(light,pname,param);}
...
inline void glVertexAttrib4NsvARB(GLuint index,const GLshort* v)const{(this->*(this->m_ptr_glVertexAttrib4NsvARB))(index,v);}
...
inline GLboolean glIsImageHandleResidentARB(GLuint64 handle)const{return (this->*(this->m_ptr_glIsImageHandleResidentARB))(handle);}
...
inline void glVertexAttribL3i64NV(GLuint index,GLint64EXT x,GLint64EXT y,GLint64EXT z)const{(this->*(this->m_ptr_glVertexAttribL3i64NV))(index,x,y,z);}
...
inline void glUniform4ui64vNV(GLint location,GLsizei count,const GLuint64EXT* value)const{(this->*(this->m_ptr_glUniform4ui64vNV))(location,count,value);}
inline void glDebugMessageEnableAMD(GLenum category,GLenum severity,GLsizei count,const GLuint* ids,GLboolean enabled)const{(this->*(this->m_ptr_glDebugMessageEnableAMD))(category,severity,count,ids,enabled);}
...
inline void glBlendEquationiARB(GLuint buf,GLenum mode)const{(this->*(this->m_ptr_glBlendEquationiARB))(buf,mode);}
...
inline void glUniform4ivARB(GLint location,GLsizei count,const GLint* value)const{(this->*(this->m_ptr_glUniform4ivARB))(location,count,value);}
...
inline void glProgramLocalParametersI4ivNV(GLenum target,GLuint index,GLsizei count,const GLint* params)const{(this->*(this->m_ptr_glProgramLocalParametersI4ivNV))(target,index,count,params);}
inline void glProgramUniform4ui64vNV(GLuint program,GLint location,GLsizei count,const GLuint64EXT* value)const{(this->*(this->m_ptr_glProgramUniform4ui64vNV))(program,location,count,value);}
inline void glGetNamedStringivARB(GLint namelen,const GLchar* name,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetNamedStringivARB))(namelen,name,pname,params);}
inline void glVertexAttribL1i64vNV(GLuint index,const GLint64EXT* v)const{(this->*(this->m_ptr_glVertexAttribL1i64vNV))(index,v);}
...
inline void glPointParameterivNV(GLenum pname,const GLint* params)const{(this->*(this->m_ptr_glPointParameterivNV))(pname,params);}
inline void glGetDetailTexFuncSGIS(GLenum target,GLfloat* points)const{(this->*(this->m_ptr_glGetDetailTexFuncSGIS))(target,points);}
inline void glReplacementCodeuiColor3fVertex3fvSUN(const GLuint* rc,const GLfloat* c,const GLfloat* v)const{(this->*(this->m_ptr_glReplacementCodeuiColor3fVertex3fvSUN))(rc,c,v);}
inline void glProgramLocalParameter4fARB(GLenum target,GLuint index,GLfloat x,GLfloat y,GLfloat z,GLfloat w)const{(this->*(this->m_ptr_glProgramLocalParameter4fARB))(target,index,x,y,z,w);}
...
inline void glStencilFuncSeparateATI(GLenum frontfunc,GLenum backfunc,GLint ref,GLuint mask)const{(this->*(this->m_ptr_glStencilFuncSeparateATI))(frontfunc,backfunc,ref,mask);}
...
inline void glListParameterivSGIX(GLuint list,GLenum pname,const GLint* params)const{(this->*(this->m_ptr_glListParameterivSGIX))(list,pname,params);}
...
inline void glProgramUniform3i64NV(GLuint program,GLint location,GLint64EXT x,GLint64EXT y,GLint64EXT z)const{(this->*(this->m_ptr_glProgramUniform3i64NV))(program,location,x,y,z);}
inline GLuint64 glGetTextureHandleARB(GLuint texture)const{return (this->*(this->m_ptr_glGetTextureHandleARB))(texture);}
inline void glTexCoord4s(GLshort s,GLshort t,GLshort r,GLshort q)const{(this->*(this->m_ptr_glTexCoord4s))(s,t,r,q);}
inline void glUniform4iARB(GLint location,GLint v0,GLint v1,GLint v2,GLint v3)const{(this->*(this->m_ptr_glUniform4iARB))(location,v0,v1,v2,v3);}
...
inline void glCoverageModulationTableNV(GLsizei n,const GLfloat* v)const{(this->*(this->m_ptr_glCoverageModulationTableNV))(n,v);}
inline void glPointParameteriv(GLenum pname,const GLint* params)const{(this->*(this->m_ptr_glPointParameteriv))(pname,params);}
inline void glMultiTexCoord4svARB(GLenum target,const GLshort* v)const{(this->*(this->m_ptr_glMultiTexCoord4svARB))(target,v);}
...
inline void glGetActiveVaryingNV(GLuint program,GLuint index,GLsizei bufSize,GLsizei* length,GLsizei* size,GLenum* type,GLchar* name)const{(this->*(this->m_ptr_glGetActiveVaryingNV))(program,index,bufSize,length,size,type,name);}
inline void glUniform1i64vARB(GLint location,GLsizei count,const GLint64* value)const{(this->*(this->m_ptr_glUniform1i64vARB))(location,count,value);}
...
inline void glProgramUniform1ui64vNV(GLuint program,GLint location,GLsizei count,const GLuint64EXT* value)const{(this->*(this->m_ptr_glProgramUniform1ui64vNV))(program,location,count,value);}
...
inline void glInterpolatePathsNV(GLuint resultPath,GLuint pathA,GLuint pathB,GLfloat weight)const{(this->*(this->m_ptr_glInterpolatePathsNV))(resultPath,pathA,pathB,weight);}
...
inline void glTexCoord4xvOES(const GLfixed* coords)const{(this->*(this->m_ptr_glTexCoord4xvOES))(coords);}
...
inline void glGetVertexAttribdvARB(GLuint index,GLenum pname,GLdouble* params)const{(this->*(this->m_ptr_glGetVertexAttribdvARB))(index,pname,params);}
...
inline void glMultiDrawArraysIndirectBindlessNV(GLenum mode,const void* indirect,GLsizei drawCount,GLsizei stride,GLint vertexBufferCount)const{(this->*(this->m_ptr_glMultiDrawArraysIndirectBindlessNV))(mode,indirect,drawCount,stride,vertexBufferCount);}
...
inline void glShaderSourceARB(GLhandleARB shaderObj,GLsizei count,const GLcharARB** string,const GLint* length)const{(this->*(this->m_ptr_glShaderSourceARB))(shaderObj,count,string,length);}
...
inline void glWindowPos2dvMESA(const GLdouble* v)const{(this->*(this->m_ptr_glWindowPos2dvMESA))(v);}
...
inline void glVertex4xvOES(const GLfixed* coords)const{(this->*(this->m_ptr_glVertex4xvOES))(coords);}
...
inline void glWindowPos2sARB(GLshort x,GLshort y)const{(this->*(this->m_ptr_glWindowPos2sARB))(x,y);}
inline void glStencilOpValueAMD(GLenum face,GLuint value)const{(this->*(this->m_ptr_glStencilOpValueAMD))(face,value);}
inline void glProgramVertexLimitNV(GLenum target,GLint limit)const{(this->*(this->m_ptr_glProgramVertexLimitNV))(target,limit);}
inline void glGetTexParameterPointervAPPLE(GLenum target,GLenum pname,void** params)const{(this->*(this->m_ptr_glGetTexParameterPointervAPPLE))(target,pname,params);}
...
inline void glVertexAttribs3svNV(GLuint index,GLsizei count,const GLshort* v)const{(this->*(this->m_ptr_glVertexAttribs3svNV))(index,count,v);}
inline void glMultiTexCoord3fv(GLenum target,const GLfloat* v)const{(this->*(this->m_ptr_glMultiTexCoord3fv))(target,v);}
inline void glVertexBlendEnvfATI(GLenum pname,GLfloat param)const{(this->*(this->m_ptr_glVertexBlendEnvfATI))(pname,param);}
inline GLboolean glIsFenceAPPLE(GLuint fence)const{return (this->*(this->m_ptr_glIsFenceAPPLE))(fence);}
inline void glGetBufferParameterui64vNV(GLenum target,GLenum pname,GLuint64EXT* params)const{(this->*(this->m_ptr_glGetBufferParameterui64vNV))(target,pname,params);}
inline void glVertexAttribI4bvEXT(GLuint index,const GLbyte* v)const{(this->*(this->m_ptr_glVertexAttribI4bvEXT))(index,v);}
inline void glUniform2fARB(GLint location,GLfloat v0,GLfloat v1)const{(this->*(this->m_ptr_glUniform2fARB))(location,v0,v1);}
inline void glStopInstrumentsSGIX(GLint marker)const{(this->*(this->m_ptr_glStopInstrumentsSGIX))(marker);}
inline void glVertexAttrib3fNV(GLuint index,GLfloat x,GLfloat y,GLfloat z)const{(this->*(this->m_ptr_glVertexAttrib3fNV))(index,x,y,z);}
inline void glMapVertexAttrib2dAPPLE(GLuint index,GLuint size,GLdouble u1,GLdouble u2,GLint ustride,GLint uorder,GLdouble v1,GLdouble v2,GLint vstride,GLint vorder,const GLdouble* points)const{(this->*(this->m_ptr_glMapVertexAttrib2dAPPLE))(index,size,u1,u2,ustride,uorder,v1,v2,vstride,vorder,points);}
...
inline void glMultiTexCoord4fARB(GLenum target,GLfloat s,GLfloat t,GLfloat r,GLfloat q)const{(this->*(this->m_ptr_glMultiTexCoord4fARB))(target,s,t,r,q);}
...
inline void glMatrixIndexubvARB(GLint size,const GLubyte* indices)const{(this->*(this->m_ptr_glMatrixIndexubvARB))(size,indices);}
inline void glVertex2s(GLshort x,GLshort y)const{(this->*(this->m_ptr_glVertex2s))(x,y);}
inline void glGetVertexAttribLui64vNV(GLuint index,GLenum pname,GLuint64EXT* params)const{(this->*(this->m_ptr_glGetVertexAttribLui64vNV))(index,pname,params);}
inline void glGetProgramStringARB(GLenum target,GLenum pname,void* string)const{(this->*(this->m_ptr_glGetProgramStringARB))(target,pname,string);}
...
inline void glLineWidthxOES(GLfixed width)const{(this->*(this->m_ptr_glLineWidthxOES))(width);}
...
inline void glPixelTexGenParameterivSGIS(GLenum pname,const GLint* params)const{(this->*(this->m_ptr_glPixelTexGenParameterivSGIS))(pname,params);}
...
inline void glGetnUniformivARB(GLuint program,GLint location,GLsizei bufSize,GLint* params)const{(this->*(this->m_ptr_glGetnUniformivARB))(program,location,bufSize,params);}
inline void glVertexBlendARB(GLint count)const{(this->*(this->m_ptr_glVertexBlendARB))(count);}
...
inline GLint glGetVaryingLocationNV(GLuint program,const GLchar* name)const{return (this->*(this->m_ptr_glGetVaryingLocationNV))(program,name);}
inline void glGetMapAttribParameterivNV(GLenum target,GLuint index,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetMapAttribParameterivNV))(target,index,pname,params);}
...
inline void glGetLightxOES(GLenum light,GLenum pname,GLfixed* params)const{(this->*(this->m_ptr_glGetLightxOES))(light,pname,params);}
inline void glGetVertexAttribArrayObjectfvATI(GLuint index,GLenum pname,GLfloat* params)const{(this->*(this->m_ptr_glGetVertexAttribArrayObjectfvATI))(index,pname,params);}
...
inline void glGetBufferParameterivARB(GLenum target,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetBufferParameterivARB))(target,pname,params);}
...
inline void glDrawMeshArraysSUN(GLenum mode,GLint first,GLsizei count,GLsizei width)const{(this->*(this->m_ptr_glDrawMeshArraysSUN))(mode,first,count,width);}
inline void glVertexAttrib4dNV(GLuint index,GLdouble x,GLdouble y,GLdouble z,GLdouble w)const{(this->*(this->m_ptr_glVertexAttrib4dNV))(index,x,y,z,w);}
inline void glGetMultisamplefvNV(GLenum pname,GLuint index,GLfloat* val)const{(this->*(this->m_ptr_glGetMultisamplefvNV))(pname,index,val);}
inline void* glMapObjectBufferATI(GLuint buffer)const{return (this->*(this->m_ptr_glMapObjectBufferATI))(buffer);}
inline void glGetPathCommandsNV(GLuint path,GLubyte* commands)const{(this->*(this->m_ptr_glGetPathCommandsNV))(path,commands);}
...
inline void glColorFormatNV(GLint size,GLenum type,GLsizei stride)const{(this->*(this->m_ptr_glColorFormatNV))(size,type,stride);}
inline void glProgramUniformui64NV(GLuint program,GLint location,GLuint64EXT value)const{(this->*(this->m_ptr_glProgramUniformui64NV))(program,location,value);}
...
inline void glLoadMatrixxOES(const GLfixed* m)const{(this->*(this->m_ptr_glLoadMatrixxOES))(m);}
...
inline void glVertexAttribL2i64NV(GLuint index,GLint64EXT x,GLint64EXT y)const{(this->*(this->m_ptr_glVertexAttribL2i64NV))(index,x,y);}
...
inline void glGetClipPlanexOES(GLenum plane,GLfixed* equation)const{(this->*(this->m_ptr_glGetClipPlanexOES))(plane,equation);}
inline void glSecondaryColor3uivEXT(const GLuint* v)const{(this->*(this->m_ptr_glSecondaryColor3uivEXT))(v);}
inline void glGetPerfQueryInfoINTEL(GLuint queryId,GLuint queryNameLength,GLchar* queryName,GLuint* dataSize,GLuint* noCounters,GLuint* noInstances,GLuint* capsMask)const{(this->*(this->m_ptr_glGetPerfQueryInfoINTEL))(queryId,queryNameLength,queryName,dataSize,noCounters,noInstances,capsMask);}
...
inline void* glMapBufferARB(GLenum target,GLenum access)const{return (this->*(this->m_ptr_glMapBufferARB))(target,access);}
inline void glGetPathSpacingNV(GLenum pathListMode,GLsizei numPaths,GLenum pathNameType,const void* paths,GLuint pathBase,GLfloat advanceScale,GLfloat kerningScale,GLenum transformType,GLfloat* returnedSpacing)const{(this->*(this->m_ptr_glGetPathSpacingNV))(pathListMode,numPaths,pathNameType,paths,pathBase,advanceScale,kerningScale,transformType,returnedSpacing);}
...
inline void glGlobalAlphaFactordSUN(GLdouble factor)const{(this->*(this->m_ptr_glGlobalAlphaFactordSUN))(factor);}
...
inline void glGetShaderSourceARB(GLhandleARB obj,GLsizei maxLength,GLsizei* length,GLcharARB* source)const{(this->*(this->m_ptr_glGetShaderSourceARB))(obj,maxLength,length,source);}
inline void glVertexAttrib3dvARB(GLuint index,const GLdouble* v)const{(this->*(this->m_ptr_glVertexAttrib3dvARB))(index,v);}
inline void glInvalidateBufferData(GLuint buffer)const{(this->*(this->m_ptr_glInvalidateBufferData))(buffer);}
inline void glMatrixLoad3x2fNV(GLenum matrixMode,const GLfloat* m)const{(this->*(this->m_ptr_glMatrixLoad3x2fNV))(matrixMode,m);}
...
inline void glTexCoord3xvOES(const GLfixed* coords)const{(this->*(this->m_ptr_glTexCoord3xvOES))(coords);}
...
inline void glWindowPos3fMESA(GLfloat x,GLfloat y,GLfloat z)const{(this->*(this->m_ptr_glWindowPos3fMESA))(x,y,z);}
...
inline void glGetHistogramParameterxvOES(GLenum target,GLenum pname,GLfixed* params)const{(this->*(this->m_ptr_glGetHistogramParameterxvOES))(target,pname,params);}
...
inline void glMakeImageHandleNonResidentNV(GLuint64 handle)const{(this->*(this->m_ptr_glMakeImageHandleNonResidentNV))(handle);}
...
inline void glNormalStream3dATI(GLenum stream,GLdouble nx,GLdouble ny,GLdouble nz)const{(this->*(this->m_ptr_glNormalStream3dATI))(stream,nx,ny,nz);}
...
inline void glBeginQueryARB(GLenum target,GLuint id)const{(this->*(this->m_ptr_glBeginQueryARB))(target,id);}
inline void glUniform1iARB(GLint location,GLint v0)const{(this->*(this->m_ptr_glUniform1iARB))(location,v0);}
inline void glVertex4bvOES(const GLbyte* coords)const{(this->*(this->m_ptr_glVertex4bvOES))(coords);}
...
inline void glUniform1fvARB(GLint location,GLsizei count,const GLfloat* value)const{(this->*(this->m_ptr_glUniform1fvARB))(location,count,value);}
inline GLboolean glTestFenceNV(GLuint fence)const{return (this->*(this->m_ptr_glTestFenceNV))(fence);}
...
inline void glTexCoord1hNV(GLhalfNV s)const{(this->*(this->m_ptr_glTexCoord1hNV))(s);}
inline void glGenFencesNV(GLsizei n,GLuint* fences)const{(this->*(this->m_ptr_glGenFencesNV))(n,fences);}
inline void glRasterPos3iv(const GLint* v)const{(this->*(this->m_ptr_glRasterPos3iv))(v);}
inline void glVertexAttribL2ui64NV(GLuint index,GLuint64EXT x,GLuint64EXT y)const{(this->*(this->m_ptr_glVertexAttribL2ui64NV))(index,x,y);}
inline void glMultiTexCoord1hvNV(GLenum target,const GLhalfNV* v)const{(this->*(this->m_ptr_glMultiTexCoord1hvNV))(target,v);}
...
inline void glWeightbvARB(GLint size,const GLbyte* weights)const{(this->*(this->m_ptr_glWeightbvARB))(size,weights);}
...
inline void glBeginConditionalRenderNVX(GLuint id)const{(this->*(this->m_ptr_glBeginConditionalRenderNVX))(id);}
...
inline void glVertexStream4fvATI(GLenum stream,const GLfloat* coords)const{(this->*(this->m_ptr_glVertexStream4fvATI))(stream,coords);}
inline void glDeformationMap3fSGIX(GLenum target,GLfloat u1,GLfloat u2,GLint ustride,GLint uorder,GLfloat v1,GLfloat v2,GLint vstride,GLint vorder,GLfloat w1,GLfloat w2,GLint wstride,GLint worder,const GLfloat* points)const{(this->*(this->m_ptr_glDeformationMap3fSGIX))(target,u1,u2,ustride,uorder,v1,v2,vstride,vorder,w1,w2,wstride,worder,points);}
inline void glClearDepth(GLclampd depth)const{(this->*(this->m_ptr_glClearDepth))(depth);}
inline GLuint glGenAsyncMarkersSGIX(GLsizei range)const{return (this->*(this->m_ptr_glGenAsyncMarkersSGIX))(range);}
...
inline void glGetProgramLocalParameterIivNV(GLenum target,GLuint index,GLint* params)const{(this->*(this->m_ptr_glGetProgramLocalParameterIivNV))(target,index,params);}
inline void glCompressedTexImage3DARB(GLenum target,GLint level,GLenum internalformat,GLsizei width,GLsizei height,GLsizei depth,GLint border,GLsizei imageSize,const void* data)const{(this->*(this->m_ptr_glCompressedTexImage3DARB))(target,level,internalformat,width,height,depth,border,imageSize,data);}
inline void glProgramParameter4fNV(GLenum target,GLuint index,GLfloat x,GLfloat y,GLfloat z,GLfloat w)const{(this->*(this->m_ptr_glProgramParameter4fNV))(target,index,x,y,z,w);}
inline void glConvolutionParameterxOES(GLenum target,GLenum pname,GLfixed param)const{(this->*(this->m_ptr_glConvolutionParameterxOES))(target,pname,param);}
...
inline void glMultiTexCoord2xvOES(GLenum texture,const GLfixed* coords)const{(this->*(this->m_ptr_glMultiTexCoord2xvOES))(texture,coords);}
inline void glTexGenxvOES(GLenum coord,GLenum pname,const GLfixed* params)const{(this->*(this->m_ptr_glTexGenxvOES))(coord,pname,params);}
inline void glMultTransposeMatrixf(const GLfloat m[16])const{(this->*(this->m_ptr_glMultTransposeMatrixf))(m);}
...
inline void glTexCoord2fColor3fVertex3fSUN(GLfloat s,GLfloat t,GLfloat r,GLfloat g,GLfloat b,GLfloat x,GLfloat y,GLfloat z)const{(this->*(this->m_ptr_glTexCoord2fColor3fVertex3fSUN))(s,t,r,g,b,x,y,z);}
inline void glNormal3sv(const GLshort* v)const{(this->*(this->m_ptr_glNormal3sv))(v);}
inline void glFreeObjectBufferATI(GLuint buffer)const{(this->*(this->m_ptr_glFreeObjectBufferATI))(buffer);}
inline void glBlendBarrierNV()const{(this->*(this->m_ptr_glBlendBarrierNV))();}
inline void glUniform4i64vNV(GLint location,GLsizei count,const GLint64EXT* value)const{(this->*(this->m_ptr_glUniform4i64vNV))(location,count,value);}
inline void glGetnUniformuivARB(GLuint program,GLint location,GLsizei bufSize,GLuint* params)const{(this->*(this->m_ptr_glGetnUniformuivARB))(program,location,bufSize,params);}
inline void glAlphaFragmentOp3ATI(GLenum op,GLuint dst,GLuint dstMod,GLuint arg1,GLuint arg1Rep,GLuint arg1Mod,GLuint arg2,GLuint arg2Rep,GLuint arg2Mod,GLuint arg3,GLuint arg3Rep,GLuint arg3Mod)const{(this->*(this->m_ptr_glAlphaFragmentOp3ATI))(op,dst,dstMod,arg1,arg1Rep,arg1Mod,arg2,arg2Rep,arg2Mod,arg3,arg3Rep,arg3Mod);}
...
inline void glPixelTexGenSGIX(GLenum mode)const{(this->*(this->m_ptr_glPixelTexGenSGIX))(mode);}
...
inline void glGetVideoCaptureStreamivNV(GLuint video_capture_slot,GLuint stream,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetVideoCaptureStreamivNV))(video_capture_slot,stream,pname,params);}
...
inline void glMakeImageHandleNonResidentARB(GLuint64 handle)const{(this->*(this->m_ptr_glMakeImageHandleNonResidentARB))(handle);}
...
inline void glProgramParameter4dNV(GLenum target,GLuint index,GLdouble x,GLdouble y,GLdouble z,GLdouble w)const{(this->*(this->m_ptr_glProgramParameter4dNV))(target,index,x,y,z,w);}
inline void glIndexxOES(GLfixed component)const{(this->*(this->m_ptr_glIndexxOES))(component);}
...
inline void glProgramUniform1ui64NV(GLuint program,GLint location,GLuint64EXT x)const{(this->*(this->m_ptr_glProgramUniform1ui64NV))(program,location,x);}
inline void glColor4hvNV(const GLhalfNV* v)const{(this->*(this->m_ptr_glColor4hvNV))(v);}
...
inline void glFragmentColorMaterialSGIX(GLenum face,GLenum mode)const{(this->*(this->m_ptr_glFragmentColorMaterialSGIX))(face,mode);}
...
inline void glGetnMinmaxARB(GLenum target,GLboolean reset,GLenum format,GLenum type,GLsizei bufSize,void* values)const{(this->*(this->m_ptr_glGetnMinmaxARB))(target,reset,format,type,bufSize,values);}
...
inline void glWindowPos4iMESA(GLint x,GLint y,GLint z,GLint w)const{(this->*(this->m_ptr_glWindowPos4iMESA))(x,y,z,w);}
...
inline void glMultiTexCoord1xOES(GLenum texture,GLfixed s)const{(this->*(this->m_ptr_glMultiTexCoord1xOES))(texture,s);}
...
inline void glVertexPointervINTEL(GLint size,GLenum type,const void** pointer)const{(this->*(this->m_ptr_glVertexPointervINTEL))(size,type,pointer);}
...
inline void glMultiTexCoord3iARB(GLenum target,GLint s,GLint t,GLint r)const{(this->*(this->m_ptr_glMultiTexCoord3iARB))(target,s,t,r);}
inline void glRasterPos4xvOES(const GLfixed* coords)const{(this->*(this->m_ptr_glRasterPos4xvOES))(coords);}
...
inline void glVertex3hvNV(const GLhalfNV* v)const{(this->*(this->m_ptr_glVertex3hvNV))(v);}
...
inline void glAccumxOES(GLenum op,GLfixed value)const{(this->*(this->m_ptr_glAccumxOES))(op,value);}
...
inline void glPointParameterxvOES(GLenum pname,const GLfixed* params)const{(this->*(this->m_ptr_glPointParameterxvOES))(pname,params);}
inline void glCreateStatesNV(GLsizei n,GLuint* states)const{(this->*(this->m_ptr_glCreateStatesNV))(n,states);}
inline void glClearDepthdNV(GLdouble depth)const{(this->*(this->m_ptr_glClearDepthdNV))(depth);}
...
inline void glProgramUniform3ui64NV(GLuint program,GLint location,GLuint64EXT x,GLuint64EXT y,GLuint64EXT z)const{(this->*(this->m_ptr_glProgramUniform3ui64NV))(program,location,x,y,z);}
...
inline void glVertexAttrib2sNV(GLuint index,GLshort x,GLshort y)const{(this->*(this->m_ptr_glVertexAttrib2sNV))(index,x,y);}
...
inline void glVertexStream2fATI(GLenum stream,GLfloat x,GLfloat y)const{(this->*(this->m_ptr_glVertexStream2fATI))(stream,x,y);}
inline void glDebugMessageCallbackAMD(GLDEBUGPROCAMD callback,void* userParam)const{(this->*(this->m_ptr_glDebugMessageCallbackAMD))(callback,userParam);}
...
inline void glNormalStream3sATI(GLenum stream,GLshort nx,GLshort ny,GLshort nz)const{(this->*(this->m_ptr_glNormalStream3sATI))(stream,nx,ny,nz);}
inline void glProgramParameteriARB(GLuint program,GLenum pname,GLint value)const{(this->*(this->m_ptr_glProgramParameteriARB))(program,pname,value);}
inline void glTexEnvxOES(GLenum target,GLenum pname,GLfixed param)const{(this->*(this->m_ptr_glTexEnvxOES))(target,pname,param);}
...
inline void glDisableVertexAttribAPPLE(GLuint index,GLenum pname)const{(this->*(this->m_ptr_glDisableVertexAttribAPPLE))(index,pname);}
...
inline void glMultiDrawElementsIndirectAMD(GLenum mode,GLenum type,const void* indirect,GLsizei primcount,GLsizei stride)const{(this->*(this->m_ptr_glMultiDrawElementsIndirectAMD))(mode,type,indirect,primcount,stride);}
...
inline void glTexCoord4bOES(GLbyte s,GLbyte t,GLbyte r,GLbyte q)const{(this->*(this->m_ptr_glTexCoord4bOES))(s,t,r,q);}
...
inline void glProgramEnvParametersI4uivNV(GLenum target,GLuint index,GLsizei count,const GLuint* params)const{(this->*(this->m_ptr_glProgramEnvParametersI4uivNV))(target,index,count,params);}
inline void glTexCoord3xOES(GLfixed s,GLfixed t,GLfixed r)const{(this->*(this->m_ptr_glTexCoord3xOES))(s,t,r);}
inline void glLoadTransposeMatrixfARB(const GLfloat* m)const{(this->*(this->m_ptr_glLoadTransposeMatrixfARB))(m);}
inline void glImageTransformParameteriHP(GLenum target,GLenum pname,GLint param)const{(this->*(this->m_ptr_glImageTransformParameteriHP))(target,pname,param);}
inline void glMultiTexCoord4xOES(GLenum texture,GLfixed s,GLfixed t,GLfixed r,GLfixed q)const{(this->*(this->m_ptr_glMultiTexCoord4xOES))(texture,s,t,r,q);}
inline void glVertexAttribs3fvNV(GLuint index,GLsizei count,const GLfloat* v)const{(this->*(this->m_ptr_glVertexAttribs3fvNV))(index,count,v);}
inline void glVertexAttrib2fv(GLuint index,const GLfloat* v)const{(this->*(this->m_ptr_glVertexAttrib2fv))(index,v);}
inline void glUniform3ui64NV(GLint location,GLuint64EXT x,GLuint64EXT y,GLuint64EXT z)const{(this->*(this->m_ptr_glUniform3ui64NV))(location,x,y,z);}
inline void glCombinerParameterfvNV(GLenum pname,const GLfloat* params)const{(this->*(this->m_ptr_glCombinerParameterfvNV))(pname,params);}
inline void glFragmentMaterialiSGIX(GLenum face,GLenum pname,GLint param)const{(this->*(this->m_ptr_glFragmentMaterialiSGIX))(face,pname,param);}
...
inline void glBeginConditionalRenderNV(GLuint id,GLenum mode)const{(this->*(this->m_ptr_glBeginConditionalRenderNV))(id,mode);}
inline void glDisableClientState(GLenum cap)const{(this->*(this->m_ptr_glDisableClientState))(cap);}
inline void glPathFogGenNV(GLenum genMode)const{(this->*(this->m_ptr_glPathFogGenNV))(genMode);}
inline void glStencilThenCoverFillPathNV(GLuint path,GLenum fillMode,GLuint mask,GLenum coverMode)const{(this->*(this->m_ptr_glStencilThenCoverFillPathNV))(path,fillMode,mask,coverMode);}
...
inline void glProgramBufferParametersIuivNV(GLenum target,GLuint bindingIndex,GLuint wordIndex,GLsizei count,const GLuint* params)const{(this->*(this->m_ptr_glProgramBufferParametersIuivNV))(target,bindingIndex,wordIndex,count,params);}
...
inline void glTexBufferARB(GLenum target,GLenum internalformat,GLuint buffer)const{(this->*(this->m_ptr_glTexBufferARB))(target,internalformat,buffer);}
...
inline void glMultiDrawElementsIndirectBindlessCountNV(GLenum mode,GLenum type,const void* indirect,GLsizei drawCount,GLsizei maxDrawCount,GLsizei stride,GLint vertexBufferCount)const{(this->*(this->m_ptr_glMultiDrawElementsIndirectBindlessCountNV))(mode,type,indirect,drawCount,maxDrawCount,stride,vertexBufferCount);}
inline void glGetBufferPointervARB(GLenum target,GLenum pname,void** params)const{(this->*(this->m_ptr_glGetBufferPointervARB))(target,pname,params);}
...
inline void glMapVertexAttrib1dAPPLE(GLuint index,GLuint size,GLdouble u1,GLdouble u2,GLint stride,GLint order,const GLdouble* points)const{(this->*(this->m_ptr_glMapVertexAttrib1dAPPLE))(index,size,u1,u2,stride,order,points);}
inline void glEvalCoord2fv(const GLfloat* u)const{(this->*(this->m_ptr_glEvalCoord2fv))(u);}
inline void glGetUniformivARB(GLhandleARB programObj,GLint location,GLint* params)const{(this->*(this->m_ptr_glGetUniformivARB))(programObj,location,params);}
...
inline void glProgramNamedParameter4dvNV(GLuint id,GLsizei len,const GLubyte* name,const GLdouble* v)const{(this->*(this->m_ptr_glProgramNamedParameter4dvNV))(id,len,name,v);}
inline void glCompileCommandListNV(GLuint list)const{(this->*(this->m_ptr_glCompileCommandListNV))(list);}
...
inline GLboolean glIsBufferResidentNV(GLenum target)const{return (this->*(this->m_ptr_glIsBufferResidentNV))(target);}
...
inline void glNamedFramebufferSampleLocationsfvARB(GLuint framebuffer,GLuint start,GLsizei count,const GLfloat* v)const{(this->*(this->m_ptr_glNamedFramebufferSampleLocationsfvARB))(framebuffer,start,count,v);}
...
inline void glVertexArrayRangeNV(GLsizei length,const void* pointer)const{(this->*(this->m_ptr_glVertexArrayRangeNV))(length,pointer);}
inline GLboolean glIsTextureHandleResidentNV(GLuint64 handle)const{return (this->*(this->m_ptr_glIsTextureHandleResidentNV))(handle);}
inline void glGetProgramEnvParameterdvARB(GLenum target,GLuint index,GLdouble* params)const{(this->*(this->m_ptr_glGetProgramEnvParameterdvARB))(target,index,params);}
inline GLboolean glIsNamedStringARB(GLint namelen,const GLchar* name)const{return (this->*(this->m_ptr_glIsNamedStringARB))(namelen,name);}
inline void glSecondaryColorFormatNV(GLint size,GLenum type,GLsizei stride)const{(this->*(this->m_ptr_glSecondaryColorFormatNV))(size,type,stride);}
inline void glVertexAttrib4ubvNV(GLuint index,const GLubyte* v)const{(this->*(this->m_ptr_glVertexAttrib4ubvNV))(index,v);}
inline void glTagSampleBufferSGIX()const{(this->*(this->m_ptr_glTagSampleBufferSGIX))();}
inline void glVDPAUUnregisterSurfaceNV(GLvdpauSurfaceNV surface)const{(this->*(this->m_ptr_glVDPAUUnregisterSurfaceNV))(surface);}
inline void glGetPerfQueryIdByNameINTEL(GLchar* queryName,GLuint* queryId)const{(this->*(this->m_ptr_glGetPerfQueryIdByNameINTEL))(queryName,queryId);}
...
inline void glColor4ubVertex3fSUN(GLubyte r,GLubyte g,GLubyte b,GLubyte a,GLfloat x,GLfloat y,GLfloat z)const{(this->*(this->m_ptr_glColor4ubVertex3fSUN))(r,g,b,a,x,y,z);}
inline void glIndexub(GLubyte c)const{(this->*(this->m_ptr_glIndexub))(c);}
inline void glGetProgramEnvParameterfvARB(GLenum target,GLuint index,GLfloat* params)const{(this->*(this->m_ptr_glGetProgramEnvParameterfvARB))(target,index,params);}
inline void glVertexAttrib4usvARB(GLuint index,const GLushort* v)const{(this->*(this->m_ptr_glVertexAttrib4usvARB))(index,v);}
...
inline GLboolean glTestFenceAPPLE(GLuint fence)const{return (this->*(this->m_ptr_glTestFenceAPPLE))(fence);}
inline void glVertexAttrib4Niv(GLuint index,const GLint* v)const{(this->*(this->m_ptr_glVertexAttrib4Niv))(index,v);}
inline void glVertexAttribL2i64vNV(GLuint index,const GLint64EXT* v)const{(this->*(this->m_ptr_glVertexAttribL2i64vNV))(index,v);}
...
inline void glCallCommandListNV(GLuint list)const{(this->*(this->m_ptr_glCallCommandListNV))(list);}
...
inline void glNamedStringARB(GLenum type,GLint namelen,const GLchar* name,GLint stringlen,const GLchar* string)const{(this->*(this->m_ptr_glNamedStringARB))(type,namelen,name,stringlen,string);}
inline void glMatrixMult3x2fNV(GLenum matrixMode,const GLfloat* m)const{(this->*(this->m_ptr_glMatrixMult3x2fNV))(matrixMode,m);}
...
inline void glGetnHistogramARB(GLenum target,GLboolean reset,GLenum format,GLenum type,GLsizei bufSize,void* values)const{(this->*(this->m_ptr_glGetnHistogramARB))(target,reset,format,type,bufSize,values);}
...
inline void glBitmapxOES(GLsizei width,GLsizei height,GLfixed xorig,GLfixed yorig,GLfixed xmove,GLfixed ymove,const GLubyte* bitmap)const{(this->*(this->m_ptr_glBitmapxOES))(width,height,xorig,yorig,xmove,ymove,bitmap);}
...
inline void glVertexAttribs2svNV(GLuint index,GLsizei count,const GLshort* v)const{(this->*(this->m_ptr_glVertexAttribs2svNV))(index,count,v);}
...
inline void glVertex3xvOES(const GLfixed* coords)const{(this->*(this->m_ptr_glVertex3xvOES))(coords);}
inline void glColor3us(GLushort red,GLushort green,GLushort blue)const{(this->*(this->m_ptr_glColor3us))(red,green,blue);}
inline void glBeginPerfMonitorAMD(GLuint monitor)const{(this->*(this->m_ptr_glBeginPerfMonitorAMD))(monitor);}
...
inline void glVertexAttribL3ui64NV(GLuint index,GLuint64EXT x,GLuint64EXT y,GLuint64EXT z)const{(this->*(this->m_ptr_glVertexAttribL3ui64NV))(index,x,y,z);}
...
inline void glVertexAttrib2sARB(GLuint index,GLshort x,GLshort y)const{(this->*(this->m_ptr_glVertexAttrib2sARB))(index,x,y);}
...
inline void glGetnMapivARB(GLenum target,GLenum query,GLsizei bufSize,GLint* v)const{(this->*(this->m_ptr_glGetnMapivARB))(target,query,bufSize,v);}
inline void glMultiTexCoord1ivARB(GLenum target,const GLint* v)const{(this->*(this->m_ptr_glMultiTexCoord1ivARB))(target,v);}
inline void glDisableVertexAttribArrayARB(GLuint index)const{(this->*(this->m_ptr_glDisableVertexAttribArrayARB))(index);}
...
inline void glGetPathDashArrayNV(GLuint path,GLfloat* dashArray)const{(this->*(this->m_ptr_glGetPathDashArrayNV))(path,dashArray);}
...
inline void glDeleteOcclusionQueriesNV(GLsizei n,const GLuint* ids)const{(this->*(this->m_ptr_glDeleteOcclusionQueriesNV))(n,ids);}
inline void glVertex4hvNV(const GLhalfNV* v)const{(this->*(this->m_ptr_glVertex4hvNV))(v);}
...
inline void glProgramLocalParameter4dARB(GLenum target,GLuint index,GLdouble x,GLdouble y,GLdouble z,GLdouble w)const{(this->*(this->m_ptr_glProgramLocalParameter4dARB))(target,index,x,y,z,w);}
...
inline void glUniform1i64vNV(GLint location,GLsizei count,const GLint64EXT* value)const{(this->*(this->m_ptr_glUniform1i64vNV))(location,count,value);}
...
inline void glVertexStream4ivATI(GLenum stream,const GLint* coords)const{(this->*(this->m_ptr_glVertexStream4ivATI))(stream,coords);}
...
inline void glGetProgramivNV(GLuint id,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetProgramivNV))(id,pname,params);}
inline void glBeginTransformFeedback(GLenum primitiveMode)const{(this->*(this->m_ptr_glBeginTransformFeedback))(primitiveMode);}
inline void glFinishObjectAPPLE(GLenum object,GLint name)const{(this->*(this->m_ptr_glFinishObjectAPPLE))(object,name);}
...
inline void glGetVideoi64vNV(GLuint video_slot,GLenum pname,GLint64EXT* params)const{(this->*(this->m_ptr_glGetVideoi64vNV))(video_slot,pname,params);}
...
inline void glUniform4i64vARB(GLint location,GLsizei count,const GLint64* value)const{(this->*(this->m_ptr_glUniform4i64vARB))(location,count,value);}
...
inline void glProgramUniformui64vNV(GLuint program,GLint location,GLsizei count,const GLuint64EXT* value)const{(this->*(this->m_ptr_glProgramUniformui64vNV))(program,location,count,value);}
...
inline void glMultTransposeMatrixxOES(const GLfixed* m)const{(this->*(this->m_ptr_glMultTransposeMatrixxOES))(m);}
...
inline void glBlendFuncSeparateiARB(GLuint buf,GLenum srcRGB,GLenum dstRGB,GLenum srcAlpha,GLenum dstAlpha)const{(this->*(this->m_ptr_glBlendFuncSeparateiARB))(buf,srcRGB,dstRGB,srcAlpha,dstAlpha);}
inline void glWeightuivARB(GLint size,const GLuint* weights)const{(this->*(this->m_ptr_glWeightuivARB))(size,weights);}
...
inline void glVertexAttrib4svNV(GLuint index,const GLshort* v)const{(this->*(this->m_ptr_glVertexAttrib4svNV))(index,v);}
...
inline void glListDrawCommandsStatesClientNV(GLuint list,GLuint segment,const void** indirects,const GLsizei* sizes,const GLuint* states,const GLuint* fbos,GLuint count)const{(this->*(this->m_ptr_glListDrawCommandsStatesClientNV))(list,segment,indirects,sizes,states,fbos,count);}
inline void glProgramLocalParametersI4uivNV(GLenum target,GLuint index,GLsizei count,const GLuint* params)const{(this->*(this->m_ptr_glProgramLocalParametersI4uivNV))(target,index,count,params);}
inline void glBeginTransformFeedbackNV(GLenum primitiveMode)const{(this->*(this->m_ptr_glBeginTransformFeedbackNV))(primitiveMode);}
...
inline void glWindowPos2sMESA(GLshort x,GLshort y)const{(this->*(this->m_ptr_glWindowPos2sMESA))(x,y);}
inline void glGlobalAlphaFactorbSUN(GLbyte factor)const{(this->*(this->m_ptr_glGlobalAlphaFactorbSUN))(factor);}
...
inline void glTransformFeedbackVaryingsNV(GLuint program,GLsizei count,const GLint* locations,GLenum bufferMode)const{(this->*(this->m_ptr_glTransformFeedbackVaryingsNV))(program,count,locations,bufferMode);}
...
inline GLboolean glIsOcclusionQueryNV(GLuint id)const{return (this->*(this->m_ptr_glIsOcclusionQueryNV))(id);}
inline void glCompressedTexImage2DARB(GLenum target,GLint level,GLenum internalformat,GLsizei width,GLsizei height,GLint border,GLsizei imageSize,const void* data)const{(this->*(this->m_ptr_glCompressedTexImage2DARB))(target,level,internalformat,width,height,border,imageSize,data);}
inline void glGetProgramEnvParameterIuivNV(GLenum target,GLuint index,GLuint* params)const{(this->*(this->m_ptr_glGetProgramEnvParameterIuivNV))(target,index,params);}
inline void glVertexAttrib4sv(GLuint index,const GLshort* v)const{(this->*(this->m_ptr_glVertexAttrib4sv))(index,v);}
inline void glVertexAttrib4fvARB(GLuint index,const GLfloat* v)const{(this->*(this->m_ptr_glVertexAttrib4fvARB))(index,v);}
...
inline void glTexCoord1hvNV(const GLhalfNV* v)const{(this->*(this->m_ptr_glTexCoord1hvNV))(v);}
...
inline GLboolean glIsBufferARB(GLuint buffer)const{return (this->*(this->m_ptr_glIsBufferARB))(buffer);}
inline void glMultiTexCoord1bOES(GLenum texture,GLbyte s)const{(this->*(this->m_ptr_glMultiTexCoord1bOES))(texture,s);}
inline void glFogCoordhNV(GLhalfNV fog)const{(this->*(this->m_ptr_glFogCoordhNV))(fog);}
inline void glFramebufferSampleLocationsfvNV(GLenum target,GLuint start,GLsizei count,const GLfloat* v)const{(this->*(this->m_ptr_glFramebufferSampleLocationsfvNV))(target,start,count,v);}
...
inline void glGetNextPerfQueryIdINTEL(GLuint queryId,GLuint* nextQueryId)const{(this->*(this->m_ptr_glGetNextPerfQueryIdINTEL))(queryId,nextQueryId);}
inline void glCompressedTexImage1DARB(GLenum target,GLint level,GLenum internalformat,GLsizei width,GLint border,GLsizei imageSize,const void* data)const{(this->*(this->m_ptr_glCompressedTexImage1DARB))(target,level,internalformat,width,border,imageSize,data);}
...
inline void glGetProgramEnvParameterIivNV(GLenum target,GLuint index,GLint* params)const{(this->*(this->m_ptr_glGetProgramEnvParameterIivNV))(target,index,params);}
...
inline void glVertexAttribL4ui64vNV(GLuint index,const GLuint64EXT* v)const{(this->*(this->m_ptr_glVertexAttribL4ui64vNV))(index,v);}
inline void glGetVideoivNV(GLuint video_slot,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetVideoivNV))(video_slot,pname,params);}
...
inline void glBeginFragmentShaderATI()const{(this->*(this->m_ptr_glBeginFragmentShaderATI))();}
...
inline void glGenNamesAMD(GLenum identifier,GLuint num,GLuint* names)const{(this->*(this->m_ptr_glGenNamesAMD))(identifier,num,names);}
inline void glPathParameteriNV(GLuint path,GLenum pname,GLint value)const{(this->*(this->m_ptr_glPathParameteriNV))(path,pname,value);}
inline void glCreateCommandListsNV(GLsizei n,GLuint* lists)const{(this->*(this->m_ptr_glCreateCommandListsNV))(n,lists);}
...
inline void glOrthoxOES(GLfixed l,GLfixed r,GLfixed b,GLfixed t,GLfixed n,GLfixed f)const{(this->*(this->m_ptr_glOrthoxOES))(l,r,b,t,n,f);}
...
inline void glProgramUniform1i64vNV(GLuint program,GLint location,GLsizei count,const GLint64EXT* value)const{(this->*(this->m_ptr_glProgramUniform1i64vNV))(program,location,count,value);}
...
inline void glTexCoord2hNV(GLhalfNV s,GLhalfNV t)const{(this->*(this->m_ptr_glTexCoord2hNV))(s,t);}
...
inline void glColor4fNormal3fVertex3fvSUN(const GLfloat* c,const GLfloat* n,const GLfloat* v)const{(this->*(this->m_ptr_glColor4fNormal3fVertex3fvSUN))(c,n,v);}
...
inline void glTexParameterxOES(GLenum target,GLenum pname,GLfixed param)const{(this->*(this->m_ptr_glTexParameterxOES))(target,pname,param);}
inline void glClearAccumxOES(GLfixed red,GLfixed green,GLfixed blue,GLfixed alpha)const{(this->*(this->m_ptr_glClearAccumxOES))(red,green,blue,alpha);}
...
inline void glWeightubvARB(GLint size,const GLubyte* weights)const{(this->*(this->m_ptr_glWeightubvARB))(size,weights);}
...
inline void glMultiTexCoord4dvARB(GLenum target,const GLdouble* v)const{(this->*(this->m_ptr_glMultiTexCoord4dvARB))(target,v);}
inline void glMultiTexCoord1sv(GLenum target,const GLshort* v)const{(this->*(this->m_ptr_glMultiTexCoord1sv))(target,v);}
inline void glUniform1ui64vNV(GLint location,GLsizei count,const GLuint64EXT* value)const{(this->*(this->m_ptr_glUniform1ui64vNV))(location,count,value);}
inline void glGetClipPlanefOES(GLenum plane,GLfloat* equation)const{(this->*(this->m_ptr_glGetClipPlanefOES))(plane,equation);}
inline void glRasterPos2s(GLshort x,GLshort y)const{(this->*(this->m_ptr_glRasterPos2s))(x,y);}
inline void glWeightivARB(GLint size,const GLint* weights)const{(this->*(this->m_ptr_glWeightivARB))(size,weights);}
inline void glMultiTexCoord4hvNV(GLenum target,const GLhalfNV* v)const{(this->*(this->m_ptr_glMultiTexCoord4hvNV))(target,v);}
inline void glNormal3hNV(GLhalfNV nx,GLhalfNV ny,GLhalfNV nz)const{(this->*(this->m_ptr_glNormal3hNV))(nx,ny,nz);}
...
inline void glGetPathTexGenivNV(GLenum texCoordSet,GLenum pname,GLint* value)const{(this->*(this->m_ptr_glGetPathTexGenivNV))(texCoordSet,pname,value);}
...
inline void glNamedBufferPageCommitmentARB(GLuint buffer,GLintptr offset,GLsizeiptr size,GLboolean commit)const{(this->*(this->m_ptr_glNamedBufferPageCommitmentARB))(buffer,offset,size,commit);}
...
inline void glMultiTexCoord2fvARB(GLenum target,const GLfloat* v)const{(this->*(this->m_ptr_glMultiTexCoord2fvARB))(target,v);}
...
inline void glMultiTexCoord4hNV(GLenum target,GLhalfNV s,GLhalfNV t,GLhalfNV r,GLhalfNV q)const{(this->*(this->m_ptr_glMultiTexCoord4hNV))(target,s,t,r,q);}
inline void glTextureBarrier()const{(this->*(this->m_ptr_glTextureBarrier))();}
inline void glReplacementCodeuivSUN(const GLuint* code)const{(this->*(this->m_ptr_glReplacementCodeuivSUN))(code);}
inline void glDeleteAsyncMarkersSGIX(GLuint marker,GLsizei range)const{(this->*(this->m_ptr_glDeleteAsyncMarkersSGIX))(marker,range);}
inline void glTexCoord2bvOES(const GLbyte* coords)const{(this->*(this->m_ptr_glTexCoord2bvOES))(coords);}
inline void glEvalCoord2xOES(GLfixed u,GLfixed v)const{(this->*(this->m_ptr_glEvalCoord2xOES))(u,v);}
inline void glGetSharpenTexFuncSGIS(GLenum target,GLfloat* points)const{(this->*(this->m_ptr_glGetSharpenTexFuncSGIS))(target,points);}
inline void glProgramUniformHandleui64vNV(GLuint program,GLint location,GLsizei count,const GLuint64* values)const{(this->*(this->m_ptr_glProgramUniformHandleui64vNV))(program,location,count,values);}
inline void glIglooInterfaceSGIX(GLenum pname,const void* params)const{(this->*(this->m_ptr_glIglooInterfaceSGIX))(pname,params);}
inline void glWindowPos2dvARB(const GLdouble* v)const{(this->*(this->m_ptr_glWindowPos2dvARB))(v);}
...
inline void glVertexStream4fATI(GLenum stream,GLfloat x,GLfloat y,GLfloat z,GLfloat w)const{(this->*(this->m_ptr_glVertexStream4fATI))(stream,x,y,z,w);}
...
inline void glGetCoverageModulationTableNV(GLsizei bufsize,GLfloat* v)const{(this->*(this->m_ptr_glGetCoverageModulationTableNV))(bufsize,v);}
inline void glDepthRangedNV(GLdouble zNear,GLdouble zFar)const{(this->*(this->m_ptr_glDepthRangedNV))(zNear,zFar);}
...
inline void glMultiDrawRangeElementArrayAPPLE(GLenum mode,GLuint start,GLuint end,const GLint* first,const GLsizei* count,GLsizei primcount)const{(this->*(this->m_ptr_glMultiDrawRangeElementArrayAPPLE))(mode,start,end,first,count,primcount);}
inline void glVertexAttribFormatNV(GLuint index,GLint size,GLenum type,GLboolean normalized,GLsizei stride)const{(this->*(this->m_ptr_glVertexAttribFormatNV))(index,size,type,normalized,stride);}
...
inline void glGetUniformi64vARB(GLuint program,GLint location,GLint64* params)const{(this->*(this->m_ptr_glGetUniformi64vARB))(program,location,params);}
...
inline GLhandleARB glGetHandleARB(GLenum pname)const{return (this->*(this->m_ptr_glGetHandleARB))(pname);}
inline void glVideoCaptureStreamParameterdvNV(GLuint video_capture_slot,GLuint stream,GLenum pname,const GLdouble* params)const{(this->*(this->m_ptr_glVideoCaptureStreamParameterdvNV))(video_capture_slot,stream,pname,params);}
inline void glMapParameterivNV(GLenum target,GLenum pname,const GLint* params)const{(this->*(this->m_ptr_glMapParameterivNV))(target,pname,params);}
...
inline void glFrameTerminatorGREMEDY()const{(this->*(this->m_ptr_glFrameTerminatorGREMEDY))();}
inline void glBlendBarrierKHR()const{(this->*(this->m_ptr_glBlendBarrierKHR))();}
inline void glVertexAttrib4NubARB(GLuint index,GLubyte x,GLubyte y,GLubyte z,GLubyte w)const{(this->*(this->m_ptr_glVertexAttrib4NubARB))(index,x,y,z,w);}
inline void glPrimitiveRestartNV()const{(this->*(this->m_ptr_glPrimitiveRestartNV))();}
inline void glVertexAttribL1ui64vARB(GLuint index,const GLuint64EXT* v)const{(this->*(this->m_ptr_glVertexAttribL1ui64vARB))(index,v);}
inline void glVertexAttribI4ivEXT(GLuint index,const GLint* v)const{(this->*(this->m_ptr_glVertexAttribI4ivEXT))(index,v);}
inline void glVertexAttribs4svNV(GLuint index,GLsizei count,const GLshort* v)const{(this->*(this->m_ptr_glVertexAttribs4svNV))(index,count,v);}
inline void glUniform1ui(GLint location,GLuint v0)const{(this->*(this->m_ptr_glUniform1ui))(location,v0);}
inline void glVertexAttrib2fvARB(GLuint index,const GLfloat* v)const{(this->*(this->m_ptr_glVertexAttrib2fvARB))(index,v);}
inline void glVertexAttribI4svEXT(GLuint index,const GLshort* v)const{(this->*(this->m_ptr_glVertexAttribI4svEXT))(index,v);}
inline void glTextureImage3DMultisampleCoverageNV(GLuint texture,GLenum target,GLsizei coverageSamples,GLsizei colorSamples,GLint internalFormat,GLsizei width,GLsizei height,GLsizei depth,GLboolean fixedSampleLocations)const{(this->*(this->m_ptr_glTextureImage3DMultisampleCoverageNV))(texture,target,coverageSamples,colorSamples,internalFormat,width,height,depth,fixedSampleLocations);}
inline void glMemoryBarrier(GLbitfield barriers)const{(this->*(this->m_ptr_glMemoryBarrier))(barriers);}
inline void glGetVariantArrayObjectfvATI(GLuint id,GLenum pname,GLfloat* params)const{(this->*(this->m_ptr_glGetVariantArrayObjectfvATI))(id,pname,params);}
inline void glTexCoord4fColor4fNormal3fVertex4fvSUN(const GLfloat* tc,const GLfloat* c,const GLfloat* n,const GLfloat* v)const{(this->*(this->m_ptr_glTexCoord4fColor4fNormal3fVertex4fvSUN))(tc,c,n,v);}
inline GLboolean glIsProgramARB(GLuint program)const{return (this->*(this->m_ptr_glIsProgramARB))(program);}
...
inline void glMultiTexCoord1svARB(GLenum target,const GLshort* v)const{(this->*(this->m_ptr_glMultiTexCoord1svARB))(target,v);}
inline void glGetMapxvOES(GLenum target,GLenum query,GLfixed* v)const{(this->*(this->m_ptr_glGetMapxvOES))(target,query,v);}
...
inline void glVertexAttrib4NbvARB(GLuint index,const GLbyte* v)const{(this->*(this->m_ptr_glVertexAttrib4NbvARB))(index,v);}
...
inline void glEvalCoord1xvOES(const GLfixed* coords)const{(this->*(this->m_ptr_glEvalCoord1xvOES))(coords);}
inline void glDetachObjectARB(GLhandleARB containerObj,GLhandleARB attachedObj)const{(this->*(this->m_ptr_glDetachObjectARB))(containerObj,attachedObj);}
...
inline void glMultiTexCoord1dARB(GLenum target,GLdouble s)const{(this->*(this->m_ptr_glMultiTexCoord1dARB))(target,s);}
...
inline void glPixelTexGenParameterfSGIS(GLenum pname,GLfloat param)const{(this->*(this->m_ptr_glPixelTexGenParameterfSGIS))(pname,param);}
...
inline void glUniform3fARB(GLint location,GLfloat v0,GLfloat v1,GLfloat v2)const{(this->*(this->m_ptr_glUniform3fARB))(location,v0,v1,v2);}
...
inline void glTexCoord4hvNV(const GLhalfNV* v)const{(this->*(this->m_ptr_glTexCoord4hvNV))(v);}
inline void glUseProgramObjectARB(GLhandleARB programObj)const{(this->*(this->m_ptr_glUseProgramObjectARB))(programObj);}
...
inline void glGetVideoCaptureivNV(GLuint video_capture_slot,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetVideoCaptureivNV))(video_capture_slot,pname,params);}
...
inline void glVertexAttrib3svARB(GLuint index,const GLshort* v)const{(this->*(this->m_ptr_glVertexAttrib3svARB))(index,v);}
...
inline void glGetVertexAttribPointervNV(GLuint index,GLenum pname,void** pointer)const{(this->*(this->m_ptr_glGetVertexAttribPointervNV))(index,pname,pointer);}
inline void glPushMatrix()const{(this->*(this->m_ptr_glPushMatrix))();}
inline void glEdgeFlagPointerListIBM(GLint stride,const GLboolean** pointer,GLint ptrstride)const{(this->*(this->m_ptr_glEdgeFlagPointerListIBM))(stride,pointer,ptrstride);}
...
inline void glPathCoordsNV(GLuint path,GLsizei numCoords,GLenum coordType,const void* coords)const{(this->*(this->m_ptr_glPathCoordsNV))(path,numCoords,coordType,coords);}
...
inline void glMultiTexCoord4xvOES(GLenum texture,const GLfixed* coords)const{(this->*(this->m_ptr_glMultiTexCoord4xvOES))(texture,coords);}
inline void glEGLImageTargetTexture2DOES(GLenum target,GLeglImageOES image)const{(this->*(this->m_ptr_glEGLImageTargetTexture2DOES))(target,image);}
inline void glPixelZoom(GLfloat xfactor,GLfloat yfactor)const{(this->*(this->m_ptr_glPixelZoom))(xfactor,yfactor);}
inline void glVertex3bvOES(const GLbyte* coords)const{(this->*(this->m_ptr_glVertex3bvOES))(coords);}
...
inline void glFragmentLightiSGIX(GLenum light,GLenum pname,GLint param)const{(this->*(this->m_ptr_glFragmentLightiSGIX))(light,pname,param);}
inline void glMultiTexCoord1bvOES(GLenum texture,const GLbyte* coords)const{(this->*(this->m_ptr_glMultiTexCoord1bvOES))(texture,coords);}
...
inline void glGetAttachedObjectsARB(GLhandleARB containerObj,GLsizei maxCount,GLsizei* count,GLhandleARB* obj)const{(this->*(this->m_ptr_glGetAttachedObjectsARB))(containerObj,maxCount,count,obj);}
...
inline void glFogxOES(GLenum pname,GLfixed param)const{(this->*(this->m_ptr_glFogxOES))(pname,param);}
...
inline void glUniform3ui64vNV(GLint location,GLsizei count,const GLuint64EXT* value)const{(this->*(this->m_ptr_glUniform3ui64vNV))(location,count,value);}
inline void glBlendFuncSeparateIndexedAMD(GLuint buf,GLenum srcRGB,GLenum dstRGB,GLenum srcAlpha,GLenum dstAlpha)const{(this->*(this->m_ptr_glBlendFuncSeparateIndexedAMD))(buf,srcRGB,dstRGB,srcAlpha,dstAlpha);}
inline void glMakeBufferResidentNV(GLenum target,GLenum access)const{(this->*(this->m_ptr_glMakeBufferResidentNV))(target,access);}
...
inline void glGetVertexAttribivNV(GLuint index,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetVertexAttribivNV))(index,pname,params);}
...
inline void glGetPerfQueryDataINTEL(GLuint queryHandle,GLuint flags,GLsizei dataSize,GLvoid* data,GLuint* bytesWritten)const{(this->*(this->m_ptr_glGetPerfQueryDataINTEL))(queryHandle,flags,dataSize,data,bytesWritten);}
inline void glVertexAttrib4dvARB(GLuint index,const GLdouble* v)const{(this->*(this->m_ptr_glVertexAttrib4dvARB))(index,v);}
...
inline void glVertexAttrib2dvARB(GLuint index,const GLdouble* v)const{(this->*(this->m_ptr_glVertexAttrib2dvARB))(index,v);}
...
inline void glDepthBoundsdNV(GLdouble zmin,GLdouble zmax)const{(this->*(this->m_ptr_glDepthBoundsdNV))(zmin,zmax);}
inline void glDeleteTexturesEXT(GLsizei n,const GLuint* textures)const{(this->*(this->m_ptr_glDeleteTexturesEXT))(n,textures);}
inline void glDrawBuffersATI(GLsizei n,const GLenum* bufs)const{(this->*(this->m_ptr_glDrawBuffersATI))(n,bufs);}
inline void glLightModelxvOES(GLenum pname,const GLfixed* param)const{(this->*(this->m_ptr_glLightModelxvOES))(pname,param);}
inline void glApplyTextureEXT(GLenum mode)const{(this->*(this->m_ptr_glApplyTextureEXT))(mode);}
inline GLuint64 glGetImageHandleNV(GLuint texture,GLint level,GLboolean layered,GLint layer,GLenum format)const{return (this->*(this->m_ptr_glGetImageHandleNV))(texture,level,layered,layer,format);}
...
inline void glGetFixedvOES(GLenum pname,GLfixed* params)const{(this->*(this->m_ptr_glGetFixedvOES))(pname,params);}
...
inline void glColor4fNormal3fVertex3fSUN(GLfloat r,GLfloat g,GLfloat b,GLfloat a,GLfloat nx,GLfloat ny,GLfloat nz,GLfloat x,GLfloat y,GLfloat z)const{(this->*(this->m_ptr_glColor4fNormal3fVertex3fSUN))(r,g,b,a,nx,ny,nz,x,y,z);}
...
inline void glFlushMappedBufferRangeAPPLE(GLenum target,GLintptr offset,GLsizeiptr size)const{(this->*(this->m_ptr_glFlushMappedBufferRangeAPPLE))(target,offset,size);}
inline void glVertex3sv(const GLshort* v)const{(this->*(this->m_ptr_glVertex3sv))(v);}
inline void glFlushStaticDataIBM(GLenum target)const{(this->*(this->m_ptr_glFlushStaticDataIBM))(target);}
inline void glProgramUniform4ui64NV(GLuint program,GLint location,GLuint64EXT x,GLuint64EXT y,GLuint64EXT z,GLuint64EXT w)const{(this->*(this->m_ptr_glProgramUniform4ui64NV))(program,location,x,y,z,w);}
inline void glRasterPos4xOES(GLfixed x,GLfixed y,GLfixed z,GLfixed w)const{(this->*(this->m_ptr_glRasterPos4xOES))(x,y,z,w);}
...
inline GLint glFinishAsyncSGIX(GLuint* markerp)const{return (this->*(this->m_ptr_glFinishAsyncSGIX))(markerp);}
...
inline void glProgramUniform2i64vNV(GLuint program,GLint location,GLsizei count,const GLint64EXT* value)const{(this->*(this->m_ptr_glProgramUniform2i64vNV))(program,location,count,value);}
inline void glFlushVertexArrayRangeAPPLE(GLsizei length,void* pointer)const{(this->*(this->m_ptr_glFlushVertexArrayRangeAPPLE))(length,pointer);}
...
inline void glMultiTexCoord3dvARB(GLenum target,const GLdouble* v)const{(this->*(this->m_ptr_glMultiTexCoord3dvARB))(target,v);}
...
inline void glDebugMessageInsertARB(GLenum source,GLenum type,GLuint id,GLenum severity,GLsizei length,const GLchar* buf)const{(this->*(this->m_ptr_glDebugMessageInsertARB))(source,type,id,severity,length,buf);}
...
inline void glArrayObjectATI(GLenum array,GLint size,GLenum type,GLsizei stride,GLuint buffer,GLuint offset)const{(this->*(this->m_ptr_glArrayObjectATI))(array,size,type,stride,buffer,offset);}
...
inline void glGetPerfMonitorCountersAMD(GLuint group,GLint* numCounters,GLint* maxActiveCounters,GLsizei counterSize,GLuint* counters)const{(this->*(this->m_ptr_glGetPerfMonitorCountersAMD))(group,numCounters,maxActiveCounters,counterSize,counters);}
...
inline void glTexEnvxvOES(GLenum target,GLenum pname,const GLfixed* params)const{(this->*(this->m_ptr_glTexEnvxvOES))(target,pname,params);}
inline void glProgramUniform2ui64NV(GLuint program,GLint location,GLuint64EXT x,GLuint64EXT y)const{(this->*(this->m_ptr_glProgramUniform2ui64NV))(program,location,x,y);}
inline void glMultiTexCoord3bOES(GLenum texture,GLbyte s,GLbyte t,GLbyte r)const{(this->*(this->m_ptr_glMultiTexCoord3bOES))(texture,s,t,r);}
...
inline void glProgramEnvParameterI4uivNV(GLenum target,GLuint index,const GLuint* params)const{(this->*(this->m_ptr_glProgramEnvParameterI4uivNV))(target,index,params);}
inline void glVertex2sv(const GLshort* v)const{(this->*(this->m_ptr_glVertex2sv))(v);}
inline void glWindowPos4dMESA(GLdouble x,GLdouble y,GLdouble z,GLdouble w)const{(this->*(this->m_ptr_glWindowPos4dMESA))(x,y,z,w);}
inline void glDebugMessageControlARB(GLenum source,GLenum type,GLenum severity,GLsizei count,const GLuint* ids,GLboolean enabled)const{(this->*(this->m_ptr_glDebugMessageControlARB))(source,type,severity,count,ids,enabled);}
inline GLboolean glIsTextureEXT(GLuint texture)const{return (this->*(this->m_ptr_glIsTextureEXT))(texture);}
inline void glFragmentMaterialivSGIX(GLenum face,GLenum pname,const GLint* params)const{(this->*(this->m_ptr_glFragmentMaterialivSGIX))(face,pname,params);}
...
inline void glVertex4bOES(GLbyte x,GLbyte y,GLbyte z,GLbyte w)const{(this->*(this->m_ptr_glVertex4bOES))(x,y,z,w);}
...
inline void glCombinerOutputNV(GLenum stage,GLenum portion,GLenum abOutput,GLenum cdOutput,GLenum sumOutput,GLenum scale,GLenum bias,GLboolean abDotProduct,GLboolean cdDotProduct,GLboolean muxSum)const{(this->*(this->m_ptr_glCombinerOutputNV))(stage,portion,abOutput,cdOutput,sumOutput,scale,bias,abDotProduct,cdDotProduct,muxSum);}
inline void glWindowPos4sMESA(GLshort x,GLshort y,GLshort z,GLshort w)const{(this->*(this->m_ptr_glWindowPos4sMESA))(x,y,z,w);}
inline void glVertexAttrib4svARB(GLuint index,const GLshort* v)const{(this->*(this->m_ptr_glVertexAttrib4svARB))(index,v);}
inline GLboolean glIsList(GLuint list)const{return (this->*(this->m_ptr_glIsList))(list);}
inline void glGetInfoLogARB(GLhandleARB obj,GLsizei maxLength,GLsizei* length,GLcharARB* infoLog)const{(this->*(this->m_ptr_glGetInfoLogARB))(obj,maxLength,length,infoLog);}
...
inline void glVertexAttribs3dvNV(GLuint index,GLsizei count,const GLdouble* v)const{(this->*(this->m_ptr_glVertexAttribs3dvNV))(index,count,v);}
inline void glGlobalAlphaFactorsSUN(GLshort factor)const{(this->*(this->m_ptr_glGlobalAlphaFactorsSUN))(factor);}
inline void glGetTrackMatrixivNV(GLenum target,GLuint address,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetTrackMatrixivNV))(target,address,pname,params);}
...
inline GLboolean glIsNamedBufferResidentNV(GLuint buffer)const{return (this->*(this->m_ptr_glIsNamedBufferResidentNV))(buffer);}
inline void glProgramUniform4ui64vARB(GLuint program,GLint location,GLsizei count,const GLuint64* value)const{(this->*(this->m_ptr_glProgramUniform4ui64vARB))(program,location,count,value);}
inline void glTbufferMask3DFX(GLuint mask)const{(this->*(this->m_ptr_glTbufferMask3DFX))(mask);}
inline void glCoverFillPathNV(GLuint path,GLenum coverMode)const{(this->*(this->m_ptr_glCoverFillPathNV))(path,coverMode);}
inline void glVertexAttrib1fvARB(GLuint index,const GLfloat* v)const{(this->*(this->m_ptr_glVertexAttrib1fvARB))(index,v);}
...
inline void glProgramSubroutineParametersuivNV(GLenum target,GLsizei count,const GLuint* params)const{(this->*(this->m_ptr_glProgramSubroutineParametersuivNV))(target,count,params);}
...
inline void glRotatexOES(GLfixed angle,GLfixed x,GLfixed y,GLfixed z)const{(this->*(this->m_ptr_glRotatexOES))(angle,x,y,z);}
inline void glMemoryBarrierEXT(GLbitfield barriers)const{(this->*(this->m_ptr_glMemoryBarrierEXT))(barriers);}
inline void glVertexAttrib3svNV(GLuint index,const GLshort* v)const{(this->*(this->m_ptr_glVertexAttrib3svNV))(index,v);}
inline void glVertexStream3iATI(GLenum stream,GLint x,GLint y,GLint z)const{(this->*(this->m_ptr_glVertexStream3iATI))(stream,x,y,z);}
...
inline GLboolean glIsPathNV(GLuint path)const{return (this->*(this->m_ptr_glIsPathNV))(path);}
inline void glGetnUniformi64vARB(GLuint program,GLint location,GLsizei bufSize,GLint64* params)const{(this->*(this->m_ptr_glGetnUniformi64vARB))(program,location,bufSize,params);}
inline void glFramebufferTextureMultiviewOVR(GLenum target,GLenum attachment,GLuint texture,GLint level,GLint baseViewIndex,GLsizei numViews)const{(this->*(this->m_ptr_glFramebufferTextureMultiviewOVR))(target,attachment,texture,level,baseViewIndex,numViews);}
...
inline void glVertexAttribParameteriAMD(GLuint index,GLenum pname,GLint param)const{(this->*(this->m_ptr_glVertexAttribParameteriAMD))(index,pname,param);}
inline void glBufferSubDataARB(GLenum target,GLintptrARB offset,GLsizeiptrARB size,const void* data)const{(this->*(this->m_ptr_glBufferSubDataARB))(target,offset,size,data);}
inline void glGetVertexAttribLui64vARB(GLuint index,GLenum pname,GLuint64EXT* params)const{(this->*(this->m_ptr_glGetVertexAttribLui64vARB))(index,pname,params);}
inline void glVertexAttribL4ui64NV(GLuint index,GLuint64EXT x,GLuint64EXT y,GLuint64EXT z,GLuint64EXT w)const{(this->*(this->m_ptr_glVertexAttribL4ui64NV))(index,x,y,z,w);}
inline void glReplacementCodeuiColor4ubVertex3fSUN(GLuint rc,GLubyte r,GLubyte g,GLubyte b,GLubyte a,GLfloat x,GLfloat y,GLfloat z)const{(this->*(this->m_ptr_glReplacementCodeuiColor4ubVertex3fSUN))(rc,r,g,b,a,x,y,z);}
inline void glImageTransformParameterfHP(GLenum target,GLenum pname,GLfloat param)const{(this->*(this->m_ptr_glImageTransformParameterfHP))(target,pname,param);}
...
inline void glVertex2bvOES(const GLbyte* coords)const{(this->*(this->m_ptr_glVertex2bvOES))(coords);}
inline void glGetMapControlPointsNV(GLenum target,GLuint index,GLenum type,GLsizei ustride,GLsizei vstride,GLboolean packed,void* points)const{(this->*(this->m_ptr_glGetMapControlPointsNV))(target,index,type,ustride,vstride,packed,points);}
...
inline void glBindBufferRangeNV(GLenum target,GLuint index,GLuint buffer,GLintptr offset,GLsizeiptr size)const{(this->*(this->m_ptr_glBindBufferRangeNV))(target,index,buffer,offset,size);}
inline void glVertexStream3dvATI(GLenum stream,const GLdouble* coords)const{(this->*(this->m_ptr_glVertexStream3dvATI))(stream,coords);}
inline void glNormalPointerListIBM(GLenum type,GLint stride,const void** pointer,GLint ptrstride)const{(this->*(this->m_ptr_glNormalPointerListIBM))(type,stride,pointer,ptrstride);}
inline void glFogFuncSGIS(GLsizei n,const GLfloat* points)const{(this->*(this->m_ptr_glFogFuncSGIS))(n,points);}
inline void glMultiModeDrawArraysIBM(const GLenum* mode,const GLint* first,const GLsizei* count,GLsizei primcount,GLint modestride)const{(this->*(this->m_ptr_glMultiModeDrawArraysIBM))(mode,first,count,primcount,modestride);}
...
inline void glGetConvolutionParameterxvOES(GLenum target,GLenum pname,GLfixed* params)const{(this->*(this->m_ptr_glGetConvolutionParameterxvOES))(target,pname,params);}
...
inline void glCoverFillPathInstancedNV(GLsizei numPaths,GLenum pathNameType,const void* paths,GLuint pathBase,GLenum coverMode,GLenum transformType,const GLfloat* transformValues)const{(this->*(this->m_ptr_glCoverFillPathInstancedNV))(numPaths,pathNameType,paths,pathBase,coverMode,transformType,transformValues);}
...
inline void glWindowPos2iMESA(GLint x,GLint y)const{(this->*(this->m_ptr_glWindowPos2iMESA))(x,y);}
inline void glVertex2xvOES(const GLfixed* coords)const{(this->*(this->m_ptr_glVertex2xvOES))(coords);}
...
inline void glReplacementCodeuiVertex3fSUN(GLuint rc,GLfloat x,GLfloat y,GLfloat z)const{(this->*(this->m_ptr_glReplacementCodeuiVertex3fSUN))(rc,x,y,z);}
...
inline void glWindowPos3fARB(GLfloat x,GLfloat y,GLfloat z)const{(this->*(this->m_ptr_glWindowPos3fARB))(x,y,z);}
...
inline GLboolean glIsPointInFillPathNV(GLuint path,GLuint mask,GLfloat x,GLfloat y)const{return (this->*(this->m_ptr_glIsPointInFillPathNV))(path,mask,x,y);}
...
inline void glBindBufferOffsetNV(GLenum target,GLuint index,GLuint buffer,GLintptr offset)const{(this->*(this->m_ptr_glBindBufferOffsetNV))(target,index,buffer,offset);}
...
inline void glGetProgramStringNV(GLuint id,GLenum pname,GLubyte* program)const{(this->*(this->m_ptr_glGetProgramStringNV))(id,pname,program);}
inline void glGetTexGenxvOES(GLenum coord,GLenum pname,GLfixed* params)const{(this->*(this->m_ptr_glGetTexGenxvOES))(coord,pname,params);}
...
inline GLenum glObjectPurgeableAPPLE(GLenum objectType,GLuint name,GLenum option)const{return (this->*(this->m_ptr_glObjectPurgeableAPPLE))(objectType,name,option);}
inline void glColorTableSGI(GLenum target,GLenum internalformat,GLsizei width,GLenum format,GLenum type,const void* table)const{(this->*(this->m_ptr_glColorTableSGI))(target,internalformat,width,format,type,table);}
...
inline void glFragmentLightModelfvSGIX(GLenum pname,const GLfloat* params)const{(this->*(this->m_ptr_glFragmentLightModelfvSGIX))(pname,params);}
...
inline void glMultiTexCoord2ivARB(GLenum target,const GLint* v)const{(this->*(this->m_ptr_glMultiTexCoord2ivARB))(target,v);}
inline void glLightModelxOES(GLenum pname,GLfixed param)const{(this->*(this->m_ptr_glLightModelxOES))(pname,param);}
inline void glColor3xOES(GLfixed red,GLfixed green,GLfixed blue)const{(this->*(this->m_ptr_glColor3xOES))(red,green,blue);}
inline void glReadBuffer(GLenum mode)const{(this->*(this->m_ptr_glReadBuffer))(mode);}
inline void glStencilFillPathInstancedNV(GLsizei numPaths,GLenum pathNameType,const void* paths,GLuint pathBase,GLenum fillMode,GLuint mask,GLenum transformType,const GLfloat* transformValues)const{(this->*(this->m_ptr_glStencilFillPathInstancedNV))(numPaths,pathNameType,paths,pathBase,fillMode,mask,transformType,transformValues);}
inline void glVDPAUUnmapSurfacesNV(GLsizei numSurface,const GLvdpauSurfaceNV* surfaces)const{(this->*(this->m_ptr_glVDPAUUnmapSurfacesNV))(numSurface,surfaces);}
inline void glProgramUniform4i64NV(GLuint program,GLint location,GLint64EXT x,GLint64EXT y,GLint64EXT z,GLint64EXT w)const{(this->*(this->m_ptr_glProgramUniform4i64NV))(program,location,x,y,z,w);}
inline void glVertexStream4dvATI(GLenum stream,const GLdouble* coords)const{(this->*(this->m_ptr_glVertexStream4dvATI))(stream,coords);}
...
inline void glVertexAttrib3hNV(GLuint index,GLhalfNV x,GLhalfNV y,GLhalfNV z)const{(this->*(this->m_ptr_glVertexAttrib3hNV))(index,x,y,z);}
...
inline void glBindTransformFeedbackNV(GLenum target,GLuint id)const{(this->*(this->m_ptr_glBindTransformFeedbackNV))(target,id);}
...
inline void glGetObjectBufferfvATI(GLuint buffer,GLenum pname,GLfloat* params)const{(this->*(this->m_ptr_glGetObjectBufferfvATI))(buffer,pname,params);}
...
inline void glGetPerfMonitorCounterStringAMD(GLuint group,GLuint counter,GLsizei bufSize,GLsizei* length,GLchar* counterString)const{(this->*(this->m_ptr_glGetPerfMonitorCounterStringAMD))(group,counter,bufSize,length,counterString);}
...
inline void glGetMaterialxOES(GLenum face,GLenum pname,GLfixed param)const{(this->*(this->m_ptr_glGetMaterialxOES))(face,pname,param);}
inline void glPopMatrix()const{(this->*(this->m_ptr_glPopMatrix))();}
inline void glGetVideoui64vNV(GLuint video_slot,GLenum pname,GLuint64EXT* params)const{(this->*(this->m_ptr_glGetVideoui64vNV))(video_slot,pname,params);}
inline void glTangent3bEXT(GLbyte tx,GLbyte ty,GLbyte tz)const{(this->*(this->m_ptr_glTangent3bEXT))(tx,ty,tz);}
inline GLenum glGetGraphicsResetStatusARB()const{return (this->*(this->m_ptr_glGetGraphicsResetStatusARB))();}
...
inline void glTexCoord4fVertex4fvSUN(const GLfloat* tc,const GLfloat* v)const{(this->*(this->m_ptr_glTexCoord4fVertex4fvSUN))(tc,v);}
...
inline void glDrawTransformFeedbackNV(GLenum mode,GLuint id)const{(this->*(this->m_ptr_glDrawTransformFeedbackNV))(mode,id);}
inline void glTextureImage2DMultisampleCoverageNV(GLuint texture,GLenum target,GLsizei coverageSamples,GLsizei colorSamples,GLint internalFormat,GLsizei width,GLsizei height,GLboolean fixedSampleLocations)const{(this->*(this->m_ptr_glTextureImage2DMultisampleCoverageNV))(texture,target,coverageSamples,colorSamples,internalFormat,width,height,fixedSampleLocations);}
...
inline void glWindowPos2svMESA(const GLshort* v)const{(this->*(this->m_ptr_glWindowPos2svMESA))(v);}
...
inline void glTexCoord3bOES(GLbyte s,GLbyte t,GLbyte r)const{(this->*(this->m_ptr_glTexCoord3bOES))(s,t,r);}
...
inline void glUniform2fvARB(GLint location,GLsizei count,const GLfloat* value)const{(this->*(this->m_ptr_glUniform2fvARB))(location,count,value);}
inline void glProgramLocalParameterI4uivNV(GLenum target,GLuint index,const GLuint* params)const{(this->*(this->m_ptr_glProgramLocalParameterI4uivNV))(target,index,params);}
inline void glFlushVertexArrayRangeNV()const{(this->*(this->m_ptr_glFlushVertexArrayRangeNV))();}
...
inline void glLoadTransposeMatrixxOES(const GLfixed* m)const{(this->*(this->m_ptr_glLoadTransposeMatrixxOES))(m);}
inline void glDeleteTransformFeedbacksNV(GLsizei n,const GLuint* ids)const{(this->*(this->m_ptr_glDeleteTransformFeedbacksNV))(n,ids);}
...
inline void glVertexAttribs1hvNV(GLuint index,GLsizei n,const GLhalfNV* v)const{(this->*(this->m_ptr_glVertexAttribs1hvNV))(index,n,v);}
inline void glWindowPos4svMESA(const GLshort* v)const{(this->*(this->m_ptr_glWindowPos4svMESA))(v);}
inline void glDeleteFragmentShaderATI(GLuint id)const{(this->*(this->m_ptr_glDeleteFragmentShaderATI))(id);}
...
inline void glMap2xOES(GLenum target,GLfixed u1,GLfixed u2,GLint ustride,GLint uorder,GLfixed v1,GLfixed v2,GLint vstride,GLint vorder,GLfixed points)const{(this->*(this->m_ptr_glMap2xOES))(target,u1,u2,ustride,uorder,v1,v2,vstride,vorder,points);}
inline void glEnd()const{(this->*(this->m_ptr_glEnd))();}
inline void glMultiTexCoord2dARB(GLenum target,GLdouble s,GLdouble t)const{(this->*(this->m_ptr_glMultiTexCoord2dARB))(target,s,t);}
inline void glUniform1i64NV(GLint location,GLint64EXT x)const{(this->*(this->m_ptr_glUniform1i64NV))(location,x);}
inline void glPathStringNV(GLuint path,GLenum format,GLsizei length,const void* pathString)const{(this->*(this->m_ptr_glPathStringNV))(path,format,length,pathString);}
...
inline void glGetProgramNamedParameterdvNV(GLuint id,GLsizei len,const GLubyte* name,GLdouble* params)const{(this->*(this->m_ptr_glGetProgramNamedParameterdvNV))(id,len,name,params);}
inline void glPathDashArrayNV(GLuint path,GLsizei dashCount,const GLfloat* dashArray)const{(this->*(this->m_ptr_glPathDashArrayNV))(path,dashCount,dashArray);}
...
inline void glColor3fVertex3fvSUN(const GLfloat* c,const GLfloat* v)const{(this->*(this->m_ptr_glColor3fVertex3fvSUN))(c,v);}
inline void glMultTransposeMatrixd(const GLdouble m[16])const{(this->*(this->m_ptr_glMultTransposeMatrixd))(m);}
...
inline GLuint64 glGetImageHandleARB(GLuint texture,GLint level,GLboolean layered,GLint layer,GLenum format)const{return (this->*(this->m_ptr_glGetImageHandleARB))(texture,level,layered,layer,format);}
inline void glTangent3dEXT(GLdouble tx,GLdouble ty,GLdouble tz)const{(this->*(this->m_ptr_glTangent3dEXT))(tx,ty,tz);}
inline void glGetQueryObjectivARB(GLuint id,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetQueryObjectivARB))(id,pname,params);}
...
inline void glFragmentMaterialfSGIX(GLenum face,GLenum pname,GLfloat param)const{(this->*(this->m_ptr_glFragmentMaterialfSGIX))(face,pname,param);}
inline void glGetVariantArrayObjectivATI(GLuint id,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetVariantArrayObjectivATI))(id,pname,params);}
...
inline void glVertexAttrib1dARB(GLuint index,GLdouble x)const{(this->*(this->m_ptr_glVertexAttrib1dARB))(index,x);}
...
inline void glVertexAttribPointerNV(GLuint index,GLint fsize,GLenum type,GLsizei stride,const void* pointer)const{(this->*(this->m_ptr_glVertexAttribPointerNV))(index,fsize,type,stride,pointer);}
...
inline void glTexCoord2xvOES(const GLfixed* coords)const{(this->*(this->m_ptr_glTexCoord2xvOES))(coords);}
...
inline void glSetMultisamplefvAMD(GLenum pname,GLuint index,const GLfloat* val)const{(this->*(this->m_ptr_glSetMultisamplefvAMD))(pname,index,val);}
inline void glPathColorGenNV(GLenum color,GLenum genMode,GLenum colorFormat,const GLfloat* coeffs)const{(this->*(this->m_ptr_glPathColorGenNV))(color,genMode,colorFormat,coeffs);}
inline void glVertexAttrib3sARB(GLuint index,GLshort x,GLshort y,GLshort z)const{(this->*(this->m_ptr_glVertexAttrib3sARB))(index,x,y,z);}
inline void glVertexAttrib4ivARB(GLuint index,const GLint* v)const{(this->*(this->m_ptr_glVertexAttrib4ivARB))(index,v);}
...
inline void glGetObjectParameterivARB(GLhandleARB obj,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetObjectParameterivARB))(obj,pname,params);}
...
inline void glWindowPos2fARB(GLfloat x,GLfloat y)const{(this->*(this->m_ptr_glWindowPos2fARB))(x,y);}
...
inline void glCompressedTexSubImage3DARB(GLenum target,GLint level,GLint xoffset,GLint yoffset,GLint zoffset,GLsizei width,GLsizei height,GLsizei depth,GLenum format,GLsizei imageSize,const void* data)const{(this->*(this->m_ptr_glCompressedTexSubImage3DARB))(target,level,xoffset,yoffset,zoffset,width,height,depth,format,imageSize,data);}
...
inline void glPresentFrameKeyedNV(GLuint video_slot,GLuint64EXT minPresentTime,GLuint beginPresentTimeId,GLuint presentDurationId,GLenum type,GLenum target0,GLuint fill0,GLuint key0,GLenum target1,GLuint fill1,GLuint key1)const{(this->*(this->m_ptr_glPresentFrameKeyedNV))(video_slot,minPresentTime,beginPresentTimeId,presentDurationId,type,target0,fill0,key0,target1,fill1,key1);}
inline void glVertexAttribI4bv(GLuint index,const GLbyte* v)const{(this->*(this->m_ptr_glVertexAttribI4bv))(index,v);}
inline void glPathCoverDepthFuncNV(GLenum func)const{(this->*(this->m_ptr_glPathCoverDepthFuncNV))(func);}
inline void glTransformFeedbackStreamAttribsNV(GLsizei count,const GLint* attribs,GLsizei nbuffers,const GLint* bufstreams,GLenum bufferMode)const{(this->*(this->m_ptr_glTransformFeedbackStreamAttribsNV))(count,attribs,nbuffers,bufstreams,bufferMode);}
...
inline void glCopyColorTableSGI(GLenum target,GLenum internalformat,GLint x,GLint y,GLsizei width)const{(this->*(this->m_ptr_glCopyColorTableSGI))(target,internalformat,x,y,width);}
inline void glProgramEnvParameter4fvARB(GLenum target,GLuint index,const GLfloat* params)const{(this->*(this->m_ptr_glProgramEnvParameter4fvARB))(target,index,params);}
inline void glMultiTexCoord4sARB(GLenum target,GLshort s,GLshort t,GLshort r,GLshort q)const{(this->*(this->m_ptr_glMultiTexCoord4sARB))(target,s,t,r,q);}
...
inline void glMatrixMultTranspose3x3fNV(GLenum matrixMode,const GLfloat* m)const{(this->*(this->m_ptr_glMatrixMultTranspose3x3fNV))(matrixMode,m);}
...
inline void glDrawCommandsStatesAddressNV(const GLuint64* indirects,const GLsizei* sizes,const GLuint* states,const GLuint* fbos,GLuint count)const{(this->*(this->m_ptr_glDrawCommandsStatesAddressNV))(indirects,sizes,states,fbos,count);}
inline void glUniform4ui64NV(GLint location,GLuint64EXT x,GLuint64EXT y,GLuint64EXT z,GLuint64EXT w)const{(this->*(this->m_ptr_glUniform4ui64NV))(location,x,y,z,w);}
...
inline void glGetFinalCombinerInputParameterfvNV(GLenum variable,GLenum pname,GLfloat* params)const{(this->*(this->m_ptr_glGetFinalCombinerInputParameterfvNV))(variable,pname,params);}
inline void glMultiTexCoord3bvOES(GLenum texture,const GLbyte* coords)const{(this->*(this->m_ptr_glMultiTexCoord3bvOES))(texture,coords);}
...
inline void glProgramNamedParameter4fvNV(GLuint id,GLsizei len,const GLubyte* name,const GLfloat* v)const{(this->*(this->m_ptr_glProgramNamedParameter4fvNV))(id,len,name,v);}
inline void glEndVideoCaptureNV(GLuint video_capture_slot)const{(this->*(this->m_ptr_glEndVideoCaptureNV))(video_capture_slot);}
...
inline void glTexCoord2fColor4fNormal3fVertex3fSUN(GLfloat s,GLfloat t,GLfloat r,GLfloat g,GLfloat b,GLfloat a,GLfloat nx,GLfloat ny,GLfloat nz,GLfloat x,GLfloat y,GLfloat z)const{(this->*(this->m_ptr_glTexCoord2fColor4fNormal3fVertex3fSUN))(s,t,r,g,b,a,nx,ny,nz,x,y,z);}
inline void glGenTransformFeedbacksNV(GLsizei n,GLuint* ids)const{(this->*(this->m_ptr_glGenTransformFeedbacksNV))(n,ids);}
...
inline void glTexSubImage4DSGIS(GLenum target,GLint level,GLint xoffset,GLint yoffset,GLint zoffset,GLint woffset,GLsizei width,GLsizei height,GLsizei depth,GLsizei size4d,GLenum format,GLenum type,const void* pixels)const{(this->*(this->m_ptr_glTexSubImage4DSGIS))(target,level,xoffset,yoffset,zoffset,woffset,width,height,depth,size4d,format,type,pixels);}
...
inline void glEvalMapsNV(GLenum target,GLenum mode)const{(this->*(this->m_ptr_glEvalMapsNV))(target,mode);}
...
inline void glCommandListSegmentsNV(GLuint list,GLuint segments)const{(this->*(this->m_ptr_glCommandListSegmentsNV))(list,segments);}
...
inline void glProgramUniform2ui64ARB(GLuint program,GLint location,GLuint64 x,GLuint64 y)const{(this->*(this->m_ptr_glProgramUniform2ui64ARB))(program,location,x,y);}
inline void glVertex4d(GLdouble x,GLdouble y,GLdouble z,GLdouble w)const{(this->*(this->m_ptr_glVertex4d))(x,y,z,w);}
inline GLuint glNewObjectBufferATI(GLsizei size,const void* pointer,GLenum usage)const{return (this->*(this->m_ptr_glNewObjectBufferATI))(size,pointer,usage);}
inline void glViewportSwizzleNV(GLuint index,GLenum swizzlex,GLenum swizzley,GLenum swizzlez,GLenum swizzlew)const{(this->*(this->m_ptr_glViewportSwizzleNV))(index,swizzlex,swizzley,swizzlez,swizzlew);}
...
inline void glUniformMatrix3fvARB(GLint location,GLsizei count,GLboolean transpose,const GLfloat* value)const{(this->*(this->m_ptr_glUniformMatrix3fvARB))(location,count,transpose,value);}
...
inline void glDrawArraysInstancedARB(GLenum mode,GLint first,GLsizei count,GLsizei primcount)const{(this->*(this->m_ptr_glDrawArraysInstancedARB))(mode,first,count,primcount);}
inline void glEnableVertexAttribAPPLE(GLuint index,GLenum pname)const{(this->*(this->m_ptr_glEnableVertexAttribAPPLE))(index,pname);}
...
inline void glBeginOcclusionQueryNV(GLuint id)const{(this->*(this->m_ptr_glBeginOcclusionQueryNV))(id);}
inline void glGenFencesAPPLE(GLsizei n,GLuint* fences)const{(this->*(this->m_ptr_glGenFencesAPPLE))(n,fences);}
...
inline void glNormalPointervINTEL(GLenum type,const void** pointer)const{(this->*(this->m_ptr_glNormalPointervINTEL))(type,pointer);}
...
inline void glNormalStream3bvATI(GLenum stream,const GLbyte* coords)const{(this->*(this->m_ptr_glNormalStream3bvATI))(stream,coords);}
inline void glGetObjectParameterivAPPLE(GLenum objectType,GLuint name,GLenum pname,GLint* params)const{(this->*(this->m_ptr_glGetObjectParameterivAPPLE))(objectType,name,pname,params);}
inline void glNormal3i(GLint nx,GLint ny,GLint nz)const{(this->*(this->m_ptr_glNormal3i))(nx,ny,nz);}
inline void glUniform1ivARB(GLint location,GLsizei count,const GLint* value)const{(this->*(this->m_ptr_glUniform1ivARB))(location,count,value);}
inline void glNormal3d(GLdouble nx,GLdouble ny,GLdouble nz)const{(this->*(this->m_ptr_glNormal3d))(nx,ny,nz);}
inline void glUpdateObjectBufferATI(GLuint buffer,GLuint offset,GLsizei size,const void* pointer,GLenum preserve)const{(this->*(this->m_ptr_glUpdateObjectBufferATI))(buffer,offset,size,pointer,preserve);}
...
inline void glProgramUniform3i64ARB(GLuint program,GLint location,GLint64 x,GLint64 y,GLint64 z)const{(this->*(this->m_ptr_glProgramUniform3i64ARB))(program,location,x,y,z);}
...
inline void glMultiTexCoord2bOES(GLenum texture,GLbyte s,GLbyte t)const{(this->*(this->m_ptr_glMultiTexCoord2bOES))(texture,s,t);}
...
inline GLboolean glIsPointInStrokePathNV(GLuint path,GLfloat x,GLfloat y)const{return (this->*(this->m_ptr_glIsPointInStrokePathNV))(path,x,y);}
