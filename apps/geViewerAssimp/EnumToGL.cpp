...
GLenum fsg::translateEnum(ge::sg::AttributeDescriptor::DataType type)
{
   switch(type)
   {
...
GLenum fsg::translateEnum(ge::sg::Image::DataType type)
{
   switch(type)
   {
...
GLenum fsg::translateEnum(ge::sg::Image::Format type)
{
   switch(type)
   {
...
GLenum fsg::translateEnum(ge::sg::Mesh::PrimitiveType type)
{
   switch(type)
   {
